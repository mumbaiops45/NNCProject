            ...
            <div style={{ display: "flex", flexDirection: "column", gap: isMobile ? "24px" : "28px" }}>
              ...
              <div>
                <h3 style={{
                  ...
                  <span style={{ fontSize: isMobile ? "20px" : "24px" }}>📞</span> Call Us
                </h3>
                  ...
                  {[
                    ...
                    <a
                      ...
                      onMouseEnter={e => {
                        ...
                        if (!isMobile) target.style.transform = "translateX(8px)";
                      }}
                      onMouseLeave={e => {
                        const target = e.currentTarget;
                    ...
                    >
                      <span style={{ fontSize: isMobile ? "18px" : "20px" }}>{item.flag}</span>
                      <span style={{ color: "rgba(255,255,255,0.6)", fontSize: isMobile ? "13px" : "14px" }}>
                        {isMobile ? item.flag.split(' ')[1] || item.label : `${item.label}:`}
                      </span>
                      <span style={{ color: T, fontWeight: 600, fontSize: isMobile ? "13px" : "15px" }}>
                        {item.phone}
                      </span>
                    </a>
                  ))}
              ...
              <div>
                <h3 style={{
                  ...
                  <span style={{ fontSize: isMobile ? "20px" : "24px" }}>✉️</span> Email
                </h3>
                <div style={{ display: "flex", flexDirection: "column", gap: isMobile ? "10px" : "12px" }}>
                  {[
                    ...
                    >
                      <span style={{ color: T, fontSize: isMobile ? "14px" : "16px" }}>✉️</span>
                      <div>
                        <div style={{ 
                          color: "#fff", 
                          fontWeight: 600, 
                        ...
                        <div style={{ color: "rgba(255,255,255,0.4)", fontSize: isMobile ? "11px" : "12px" }}>
                          {item.label}
                        </div>
                      </div>
                    </a>
              ...
              <div style={{
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "12px" }}>
                  ...
                  <span style={{ color: T, fontWeight: 700, fontSize: isMobile ? "15px" : "16px" }}>
                    Office Hours
                  </span>
                </div>
                <div style={{ 
                  ...
                  <div style={{ color: T, marginTop: "8px" }}>24hr response guaranteed</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div style={{
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: isMobile ? "16px" : "20px" }}>
                ...
                <textarea
                  required
                  style={{ ...iS, minHeight: isMobile ? "100px" : "120px", resize: "vertical" as const }}
            ...
            {globalOffices.map((office, index) => (
              ...
              >
                <div style={{ 
                  ...
                  <span style={{ fontSize: isMobile ? "24px" : "28px" }}>{office.country.split(' ')[0]}</span>
                  <div>
                    <div style={{ color: T, fontWeight: 700, fontSize: isMobile ? "15px" : "16px" }}>
                      {office.city}
                    </div>
                    <div style={{ color: "rgba(255,255,255,0.4)", fontSize: isMobile ? "12px" : "13px" }}>
                      {office.country}
                    </div>
                  </div>
                </div>
