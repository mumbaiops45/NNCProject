...
export default function ContactPage() {
  ...
  // ✅ Create LocalBusiness Schema data for each office location
  const localBusinessData = [
    {
      ...
      email: "canada@nncdigital.com",
      address: "50 Philip Ave, Guelph, ON N1E 1R4"
    },
    {
      city: "New York",
      region: "NY",
      country: "US",
      telephone: "+1-631-XXX-XXXX",
      email: "usa@nncdigital.com",
    ...
    },
    {
      ...
      email: "uk@nncdigital.com",
      address: "45 Tech Street, London, EC1A 1BB"
    },
    {
      city: "Bangalore",
      region: "Karnataka",
      ...
      address: "Darshan Plazza, Banashankari, Bengaluru 560061"
    }
  ];
  ...
  return (
    <>
      ...
      {/* ✅ Add LocalBusiness Schema - Multiple offices */}
