...
const SERVICES = [
  { icon: "🔍", title: "Search Engine Optimisation (SEO)", desc: "Tailored for businesses in Canada, USA & UK. Data-driven SEO that improves rankings, drives qualified traffic, and builds sustainable growth.", tag: "SEO" },
  { icon: "📍", title: "Local SEO (CA, US, UK)", desc: "Tailored for businesses in Canada, USA & UK. Dominate local search results, Google Maps, and 'near me' queries to attract nearby customers.", tag: "Local" },
  { icon: "🎯", title: "Google Ads", desc: "Tailored for businesses in Canada, USA & UK. High-converting PPC campaigns across Search, Shopping, Display, and YouTube, managed by Google-certified specialists.", tag: "PPC" },
  { icon: "📘", title: "Meta (Facebook/Instagram) Ads", desc: "Tailored for businesses in Canada, USA & UK. Creative-driven campaigns that build brand awareness and drive sales on the world's largest social platforms.", tag: "Social" },
  { icon: "💼", title: "LinkedIn Ads", desc: "Tailored for businesses in Canada, USA & UK. Precision B2B targeting to reach decision-makers with lead-gen forms and sponsored content.", tag: "B2B" },
  { icon: "📝", title: "Content Marketing", desc: "Tailored for businesses in Canada, USA & UK. Authority-building content that ranks: blogs, whitepapers, case studies, and pillar pages.", tag: "Content" },
  { icon: "🔧", title: "Technical SEO Audit", desc: "Tailored for businesses in Canada, USA & UK. Comprehensive crawl analysis, Core Web Vitals, site structure, and indexation fixes.", tag: "Technical" },
  { icon: "📈", title: "Conversion Rate Optimisation", desc: "Tailored for businesses in Canada, USA & UK. Turn more visitors into customers with A/B testing, UX improvements, and data-backed CRO.", tag: "CRO" },
  { icon: "📊", title: "Analytics & Reporting", desc: "Tailored for businesses in Canada, USA & UK. Custom dashboards, goal tracking, and transparent reporting — no vanity metrics.", tag: "Analytics" },
];

const BENEFITS = [
  { num: "01", icon: "🎯", title: "Qualified Traffic", desc: "We don't chase vanity metrics. Every campaign is designed to attract users who are actively searching for your products or services.", tags: ["Intent-based", "High Quality", "Buyer Keywords"] },
...
const HIRE_LEFT = [
  ...
  { icon: "🎯", title: "Agencies", desc: "White-label SEO and PPC services for agencies. Detailed reporting, client-ready dashboards, and seamless handoff to your team." },
];
const HIRE_RIGHT = [
...
const AI_FEATS = [
  { icon: "🧠", title: "AI Data Analysis", desc: "Uncover hidden opportunities in your search and ad data with AI-driven pattern recognition and competitive analysis.", clr: "rgba(0,201,167,.08)", bd: "rgba(0,201,167,.2)" },
  { icon: "🔮", title: "Predictive Insights", desc: "Forecast keyword trends, ad performance, and seasonality with machine learning models to stay ahead of your competitors.", clr: "rgba(99,102,241,.08)", bd: "rgba(99,102,241,.2)" },
  { icon: "🤖", title: "Automation at Scale", desc: "Automate bid management, ad copy testing, and reporting workflows — freeing your team to focus on strategy and creativity.", clr: "rgba(0,201,167,.08)", bd: "rgba(0,201,167,.2)" },
  { icon: "📈", title: "Real-Time Dashboards", desc: "Live dashboards tracking every KPI that matters: rankings, traffic, conversions, and revenue — updated in real time.", clr: "rgba(255,159,28,.08)", bd: "rgba(255,159,28,.2)" },
];
...
<section style={{padding:"80px 48px",background:`linear-gradient(180deg,${N1} 0%,${N2} 100%)`,position:"relative",overflow:"hidden"}}>
  ...
  <div style={{maxWidth:860,margin:"0 auto",position:"relative",zIndex:2}}>
    <div style={{textAlign:"center",marginBottom:52}}>
      ...
      <p style={{color:"rgba(255,255,255,0.45)",fontSize:15,lineHeight:1.75,maxWidth:520,margin:"0 auto"}}>Everything you need to know about SEO & digital marketing for businesses in Canada, USA &amp; UK.</p>
    </div>
    <div style={{display:"flex",flexDirection:"column",gap:12}}>
      {FAQS.map((f,i)=>(
...
<section style={{padding:"80px 48px",background:`linear-gradient(180deg,${N2} 0%,${N0} 100%)`,position:"relative",overflow:"hidden"}}>
  ...
  <div style={{maxWidth:1180,margin:"0 auto",position:"relative",zIndex:2}}>
    <div style={{textAlign:"center",marginBottom:56}}>
      ...
      <p style={{color:"rgba(255,255,255,0.45)",fontSize:15.5,lineHeight:1.75,maxWidth:540,margin:"0 auto"}}>Tell us about your marketing goals. We'll respond within 24 hours with a free audit and honest advice.</p>
    </div>
