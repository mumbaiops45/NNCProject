...
// // const SERVICES = [
// //   {icon:"🎯",title:"Lead Capture & CRM Integration",    desc:"Web forms, chatbots, and landing pages that feed qualified leads directly into HubSpot, Salesforce, or your CRM — with full attribution.",              tag:"Capture"},
// //   {icon:"📧",title:"Email Nurture Workflows",           desc:"Segmented drip sequences, behavioural triggers, and lifecycle emails that move leads from awareness to booked call — automatically.",               tag:"Email"},
// //   {icon:"💬",title:"WhatsApp Automation",               desc:"WhatsApp Business API automation for lead follow-up, appointment confirmations, and re-engagement — fully GDPR/PIPEDA compliant.",                  tag:"WhatsApp"},
// //   {icon:"📣",title:"Google & Meta Ads Integration",     desc:"Connect your ad platforms to your CRM — so every click is tracked, attributed, and enrolled in the right nurture sequence automatically.",         tag:"Ads"},
// //   {icon:"🔧",title:"Funnel Engineering",                desc:"End-to-end sales funnel design — from first touch to closed deal — with automation at every stage to eliminate manual tasks.",                     tag:"Funnel"},
// //   {icon:"🔍",title:"SEO & Content Marketing",           desc:"Always-on content and SEO strategy driving organic traffic into your automation funnel — turning search intent into booked meetings.",             tag:"SEO"},
// //   {icon:"📈",title:"Conversion Rate Optimisation",      desc:"A/B testing, landing page optimisation, form testing, and heatmap analysis to turn more visitors into qualified leads.",                           tag:"CRO"},
// //   {icon:"📊",title:"Analytics & Reporting",             desc:"Live dashboards showing cost per lead, revenue per channel, funnel drop-offs, and pipeline value — so every decision is data-driven.",           tag:"Analytics"},
// //   {icon:"🏢",title:"B2B Marketing Automation",          desc:"LinkedIn outreach sequences, ABM campaigns, and multi-touch B2B nurture workflows built for complex sales cycles in Canada, USA & UK.",           tag:"B2B"},
// //   {icon:"🔄",title:"CRM Setup & Optimisation",          desc:"HubSpot, ActiveCampaign, and Salesforce setup, migration, and optimisation — pipelines, deal stages, and automation rules built for your team.",  tag:"CRM"},
// //   {icon:"📱",title:"SMS & Push Campaigns",              desc:"Automated SMS sequences and push notification campaigns triggered by user behaviour — for mobile-first customer journeys.",                        tag:"SMS"},
// //   {icon:"🤖",title:"Chatbot & AI Lead Qualification",  desc:"AI chatbots that qualify leads 24/7, book meetings, and update your CRM — deployed on your website, WhatsApp, and Facebook Messenger.",          tag:"AI"},
// // ];
...
// // function SectionH2({children}:{children:React.ReactNode}){return <h2 style={{fontSize:"clamp(24px,3vw,40px)",fontWeight:900,color:"#fff",letterSpacing:"-0.02em",lineHeight:1.15,marginBottom:14}}>{children}</h2>;}
...
// //   return(<div onClick={toggle} style={{borderRadius:14,border:`1px solid ${open?"rgba(0,201,167,0.4)":"rgba(255,255,255,0.08)"}`,background:open?"rgba(0,201,167,0.06)":"rgba(255,255,255,0.02)",overflow:"hidden",cursor:"pointer",transition:"border-color .25s,background .25s"}}>
...
// //   @media(max-width:960px){.svc-grid{grid-template-columns:repeat(2,1fr)!important;}.two-col-wide{grid-template-columns:1fr!important;gap:44px!important;}.wcu-stats{grid-template-columns:1fr 1fr!important;}.gp-offices{grid-template-columns:1fr!important;}.gp-india-stats{grid-template-columns:repeat(2,1fr)!important;}}
// //   @media(max-width:768px){.two-col{grid-template-columns:1fr!important;}.kb-grid{grid-template-columns:1fr!important;}.cf-grid{grid-template-columns:1fr!important;gap:40px!important;}.gp-ind-grid{grid-template-columns:1fr!important;}}
...
// //   @media(max-width:480px){.hero-layout{padding:80px 20px 60px!important;}.cf-name{grid-template-columns:1fr!important;}.pt-grid{grid-template-columns:1fr!important;}.gp-india-stats{grid-template-columns:1fr 1fr!important;}}
// // `}</style>
...
// //       <div style={{display:"inline-flex",alignItems:"center",gap:8,background:"rgba(0,201,167,0.08)",border:"1px solid rgba(0,201,167,0.25)",borderRadius:100,padding:"7px 18px",marginBottom:28,animation:"heroGlow 3s ease-in-out infinite"}}>
...
// //         <span style={{color:T,fontSize:11.5,fontWeight:700,letterSpacing:"0.1em",textTransform:"uppercase" as const}}>Marketing Automation — Canada, USA &amp; UK</span>
// //       </div>
...
// //       </h1>
// //       <p style={{color:"rgba(255,255,255,0.52)",fontSize:"clamp(14px,1.3vw,16.5px)",lineHeight:1.85,marginBottom:28,maxWidth:600}}>
...
// //           <span key={b.l} className="ma-badge" style={{display:"inline-flex",alignItems:"center",gap:6,padding:"6px 13px",borderRadius:100,border:"1px solid rgba(255,255,255,0.12)",background:"rgba(255,255,255,0.04)",color:"rgba(255,255,255,0.65)",fontSize:12.5,fontWeight:600,transition:"all .2s",cursor:"default"}}>{b.i} {b.l}</span>
// //         ))}
// //       </div>
...
// //           <a key={p.phone} href={`tel:${p.phone.replace(/\s|-/g,"")}`} className="h-teal" style={{display:"flex",alignItems:"center",gap:7,color:"rgba(255,255,255,0.5)",fontSize:13.5,fontWeight:600,textDecoration:"none",transition:"color .2s"}}><span>{p.flag}</span><span style={{color:"rgba(255,255,255,0.3)"}}>{p.label}</span><span style={{color:T}}>{p.phone}</span></a>
// //         ))}
// //       </div>
// //     </div>

// //     {/* Hero Form */}
// //     <div style={{background:"rgba(8,20,40,0.85)",border:"1px solid rgba(0,201,167,0.22)",borderRadius:20,padding:"32px 28px",backdropFilter:"blur(16px)",boxShadow:"0 32px 80px rgba(0,0,0,0.5),0 0 40px rgba(0,201,167,0.06)",position:"relative",overflow:"hidden"}}>
// //       <div style={{position:"absolute",top:0,left:0,right:0,height:2,background:`linear-gradient(90deg,transparent,${T},transparent)`}}/>
// //       {submitted?(<div style={{textAlign:"center",padding:"40px 0"}}>
...
// //       </div>):(<>
// //         <div style={{marginBottom:22}}><p style={{color:T,fontSize:11,fontWeight:700,letterSpacing:"0.1em",textTransform:"uppercase" as const,marginBottom:4}}>Free Consultation</p><h2 style={{color:"#fff",fontSize:18,fontWeight:800,margin:0,lineHeight:1.3}}>Get a Free Automation Strategy Call</h2></div>
...
// //           </div>
// //           <div><label style={{display:"block",fontSize:11,fontWeight:600,color:"rgba(255,255,255,0.45)",marginBottom:5,textTransform:"uppercase" as const,letterSpacing:"0.04em"}}>Phone</label>
// //             <div style={{display:"flex",gap:8}}>
// //               <select className="fi" style={{...iS,width:82,flexShrink:0,padding:"11px 6px",cursor:"pointer"}} value={form.dialCode} onChange={e=>setF("dialCode",e.target.value)}>{DIAL_CODES.map((d,i)=><option key={i} value={d.code}>{d.flag} {d.code}</option>)}</select>
...
// //           <div><label style={{display:"block",fontSize:11,fontWeight:600,color:"rgba(255,255,255,0.45)",marginBottom:5,textTransform:"uppercase" as const,letterSpacing:"0.04em"}}>Service</label>
...
// //     <div style={{fontSize:"clamp(40px,4.5vw,56px)",fontWeight:900,lineHeight:1,marginBottom:10,background:"linear-gradient(135deg,#fff 30%,#00C9A7 100%)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}}><Counter to={s.val} sfx={s.sfx}/></div>
...
// //     <div style={{textAlign:"center",marginBottom:48}}><SectionBadge label="Proven Results"/><SectionH2>Marketing Automation <GradText>Success Stories</GradText></SectionH2><p style={{color:"rgba(255,255,255,0.45)",fontSize:16,lineHeight:1.7,maxWidth:500,margin:"0 auto"}}>Real results from real automation systems built for businesses in Canada, USA &amp; UK.</p></div>
// //     <div style={{display:"flex",gap:10,justifyContent:"center",marginBottom:40,flexWrap:"wrap"}}>{CASES.map((c,i)=>(<button key={i} className={`ss-tab${story===i?" act":""}`} onClick={()=>setStory(i)}><span>{c.icon}</span>{c.industry}</button>))}</div>
...
// //           {[{label:"Challenge",text:CASES[story].challenge,icon:"⚠️"},{label:"Solution",text:CASES[story].solution,icon:"💡"}].map(col=>(<div key={col.label} style={{padding:20,borderRadius:14,background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.07)"}}><p style={{color:T,fontSize:11,fontWeight:700,letterSpacing:"0.1em",textTransform:"uppercase" as const,marginBottom:8}}>{col.icon} {col.label}</p><p style={{color:"rgba(255,255,255,0.6)",fontSize:14,lineHeight:1.7,margin:0}}>{col.text}</p></div>))}
// //         </div>
// //         <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:14}}>
// //           {CASES[story].metrics.map((m,i)=>(<div key={i} style={{textAlign:"center",padding:"18px 14px",borderRadius:14,border:"1px solid rgba(255,255,255,0.07)",background:"rgba(255,255,255,0.03)",transition:"transform .25s,background .25s",cursor:"default"}} onMouseEnter={e=>{(e.currentTarget as HTMLElement).style.transform="translateY(-4px)";(e.currentTarget as HTMLElement).style.background="rgba(0,201,167,0.06)";}} onMouseLeave={e=>{(e.currentTarget as HTMLElement).style.transform="";(e.currentTarget as HTMLElement).style.background="rgba(255,255,255,0.03)";}}>
...
// //       </div>
// //     </div>
// //     <div style={{display:"flex",justifyContent:"center",gap:8,marginTop:28}}>{CASES.map((_,i)=>(<button key={i} onClick={()=>setStory(i)} style={{width:story===i?24:8,height:8,borderRadius:100,background:story===i?T:"rgba(255,255,255,0.2)",border:"none",cursor:"pointer",transition:"all .3s ease"}}/>))}</div>
// //     <div style={{textAlign:"center",marginTop:44}}><button className="btn-teal" style={{padding:"14px 36px",borderRadius:10,border:"none",background:`linear-gradient(135deg,${T},${TD})`,color:"#000",fontWeight:700,fontSize:15,fontFamily:"'Poppins',sans-serif",cursor:"pointer",transition:"transform .2s,box-shadow .2s"}}>View All Case Studies →</button></div>
// //   </div>
// // </section>

// // {/* ══ AUTOMATION FLOW VISUAL ══════════════════════════════════════════════════ */}
// // <section style={{padding:"72px 48px 0",background:N1,position:"relative",overflow:"hidden"}}>
// //   <div style={{maxWidth:1100,margin:"0 auto"}}>
// //     <div style={{textAlign:"center",marginBottom:52}}><SectionBadge label="How It Works"/><SectionH2>Your Always-On <GradText>Lead Machine</GradText></SectionH2><p style={{color:"rgba(255,255,255,0.45)",fontSize:15,lineHeight:1.75,maxWidth:500,margin:"0 auto"}}>Every lead is captured, scored, nurtured, and handed to sales — automatically, 24/7.</p></div>
// //     <div style={{display:"flex",alignItems:"center",justifyContent:"center",gap:0,flexWrap:"wrap",marginBottom:64}}>
// //       {[
...
// //       ].map((node,i,arr)=>(<div key={i} style={{display:"flex",alignItems:"center"}}>
// //         <div className="flow-node" style={{textAlign:"center",padding:"24px 20px",borderRadius:16,background:node.clr,border:`1px solid ${node.bd}`,minWidth:130,transition:"border-color .2s,background .2s,transform .2s",cursor:"default",animation:`flowPulse ${3+i*.4}s ease-in-out infinite ${i*.3}s`}}>
// //           <div style={{fontSize:28,marginBottom:8}}>{node.icon}</div>
// //           <div style={{color:"rgba(255,255,255,0.35)",fontSize:10,fontWeight:700,letterSpacing:"0.1em",marginBottom:4}}>{node.step}</div>
// //           <div style={{color:"#fff",fontSize:14,fontWeight:700,marginBottom:4}}>{node.title}</div>
// //           <div style={{color:"rgba(255,255,255,0.45)",fontSize:11.5,lineHeight:1.5}}>{node.desc}</div>
// //         </div>
// //         {i<arr.length-1&&<div style={{display:"flex",flexDirection:"column",alignItems:"center",width:36,flexShrink:0}}>
...
// // {/* ══ M4 — SERVICES ════════════════════════════════════════════════════════════ */}
// // <section style={{padding:"80px 48px 48px",background:N1,position:"relative",overflow:"hidden"}}>
...
// //     <div style={{textAlign:"center",marginBottom:60}}><SectionBadge label="What We Do"/><SectionH2>Marketing Automation Services <GradText>We Offer</GradText></SectionH2><p style={{color:"rgba(255,255,255,0.5)",fontSize:16,lineHeight:1.75,maxWidth:580,margin:"0 auto"}}>End-to-end marketing automation for businesses across Canada, USA &amp; UK — from lead capture to closed deal.</p></div>
// //     <div className="svc-grid">
// //       {SERVICES.map((s,i)=>(<div key={s.title} className="svc-card" style={{animationDelay:`${i*.06}s`}}>
...
// //       </div>))}
// //     </div>
// //     <div style={{textAlign:"center",marginTop:56}}><button className="btn-teal" style={{padding:"14px 36px",borderRadius:10,background:`linear-gradient(135deg,${T},${TD})`,border:"none",color:"#000",fontWeight:700,fontSize:15,fontFamily:"'Poppins',sans-serif",cursor:"pointer",transition:"transform .2s,box-shadow .2s"}}>View All Services →</button></div>
// //   </div>
// // </section>
...
// //   <div style={{position:"absolute",inset:0,pointerEvents:"none",zIndex:0,backgroundImage:"linear-gradient(rgba(0,201,167,.025) 1px,transparent 1px),linear-gradient(90deg,rgba(0,201,167,.025) 1px,transparent 1px)",backgroundSize:"56px 56px"}}/>
// //   <div style={{maxWidth:1280,margin:"0 auto",position:"relative",zIndex:2}}>
// //     <div style={{textAlign:"center",marginBottom:60}}><SectionBadge label="Why It Works"/><SectionH2>Key Benefits of <GradText>Marketing Automation</GradText></SectionH2><p style={{color:"rgba(255,255,255,0.45)",fontSize:16,lineHeight:1.75,maxWidth:520,margin:"0 auto"}}>Why businesses in Canada, USA &amp; UK switch from manual outreach to always-on automation.</p></div>
// //     <div className="kb-grid">
// //       {BENEFITS.map((b,i)=>(<div key={i} className="kb-card" style={{animationDelay:`${i*.12}s`}}>
...
// //           <div style={{display:"flex",flexWrap:"wrap",gap:6}}>{b.tags.map(tag=><span key={tag} style={{display:"inline-flex",alignItems:"center",padding:"3px 10px",borderRadius:100,fontSize:10.5,fontWeight:600,letterSpacing:".06em",textTransform:"uppercase" as const,color:T,background:"rgba(0,201,167,0.08)",border:"1px solid rgba(0,201,167,0.18)"}}>{tag}</span>)}</div>
// //         </div>
// //       </div>))}
// //     </div>
// //     <div style={{textAlign:"center",marginTop:52}}><button className="btn-teal" style={{padding:"14px 36px",borderRadius:10,border:"none",background:`linear-gradient(135deg,${T},${TD})`,color:"#000",fontWeight:700,fontSize:15,fontFamily:"'Poppins',sans-serif",cursor:"pointer",transition:"transform .2s,box-shadow .2s"}}>Build My Automation Stack →</button></div>
// //   </div>
// // </section>
...
// //   <div style={{maxWidth:1280,margin:"0 auto",position:"relative",zIndex:2}}>
// //     <div style={{textAlign:"center",marginBottom:56}}><SectionBadge label="Our Stack"/><SectionH2>Leading Automation Platforms <GradText>That We Use</GradText></SectionH2><p style={{color:"rgba(255,255,255,0.45)",fontSize:16,lineHeight:1.75,maxWidth:560,margin:"0 auto"}}>Best-in-class tools for every layer of your marketing automation stack.</p></div>
// //     <div className="pt-grid">
// //       {TOOLS.map((tool,i)=>(<div key={i} className="pt-card" style={{background:tool.clr,border:`1px solid ${tool.bd}`}}>
...
// //   <div style={{maxWidth:1280,margin:"0 auto",position:"relative",zIndex:2}}>
// //     <div style={{textAlign:"center",marginBottom:60}}><SectionBadge label="Automation Capabilities"/><SectionH2>Everything Inside Your <GradText>Automation Stack</GradText></SectionH2><p style={{color:"rgba(255,255,255,0.45)",fontSize:16,lineHeight:1.7,maxWidth:520,margin:"0 auto"}}>The full capability set we bring to every marketing automation project.</p></div>
// //     <div className="two-col">
// //       <div style={{display:"flex",flexDirection:"column",gap:12}}>{ACCORDION_L.map((item,i)=><AccItem key={item.title} item={item} open={accL===i} toggle={()=>setAccL(accL===i?null:i)}/>)}</div>
// //       <div style={{display:"flex",flexDirection:"column",gap:12}}>{ACCORDION_R.map((item,i)=><AccItem key={item.title} item={item} open={accR===i} toggle={()=>setAccR(accR===i?null:i)}/>)}</div>
// //     </div>
// //   </div>
// // </section>
...
// //   <div style={{maxWidth:1280,margin:"0 auto",position:"relative",zIndex:2}}>
// //     <div style={{textAlign:"center",marginBottom:56}}><SectionBadge label="Hire Specialists"/><SectionH2>Hire Automation Specialists <GradText>Tailored to Your Needs</GradText></SectionH2><p style={{color:"rgba(255,255,255,0.45)",fontSize:16,lineHeight:1.75,maxWidth:560,margin:"0 auto"}}>Whether you&apos;re building from scratch or scaling an existing stack — we have the right specialist for your goals.</p></div>
...
// //       <p style={{color:T,fontSize:11,fontWeight:700,letterSpacing:"0.12em",textTransform:"uppercase" as const}}>By Automation Type</p>
// //     </div>
// //     <div className="two-col">
// //       <div style={{display:"flex",flexDirection:"column",gap:12}}>{HIRE_LEFT.map((item,i)=><AccItem key={item.title} item={item} open={hireL===i} toggle={()=>setHireL(hireL===i?null:i)}/>)}</div>
// //       <div style={{display:"flex",flexDirection:"column",gap:12}}>{HIRE_RIGHT.map((item,i)=><AccItem key={item.title} item={item} open={hireR===i} toggle={()=>setHireR(hireR===i?null:i)}/>)}</div>
// //     </div>
// //     <div style={{display:"flex",gap:16,marginTop:48,justifyContent:"center",flexWrap:"wrap"}}>
// //       <button className="btn-teal" style={{padding:"14px 32px",borderRadius:10,border:"none",background:`linear-gradient(135deg,${T},${TD})`,color:"#000",fontWeight:700,fontSize:15,fontFamily:"'Poppins',sans-serif",cursor:"pointer",transition:"transform .2s,box-shadow .2s"}}>⚡ Hire an Automation Specialist</button>
// //       <button style={{padding:"14px 32px",borderRadius:10,border:"1.5px solid rgba(0,201,167,0.35)",background:"transparent",color:T,fontWeight:600,fontSize:15,fontFamily:"'Poppins',sans-serif",cursor:"pointer",transition:"border-color .2s,background .2s"}} onMouseEnter={e=>{(e.currentTarget as HTMLElement).style.borderColor=T;(e.currentTarget as HTMLElement).style.background="rgba(0,201,167,0.07)";}} onMouseLeave={e=>{(e.currentTarget as HTMLElement).style.borderColor="rgba(0,201,167,0.35)";(e.currentTarget as HTMLElement).style.background="transparent";}}>View Pricing →</button>
// //     </div>
// //   </div>
// // </section>
...
// //           <div><h3 style={{color:"#fff",fontSize:17,fontWeight:700,marginBottom:8,lineHeight:1.3}}>{f.title}</h3><p style={{color:"rgba(255,255,255,0.52)",fontSize:14,lineHeight:1.75,margin:0}}>{f.desc}</p></div>
// //         </div>))}
// //         <button className="btn-teal" style={{marginTop:8,alignSelf:"flex-start",display:"inline-flex",alignItems:"center",gap:10,padding:"13px 28px",borderRadius:10,border:"none",background:`linear-gradient(135deg,${T},${TD})`,color:"#000",fontWeight:700,fontSize:14,fontFamily:"'Poppins',sans-serif",cursor:"pointer",transition:"transform .2s,box-shadow .2s"}}>🤖 Explore AI Marketing Solutions →</button>
// //       </div>
// //       {/* AI Dashboard Visual */}
...
// //           <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:24}}><div style={{width:10,height:10,borderRadius:"50%",background:"#22c55e",boxShadow:"0 0 10px #22c55e"}}/><span style={{color:"rgba(255,255,255,0.5)",fontSize:12,fontWeight:600,letterSpacing:"0.1em",textTransform:"uppercase" as const}}>Live Automation Dashboard</span></div>
// //           {[{label:"Email open rate (AI optimised)",val:"48%",color:T},{label:"WhatsApp reply rate",val:"72%",color:"#22c55e"},{label:"Lead-to-meeting conversion",val:"34%",color:T},{label:"ROAS across all ad channels",val:"4.2×",color:"#f59e0b"}].map((row,i)=>(<div key={i} style={{marginBottom:16}}>
...
// //           {[{label:"Leads This Month",val:"1,842",icon:"🎯"},{label:"Pipeline Value",val:"$284K",icon:"💰"},{label:"Avg Cost/Lead",val:"$18",icon:"📉"}].map((m,i)=>(<div key={i} style={{background:"rgba(255,255,255,0.04)",border:"1px solid rgba(255,255,255,0.08)",borderRadius:12,padding:"14px 12px",textAlign:"center"}}>
...
// //       <div style={{display:"inline-flex",alignItems:"center",gap:8,background:"rgba(255,255,255,0.15)",border:"1px solid rgba(255,255,255,0.3)",borderRadius:100,padding:"6px 18px",marginBottom:24}}><span style={{width:6,height:6,borderRadius:"50%",background:"#fff",display:"block"}}/><span style={{color:"#fff",fontSize:11,fontWeight:700,letterSpacing:"0.12em",textTransform:"uppercase" as const}}>Get Started Today</span></div>
// //       <h2 style={{fontSize:"clamp(26px,3.5vw,48px)",fontWeight:900,color:"#fff",lineHeight:1.15,letterSpacing:"-0.02em",marginBottom:20}}>Want Marketing Automation Solutions That Take Your Business to the <span style={{textDecoration:"underline",textDecorationColor:"rgba(255,255,255,0.4)"}}>Next Level?</span></h2>
// //       <p style={{color:"rgba(255,255,255,0.82)",fontSize:17,lineHeight:1.75,marginBottom:40}}>Connect with NNC Digital today — and let&apos;s build your always-on lead generation machine.</p>
// //       <div style={{display:"flex",gap:16,justifyContent:"center",flexWrap:"wrap"}}>
// //         <button style={{display:"inline-flex",alignItems:"center",gap:10,padding:"16px 40px",borderRadius:12,background:"#fff",color:"#0055b3",fontWeight:800,fontSize:16,fontFamily:"'Poppins',sans-serif",border:"none",cursor:"pointer",transition:"transform .2s,box-shadow .2s"}} onMouseEnter={e=>{(e.currentTarget as HTMLElement).style.transform="translateY(-3px)";(e.currentTarget as HTMLElement).style.boxShadow="0 16px 40px rgba(0,0,0,0.25)";}} onMouseLeave={e=>{(e.currentTarget as HTMLElement).style.transform="";(e.currentTarget as HTMLElement).style.boxShadow="";}}>✦ Connect Now</button>
// //         <button style={{display:"inline-flex",alignItems:"center",gap:10,padding:"16px 36px",borderRadius:12,background:"transparent",color:"#fff",fontWeight:700,fontSize:16,fontFamily:"'Poppins',sans-serif",border:"2px solid rgba(255,255,255,0.5)",cursor:"pointer",transition:"border-color .2s,background .2s"}} onMouseEnter={e=>{(e.currentTarget as HTMLElement).style.borderColor="#fff";(e.currentTarget as HTMLElement).style.background="rgba(255,255,255,0.1)";}} onMouseLeave={e=>{(e.currentTarget as HTMLElement).style.borderColor="rgba(255,255,255,0.5)";(e.currentTarget as HTMLElement).style.background="transparent";}}>📅 Book a Free Call →</button>
// //       </div>
...
// //         <p style={{color:"rgba(255,255,255,0.55)",fontSize:15,lineHeight:1.8,marginBottom:32}}>We launched NNC Digital as our international arm — bringing the same proven automation expertise to Canadian, US, and UK markets with transparent pricing, dedicated account managers, and a focus on measurable ROI.</p>
// //         <div style={{display:"flex",flexDirection:"column",gap:10,marginBottom:36}}>{WCU_POINTS.map((p,i)=>(<div key={i} className="wcu-point" style={{display:"flex",alignItems:"center",gap:14,padding:"14px 18px",borderRadius:12,border:"1px solid rgba(255,255,255,0.06)",background:"rgba(255,255,255,0.02)",transition:"border-color .2s,background .2s,transform .2s",cursor:"default"}}><span style={{fontSize:18,flexShrink:0}}>{p.icon}</span><span style={{color:"rgba(255,255,255,0.72)",fontSize:14,fontWeight:500}}>{p.text}</span></div>))}</div>
// //         <div className="wcu-stats">{WCU_STATS.map(st=>(<div key={st.l} className="wcu-stat" style={{textAlign:"center",padding:"22px 14px",borderRadius:14,border:"1px solid rgba(0,201,167,0.15)",background:"rgba(0,201,167,0.05)",transition:"transform .25s,background .25s",cursor:"default"}}><div style={{fontSize:"clamp(20px,2.2vw,28px)",fontWeight:900,marginBottom:4,background:`linear-gradient(135deg,#fff 30%,${T})`,WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}}><Counter to={st.n} sfx={st.s}/></div><div style={{color:"rgba(255,255,255,0.4)",fontSize:11.5,fontWeight:500}}>{st.l}</div></div>))}</div>
// //       </div>
// //       <div>
...
// //             <div style={{position:"absolute",inset:0,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:16}}><button style={{width:72,height:72,borderRadius:"50%",background:T,border:"none",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",fontSize:28,animation:"wcuPulse 2.5s ease-in-out infinite"}}>▶</button><p style={{color:"rgba(255,255,255,0.6)",fontSize:14,fontWeight:600,margin:0}}>Watch Our Story</p></div>
// //             <div style={{position:"absolute",bottom:0,left:0,right:0,padding:"16px 20px",background:"linear-gradient(0deg,rgba(3,11,24,0.95),transparent)",display:"flex",alignItems:"center",justifyContent:"space-between"}}><div><p style={{color:"#fff",fontSize:14,fontWeight:700,margin:0}}>NNC Digital Solutions</p><p style={{color:"rgba(255,255,255,0.4)",fontSize:12,margin:0}}>Founder&apos;s Story · 3 min</p></div><div style={{padding:"5px 12px",borderRadius:100,background:"rgba(0,201,167,0.1)",border:"1px solid rgba(0,201,167,0.3)",color:T,fontSize:11,fontWeight:700}}>▶ Play</div></div>
...
// //         </div>
// //         <div style={{display:"flex",gap:10,marginTop:20,flexWrap:"wrap"}}>{["🇨🇦 Canada","🇺🇸 USA","🇬🇧 UK","🇮🇳 India"].map(b=>(<span key={b} style={{padding:"6px 14px",borderRadius:100,border:"1px solid rgba(255,255,255,0.1)",background:"rgba(255,255,255,0.03)",color:"rgba(255,255,255,0.6)",fontSize:12.5,fontWeight:500}}>{b}</span>))}</div>
...
// //           <button style={{flex:1,padding:"13px 20px",borderRadius:10,border:"1.5px solid rgba(0,201,167,0.35)",background:"transparent",color:T,fontWeight:600,fontSize:14,fontFamily:"'Poppins',sans-serif",cursor:"pointer",transition:"border-color .2s,background .2s"}} onMouseEnter={e=>{(e.currentTarget as HTMLElement).style.borderColor=T;(e.currentTarget as HTMLElement).style.background="rgba(0,201,167,0.07)";}} onMouseLeave={e=>{(e.currentTarget as HTMLElement).style.borderColor="rgba(0,201,167,0.35)";(e.currentTarget as HTMLElement).style.background="transparent";}}>Our Work →</button>
// //         </div>
// //       </div>
// //     </div>
// //   </div>
...
// //           <a href={`tel:${o.phone.replace(/\s|-/g,"")}`} className="h-teal" style={{display:"flex",alignItems:"center",gap:8,color:"rgba(255,255,255,0.7)",fontSize:14,fontWeight:600,textDecoration:"none",marginBottom:8}}>📞 {o.phone}</a>
// //           <a href={`mailto:${o.email}`} className="h-teal" style={{display:"flex",alignItems:"center",gap:8,color:"rgba(255,255,255,0.5)",fontSize:13,textDecoration:"none"}}>✉️ {o.email}</a>
// //         </div>))}
// //       </div>
// //       <div style={{borderRadius:14,padding:"20px 28px",background:"rgba(0,201,167,0.05)",border:"1px solid rgba(0,201,167,0.15)",display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:16}}><div style={{display:"flex",alignItems:"center",gap:12}}><div style={{width:10,height:10,borderRadius:"50%",background:"#22c55e",boxShadow:"0 0 8px #22c55e"}}/><span style={{color:"rgba(255,255,255,0.6)",fontSize:14,fontWeight:500}}>Available Mon–Fri, 9am–6pm in your time zone</span></div><a href="mailto:hello@nncdigital.com" className="h-teal" style={{color:T,fontSize:14,fontWeight:700,textDecoration:"none"}}>hello@nncdigital.com →</a></div>
// //     </div>)}
// //     {gTab==="india"&&(<div>
...
// //         <div style={{display:"flex",alignItems:"center",gap:14,marginBottom:28}}><span style={{fontSize:32}}>🇮🇳</span><div><h3 style={{color:"#fff",fontSize:18,fontWeight:800,margin:0}}>Nakshatra Namaha Creations Pvt. Ltd.</h3><p style={{color:"rgba(255,255,255,0.4)",fontSize:13,margin:"4px 0 0"}}>Engineering &amp; Delivery HQ — Bangalore, India</p></div></div>
// //         <div className="gp-ind-grid">{INDIA_OFFICES.map((o,i)=>(<div key={i} className="gp-ind" style={{display:"flex",alignItems:"center",gap:14,padding:"16px 18px",borderRadius:12,background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.07)",transition:"background .2s,border-color .2s",cursor:"default"}}><span style={{fontSize:22}}>🇮🇳</span><div><p style={{color:"#fff",fontSize:14,fontWeight:700,margin:0}}>{o.city}</p><p style={{color:"rgba(255,255,255,0.38)",fontSize:12,margin:"2px 0 0"}}>{o.note}</p>{o.phone&&<p style={{color:T,fontSize:12.5,fontWeight:600,margin:"4px 0 0"}}>{o.phone}</p>}</div></div>))}</div>
...
// //       </div>
// //       <div className="gp-india-stats">{[{n:"8+",l:"Years Active"},{n:"300+",l:"Automations"},{n:"100+",l:"Team Members"},{n:"4",l:"India Offices"}].map((s,i)=>(<div key={i} style={{textAlign:"center",padding:"20px 12px",borderRadius:14,background:"rgba(0,201,167,0.06)",border:"1px solid rgba(0,201,167,0.15)",transition:"transform .25s,background .25s",cursor:"default"}} onMouseEnter={e=>{(e.currentTarget as HTMLElement).style.transform="translateY(-4px)";(e.currentTarget as HTMLElement).style.background="rgba(0,201,167,0.12)";}} onMouseLeave={e=>{(e.currentTarget as HTMLElement).style.transform="";(e.currentTarget as HTMLElement).style.background="rgba(0,201,167,0.06)";}}><p style={{fontSize:26,fontWeight:900,color:T,margin:0}}>{s.n}</p><p style={{fontSize:11,color:"rgba(255,255,255,0.4)",margin:"4px 0 0",fontWeight:600,textTransform:"uppercase" as const,letterSpacing:"0.06em"}}>{s.l}</p></div>))}</div>
// //     </div>)}
// //   </div>
// // </section>
...
// //     <div style={{textAlign:"center",marginBottom:52}}><SectionBadge label="FAQs"/><SectionH2>Frequently Asked <GradText>Questions</GradText></SectionH2><p style={{color:"rgba(255,255,255,0.45)",fontSize:15,lineHeight:1.75,maxWidth:520,margin:"0 auto"}}>Everything you need to know about marketing automation for businesses in Canada, USA &amp; UK.</p></div>
...
// //           <div style={{display:"flex",alignItems:"center",gap:14}}><span style={{color:T,fontSize:13,fontWeight:800,background:"rgba(0,201,167,0.1)",border:"1px solid rgba(0,201,167,0.2)",borderRadius:8,padding:"4px 10px",flexShrink:0}}>Q{i+1}</span><span style={{fontSize:15.5,fontWeight:700,color:faq===i?"#fff":"rgba(255,255,255,0.78)",lineHeight:1.4,transition:"color .2s"}}>{f.q}</span></div>
...
// //         </div>
// //         <div style={{maxHeight:faq===i?500:0,overflow:"hidden",transition:"max-height .38s ease"}}><p style={{padding:"0 22px 22px 60px",color:"rgba(255,255,255,0.55)",fontSize:14.5,lineHeight:1.8,margin:0}}>{f.a}</p></div>
// //       </div>))}
// //     </div>
// //     <div style={{textAlign:"center",marginTop:44}}><p style={{color:"rgba(255,255,255,0.4)",fontSize:14,marginBottom:20}}>Still have questions? We respond within 24 hours.</p><button className="btn-teal" style={{padding:"13px 32px",borderRadius:10,border:"none",background:`linear-gradient(135deg,${T},${TD})`,color:"#000",fontWeight:700,fontSize:15,fontFamily:"'Poppins',sans-serif",cursor:"pointer",transition:"transform .2s,box-shadow .2s"}}>Ask Us Anything →</button></div>
// //   </div>
// // </section>
...
// //   <div style={{maxWidth:1180,margin:"0 auto",position:"relative",zIndex:2}}>
// //     <div style={{textAlign:"center",marginBottom:56}}><SectionBadge label="Get In Touch"/><SectionH2>Ready to Build Your <GradText>Always-On Lead Machine?</GradText></SectionH2><p style={{color:"rgba(255,255,255,0.45)",fontSize:15.5,lineHeight:1.75,maxWidth:540,margin:"0 auto"}}>Tell us about your marketing goals. We respond within 24 hours with a free automation strategy and honest advice.</p></div>
// //     <div className="cf-grid">
// //       <div style={{background:"rgba(255,255,255,0.02)",border:"1px solid rgba(255,255,255,0.08)",borderRadius:20,padding:"36px 32px"}}>
// //         {cSubmitted?(<div style={{textAlign:"center",padding:"48px 0"}}><div style={{fontSize:56,marginBottom:20}}>✅</div><h3 style={{color:"#fff",fontSize:22,fontWeight:800,marginBottom:12}}>Message Sent!</h3><p style={{color:"rgba(255,255,255,0.5)",fontSize:15,lineHeight:1.7,marginBottom:28}}>Thank you — we&apos;ll respond within 24 hours with a tailored automation strategy.</p><button onClick={()=>{setCSubmitted(false);setCForm({name:"",phone:"",dialCode:"+1",email:"",service:"",project:""});}} style={{padding:"12px 28px",borderRadius:10,border:"none",background:`linear-gradient(135deg,${T},${TD})`,color:"#000",fontWeight:700,fontSize:14,fontFamily:"'Poppins',sans-serif",cursor:"pointer"}}>Send Another →</button></div>):(
...
// //               <div><label style={{display:"block",fontSize:12.5,fontWeight:600,color:"rgba(255,255,255,0.5)",marginBottom:7,textTransform:"uppercase" as const,letterSpacing:"0.04em"}}>Phone</label>
// //                 <div style={{display:"flex",gap:8}}><select className="fi" style={{...iSLg,width:90,flexShrink:0,padding:"13px 8px",cursor:"pointer"}} value={cForm.dialCode} onChange={e=>setCF("dialCode",e.target.value)}>{DIAL_CODES.map((d,i)=><option key={i} value={d.code}>{d.flag} {d.code}</option>)}</select><input className="fi" style={iSLg} type="tel" placeholder="647 XXX XXXX" value={cForm.phone} onChange={e=>setCF("phone",e.target.value)}/></div>
// //               </div>
// //             </div>
...
// //           {[{s:"1",text:"We review your brief within a few hours — no bots, no templates."},{s:"2",text:"An automation strategist calls you within 24 hours."},{s:"3",text:"We send a free automation map with channels, tools, and timeline."},{s:"4",text:"You decide — no pressure, no obligation."}].map((s,i)=>(<div key={i} style={{display:"flex",gap:14,alignItems:"flex-start",marginBottom:i<3?16:0,padding:"12px 14px",borderRadius:10,background:"rgba(255,255,255,0.03)",transition:"background .2s",cursor:"default"}} onMouseEnter={e=>(e.currentTarget as HTMLElement).style.background="rgba(0,201,167,0.07)"} onMouseLeave={e=>(e.currentTarget as HTMLElement).style.background="rgba(255,255,255,0.03)"}><div style={{width:32,height:32,borderRadius:"50%",flexShrink:0,background:`linear-gradient(135deg,${T},${TD})`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:11,fontWeight:900,color:"#000"}}>{s.s}</div><p style={{color:"rgba(255,255,255,0.65)",fontSize:14,lineHeight:1.65,margin:0}}>{s.text}</p></div>))}
// //         </div>
...
// //           {[{flag:"🇨🇦",label:"Canada",phone:"+1 647-XXX-XXXX"},{flag:"🇺🇸",label:"USA",phone:"+1 631-XXX-XXXX"},{flag:"🇬🇧",label:"UK",phone:"+44 20-XXXX-XXXX"}].map((c,i)=>(<div key={i} style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"12px 0",borderBottom:i<2?"1px solid rgba(255,255,255,0.06)":"none"}}><span style={{color:"rgba(255,255,255,0.55)",fontSize:14,fontWeight:500}}>{c.flag} {c.label}</span><a href={`tel:${c.phone.replace(/\s|-/g,"")}`} className="h-teal" style={{color:T,fontSize:14,fontWeight:700,textDecoration:"none"}}>{c.phone}</a></div>))}
// //           <div style={{marginTop:16,paddingTop:16,borderTop:"1px solid rgba(255,255,255,0.06)"}}><a href="mailto:hello@nncdigital.com" className="h-teal" style={{color:"rgba(255,255,255,0.5)",fontSize:14,textDecoration:"none",display:"flex",alignItems:"center",gap:8}}>✉️ hello@nncdigital.com</a></div>
// //         </div>
// //         <div style={{display:"flex",flexWrap:"wrap",gap:8}}>{["🔵 Google Partner","🏆 ISO Certified","🔒 GDPR Compliant","🍁 PIPEDA Ready","⭐ Clutch Top Agency"].map(b=>(<span key={b} style={{padding:"6px 12px",borderRadius:100,border:"1px solid rgba(255,255,255,0.1)",background:"rgba(255,255,255,0.03)",color:"rgba(255,255,255,0.5)",fontSize:12,fontWeight:500}}>{b}</span>))}</div>
// //       </div>
// //     </div>
// //   </div>
// // </section>
...
// function GradText({children}:{children:React.ReactNode}){return <span style={{background:`linear-gradient(135deg,${T},#1fd1b5)`,WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}}>{children}</span>;}
// function AccItem({item,open,toggle}:{item:{icon:string;title:string;desc:string};open:boolean;toggle:()=>void}) {
//   // Use state for responsive detection inside component
...
//     .hero-layout{padding:80px 16px 60px!important;}
...
// {/* ══ M1 — HERO ══════════════════════════════════════════════════════════════ */}
// <section style={{padding: isMobile ? "40px 16px 40px" : isTablet ? "96px 32px 80px" : "90px 48px 80px",background:`linear-gradient(135deg,${N0} 0%,#041628 45%,${N0} 100%)`,position:"relative",overflow:"hidden",minHeight: isMobile ? "auto" : "90vh",display:"flex",alignItems:"center"}}>
//   <Particles/>
//   <div style={{position:"absolute",inset:0,pointerEvents:"none",zIndex:1,backgroundImage:`linear-gradient(rgba(0,201,167,.035) 1px,transparent 1px),linear-gradient(90deg,rgba(0,201,167,.035) 1px,transparent 1px)`,backgroundSize:"60px 60px"}}/>
//   {!isMobile && (
//     <>
...
//   <div className="hero-layout">
//     <div style={{animation:"heroFadeUp .7s ease both"}}>
//       <div style={{display:"inline-flex",alignItems:"center",gap:8,background:"rgba(0,201,167,0.08)",border:"1px solid rgba(0,201,167,0.25)",borderRadius:100,padding: isMobile ? "6px 14px" : "7px 18px",marginBottom: isMobile ? 10 : 28,animation:"heroGlow 3s ease-in-out infinite"}}>
...
//       </div>
//       <h1 style={{fontSize: isMobile ? "28px" : isTablet ? "36px" : "48px",fontWeight:900,lineHeight:1.12,marginBottom: isMobile ? 16 : 22,letterSpacing:"-0.025em",color:"#fff"}}>
//         Marketing Automation Services That <GradText>Generate and Nurture</GradText> Qualified Leads
//       </h1>
//       <p style={{color:"rgba(255,255,255,0.52)",fontSize: isMobile ? "14px" : isTablet ? "15px" : "16.5px",lineHeight:1.85,marginBottom: isMobile ? 20 : 28,maxWidth:600}}>
//         Marketing automation is an always-on system that captures, qualifies, nurtures, and converts leads — while your team focuses on closing deals. We build it, you scale it.
//       </p>
//       {/* Channel pills */}
...
//         </Link>
//       </div>):(<>
//         <div style={{marginBottom: isMobile ? 16 : 22}}><p style={{color:T,fontSize: isMobile ? 10 : 11,fontWeight:700,letterSpacing:"0.1em",textTransform:"uppercase" as const,marginBottom:4}}>Free Consultation</p><h2 style={{color:"#fff",fontSize: isMobile ? 16 : 18,fontWeight:800,margin:0,lineHeight:1.3}}>Get a Free Automation Strategy Call</h2></div>
...
// {/* ══ M2 — LOGOS ══════════════════════════════════════════════════════════════ */}
// <section style={{ padding: isMobile ? "10px 0" : "60px 0", background: N0, overflow: "hidden", borderTop: `1px solid rgba(0,201,167,.1)`, borderBottom: `1px solid rgba(0,201,167,.1)` }}>
...
// {/* ══ AUTOMATION FLOW VISUAL ══════════════════════════════════════════════════ */}
// <section style={{padding: isMobile ? "40px 16px 0" : "42px 48px 0",background:N1,position:"relative",overflow:"hidden"}}>
//   <div style={{maxWidth:1100,margin:"0 auto"}}>
...
// {/* ══ M4 — SERVICES ════════════════════════════════════════════════════════════ */}
// <section style={{padding: isMobile ? "40px 16px" : isTablet ? "60px 32px" : "40px 48px", background:N1,position:"relative",overflow:"hidden"}}>
//   <div style={{position:"absolute",inset:0,pointerEvents:"none",zIndex:0,backgroundImage:"linear-gradient(rgba(0,201,167,.025) 1px,transparent 1px),linear-gradient(90deg,rgba(0,201,167,.025) 1px,transparent 1px)",backgroundSize:"56px 56px"}}/>
//   <div style={{maxWidth:1280,margin:"0 auto",position:"relative",zIndex:2}}>
...
//   <div style={{position:"absolute",inset:0,pointerEvents:"none",zIndex:0,backgroundImage:"linear-gradient(rgba(0,201,167,.025) 1px,transparent 1px),linear-gradient(90deg,rgba(0,201,167,.025) 1px,transparent 1px)",backgroundSize:"56px 56px"}}/>
//   <div style={{maxWidth:1280,margin:"0 auto",position:"relative",zIndex:2}}>
//     <div style={{textAlign:"center",marginBottom: isMobile ? 20 : 30}}><SectionBadge label="Why It Works"/><SectionH2>Key Benefits of <GradText>Marketing Automation</GradText></SectionH2><p style={{color:"rgba(255,255,255,0.45)",fontSize: isMobile ? 13 : 15,lineHeight:1.75,maxWidth:520,margin:"0 auto"}}>Why businesses in Canada, USA &amp; UK switch from manual outreach to always-on automation.</p></div>
//     <div className="kb-grid">
...
// {/* ══ M6 — PLATFORM TOOLS ══════════════════════════════════════════════════════ */}
// <section style={{padding: isMobile ? "40px 16px" : isTablet ? "60px 32px" : "80px 48px", background:N1,position:"relative",overflow:"hidden"}}>
...
// {/* ══ CAPABILITIES ACCORDION ══════════════════════════════════════════════════ */}
// <section style={{padding: isMobile ? "40px 16px" : isTablet ? "60px 32px" : "80px 48px", background:N0,position:"relative",overflow:"hidden"}}>
...
//   <div style={{maxWidth:860,margin:"0 auto",position:"relative",zIndex:2}}>
//     <div style={{textAlign:"center",marginBottom: isMobile ? 32 : 40}}><SectionBadge label="FAQs"/><SectionH2>Frequently Asked <GradText>Questions</GradText></SectionH2><p style={{color:"rgba(255,255,255,0.45)",fontSize: isMobile ? "13px" : "15px",lineHeight:1.75,maxWidth:520,margin:"0 auto"}}>Everything you need to know about marketing automation for businesses in Canada, USA &amp; UK.</p></div>
...
//   <div style={{maxWidth:1180,margin:"0 auto",position:"relative",zIndex:2}}>
//     <div style={{textAlign:"center",marginBottom: isMobile ? 32 : 40}}><SectionBadge label="Get In Touch"/><SectionH2>Ready to Build Your <GradText>Always-On Lead Machine?</GradText></SectionH2><p style={{color:"rgba(255,255,255,0.45)",fontSize: isMobile ? "13px" : "15px",lineHeight:1.75,maxWidth:540,margin:"0 auto"}}>Tell us about your marketing goals. We respond within 24 hours with a free automation strategy and honest advice.</p></div>
//     <div className="cf-grid">
