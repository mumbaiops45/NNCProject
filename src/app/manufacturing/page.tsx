...
// //     id: 1,
// //     icon: "🏭",
// //     title: "35% Efficiency Gain for Canadian Manufacturer",
// //     description: "A mid-sized manufacturer implemented our dealer CRM and production planning system, connecting 5 facilities in real-time.",
// //     metrics: [
// //       { label: "Efficiency", value: "+35%" },
// //       { label: "Response", value: "-60%" },
// //       { label: "ROI", value: "312%" }
// //     ],
// //     tags: ["Manufacturing", "CRM", "Canada"]
// //   },
// //   {
// //     id: 2,
// //     icon: "🔧",
// //     title: "28% Inventory Reduction for US Industrial Supplier",
// //     description: "ERP integration and warehouse management system reduced inventory levels while maintaining 99% order accuracy.",
// //     metrics: [
// //       { label: "Inventory", value: "-28%" },
// //       { label: "Accuracy", value: "99.2%" },
// //       { label: "Fulfillment", value: "+41%" }
// //     ],
// //     tags: ["Manufacturing", "ERP", "USA"]
// //   },
// //   {
// //     id: 3,
// //     icon: "📊",
// //     title: "52% Faster Dealer Onboarding for UK Manufacturer",
// //     description: "Automated dealer management system reduced onboarding time and improved sales pipeline visibility.",
// //     metrics: [
// //       { label: "Onboarding", value: "-52%" },
// //       { label: "Pipeline", value: "+78%" },
// //       { label: "Sales", value: "+34%" }
// //     ],
// //     tags: ["Manufacturing", "Dealer", "UK"]
// //   }
// // ];

// // const SOLUTIONS = [
// //   { icon: "🤝", title: "Dealer & Distributor CRM", desc: "Complete dealer network management, territory assignments, performance tracking, and automated order workflows." },
// //   { icon: "📊", title: "Sales Pipeline Management", desc: "Track complex B2B sales cycles, quote management, and forecasting for manufacturing sales teams." },
// //   { icon: "⚙️", title: "Production Planning & Scheduling", desc: "Optimize production runs, capacity planning, and shop floor scheduling with real-time updates." },
// //   { icon: "📦", title: "Inventory & Warehouse Management", desc: "Real-time inventory tracking, bin management, and automated reorder points across multiple warehouses." },
// //   { icon: "🔗", title: "ERP Integration", desc: "Unified data across sales, production, inventory, and finance with seamless ERP integration." },
// //   { icon: "🛠️", title: "Field Service Management", desc: "Mobile apps for field technicians with job scheduling, digital forms, and offline sync." },
// //   { icon: "✅", title: "Quality Control Workflows", desc: "Automated quality checks, non-conformance tracking, and corrective action workflows." },
// //   { icon: "🏢", title: "Vendor Management", desc: "Supplier onboarding, performance scorecards, purchase orders, and 3-way matching." },
...
// //   { n: 565, s: "+", l: "Projects" },
// //   { n: 100, s: "+", l: "Team" },
// //   { n: 30, s: "+", l: "Manufacturing Clients" }
// // ];

// // const MANUFACTURING_STATS = [
// //   { value: "35%", label: "Efficiency Gain", icon: "⚡" },
// //   { value: "99%", label: "Order Accuracy", icon: "✅" },
// //   { value: "24/7", label: "Real-time Data", icon: "📊" },
...
// // const SERVICES_LIST = [
// //   "Dealer CRM", "Sales Pipeline", "Production Planning",
// //   "Inventory Management", "ERP Integration", "Field Service", "Other"
// // ];
...
// //           <span style={{ fontSize: "clamp(20px, 3vw, 24px)" }}>⚙️</span>
// //           <span style={{ color: T, fontSize: "clamp(12px, 2vw, 14px)", fontWeight: 700 }}>PRODUCTION METRICS</span>
// //         </div>

// //         <div style={{ display: "flex", flexDirection: "column", gap: "clamp(8px, 2vw, 12px)" }}>
// //           <div>
// //             <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4, flexWrap: "wrap", gap: 4 }}>
// //               <span style={{ fontSize: "clamp(11px, 2vw, 12px)", color: "rgba(255,255,255,0.5)" }}>OEE (Overall Equipment Effectiveness)</span>
// //               <span style={{ fontSize: "clamp(11px, 2vw, 12px)", color: T, fontWeight: 600 }}>85%</span>
// //             </div>
// //             <div style={{ height: 6, background: "rgba(255,255,255,0.1)", borderRadius: 3 }}>
// //               <div style={{ width: "85%", height: "100%", background: T, borderRadius: 3 }} />
// //             </div>
// //           </div>

// //           <div>
// //             <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4, flexWrap: "wrap", gap: 4 }}>
// //               <span style={{ fontSize: "clamp(11px, 2vw, 12px)", color: "rgba(255,255,255,0.5)" }}>On-Time Delivery</span>
...
// //           <div>
// //             <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4, flexWrap: "wrap", gap: 4 }}>
// //               <span style={{ fontSize: "clamp(11px, 2vw, 12px)", color: "rgba(255,255,255,0.5)" }}>Inventory Accuracy</span>
// //               <span style={{ fontSize: "clamp(11px, 2vw, 12px)", color: T, fontWeight: 600 }}>99.2%</span>
// //             </div>
// //             <div style={{ height: 6, background: "rgba(255,255,255,0.1)", borderRadius: 3 }}>
// //               <div style={{ width: "99.2%", height: "100%", background: T, borderRadius: 3 }} />
// //             </div>
// //           </div>
// //         </div>
// //       </div>
...
// //         <span style={{ fontSize: "clamp(11px, 2vw, 12px)", color: "rgba(255,255,255,0.5)" }}>ERP connected · Live data</span>
// //       </div>
// //     </div>
// //   );
// // }
...
// //           {/* Left - Hero Text */}
// //           <div>
// //             <SectionBadge label="Manufacturing Technology" />
// //             <h1 style={{
...
// //             }}>
// //               Custom CRM & ERP Solutions for <GradText>Manufacturers</GradText> in Canada, USA & UK
// //             </h1>
// //             <p style={{
...
// //                   A manufacturing specialist will contact you within 24 hours.
// //                 </p>
...
// //             <SectionH2>Manufacturing <GradText>Success Stories</GradText></SectionH2>
// //           </div>
...
// //             <SectionH2>Manufacturing <GradText>Digital Solutions</GradText> We Build</SectionH2>
// //           </div>
...
// //               <SectionH2>Your Trusted <GradText>Manufacturing Technology</GradText> Partner</SectionH2>
// //             </div>
...
// //                   Backed by <strong style={{ color: T }}>Nakshatra Namaha Creations Pvt. Ltd.</strong> — 8+ years of experience, 565+ projects delivered. Dedicated client teams in Canada, USA, and UK. ERP integration specialists. Long-term partnership focused on your success.
// //                 </p>
...
// //             <SectionH2>Ready to Build Your <GradText>Manufacturing Solution?</GradText></SectionH2>
// //             <p style={{ color: "rgba(255,255,255,0.6)", fontSize: isMobile ? 13 : 14, marginBottom: 20 }}>
...
// const SUCCESS_STORIES = [
//   { id:1, icon:"🏭", title:"35% Efficiency Gain for Canadian Manufacturer",       description:"A mid-sized manufacturer implemented our dealer CRM and production planning system, connecting 5 facilities in real-time.",          metrics:[{label:"Efficiency",value:"+35%"},{label:"Response",value:"-60%"},{label:"ROI",value:"312%"}],       tags:["Manufacturing","CRM","Canada"] },
//   { id:2, icon:"🔧", title:"28% Inventory Reduction for US Industrial Supplier",  description:"ERP integration and warehouse management system reduced inventory levels while maintaining 99% order accuracy.",                     metrics:[{label:"Inventory",value:"-28%"},{label:"Accuracy",value:"99.2%"},{label:"Fulfillment",value:"+41%"}], tags:["Manufacturing","ERP","USA"]    },
//   { id:3, icon:"📊", title:"52% Faster Dealer Onboarding for UK Manufacturer",    description:"Automated dealer management system reduced onboarding time and improved sales pipeline visibility.",                                 metrics:[{label:"Onboarding",value:"-52%"},{label:"Pipeline",value:"+78%"},{label:"Sales",value:"+34%"}],       tags:["Manufacturing","Dealer","UK"]  },
// ];
...
// const COMPLIANCE = [
//   { region:"Dealer Network",  flag:"🤝", title:"Dealer Network CRM",  desc:"Track dealer performance, territory assignments, and automate order workflows." },
//   { region:"ERP Integration", flag:"🔗", title:"ERP–CRM Integration", desc:"Unified data across sales, production, inventory, and finance in real time." },
//   { region:"Compliance",      flag:"✅", title:"Compliance",          desc:"Systems built to meet Canadian, US, and UK manufacturing regulatory requirements including ISO standards and traceability." },
// ];
...
//   { q:"Can you integrate with our existing ERP system?",             a:"Yes. We specialize in integrating CRMs with major ERP systems including SAP, Oracle, Microsoft Dynamics, and custom manufacturing ERPs. Integration covers real-time inventory visibility, order sync, financial data, and production status — ensuring your sales team always has accurate information without double-entry." },
...
//         </div>
//         <div style={{display:"flex",flexDirection:"column",gap:"clamp(8px,2vw,12px)"}}>
//           {[{label:"OEE (Overall Equipment Effectiveness)",val:"85%",w:"85%"},{label:"On-Time Delivery",val:"94%",w:"94%"},{label:"Inventory Accuracy",val:"99.2%",w:"99.2%"}].map((row,i)=>(
//             <div key={i}>
//               <div style={{display:"flex",justifyContent:"space-between",marginBottom:4,flexWrap:"wrap",gap:4}}>
...
// // ─── Logo row helper ──────────────────────────────────────────────────────────
// function LogoItem({logo,isMobile}:{logo:string;isMobile:boolean}) {
//   return (
//     <div style={{flexShrink:0,display:"flex",alignItems:"center",justifyContent:"center",height:isMobile?60:70,padding:isMobile?"8px 14px":"10px 18px",background:"#fff",borderRadius:10,margin:"0 8px",boxShadow:"0 6px 20px rgba(0,0,0,0.15)",opacity:.9,transition:"transform .3s,box-shadow .3s"}}
//       onMouseEnter={e=>{const el=e.currentTarget as HTMLElement;el.style.transform="scale(1.08)";el.style.boxShadow="0 10px 28px rgba(0,0,0,0.25)";}}
//       onMouseLeave={e=>{const el=e.currentTarget as HTMLElement;el.style.transform="";el.style.boxShadow="0 6px 20px rgba(0,0,0,0.15)";}}>
...
//       await emailjs.send(EMAILJS_SERVICE_ID,EMAILJS_TEMPLATE_ID,buildParams({firstName:parts[0],lastName:parts.slice(1).join(" "),email:hForm.email,phone:`${hForm.dialCode} ${hForm.phone}`,service:hForm.service,message:hForm.message,title:`New Manufacturing Enquiry from ${hForm.name}`}));
//       setHSubmitted(true);
...
//       await emailjs.send(EMAILJS_SERVICE_ID,EMAILJS_TEMPLATE_ID,buildParams({firstName:parts[0],lastName:parts.slice(1).join(" "),email:cForm.email,phone:`${cForm.dialCode} ${cForm.phone}`,service:"Manufacturing CTA",message:cForm.project,title:`New Manufacturing CTA from ${cForm.name}`}));
//       setCSubmitted(true);
...
//   const getSP   = ()=>isMobile?"40px 16px":isTablet?"60px 32px":"60px 48px";
...
//   /* ADD THESE KEYFRAMES - FIX FOR MARQUEE ANIMATIONS */
//   @keyframes marquee {
...
//   /* FIX: Ensure the tracks have proper display and width */
//   .cl-track,
//   .cl-track-rev,
//   .cl-track-slow {
...
//   .cl-track { animation: marquee 30s linear infinite; }
//   .cl-track-rev { animation: marqueeReverse 35s linear infinite; }
//   .cl-track-slow { animation: marquee 40s linear infinite; }
...
//                 <div style={{fontSize:isMobile?40:48,marginBottom:16}}>🏭</div>
//                 <h4 style={{fontSize:isMobile?16:18,fontWeight:700,marginBottom:8}}>Request Received!</h4>
//                 <p style={{color:"rgba(255,255,255,0.6)",fontSize:isMobile?13:14,marginBottom:20}}>A manufacturing specialist will contact you within 24 hours.</p>
...
//       {/* ══ MODULE 2 — LOGOS ══════════════════════════════════════════════════ */}
//       <section style={{padding:isMobile?"40px 0":"50px 0",background:N0,overflow:"hidden",borderTop:"1px solid rgba(0,201,167,.1)",borderBottom:"1px solid rgba(0,201,167,.1)"}}>
//         <div style={{textAlign:"center",marginBottom:isMobile?30:40,padding:"0 24px"}}>
//           <p style={{fontWeight:600,fontSize:isMobile?10:11.5,color:"rgba(255,255,255,.28)",letterSpacing:"0.14em",textTransform:"uppercase",marginBottom:12}}>Our Happy Clients</p>
//           <h2 style={{fontSize:isMobile?"22px":"28px",fontWeight:800,color:"#fff",letterSpacing:"-0.02em",lineHeight:1.25,margin:0}}>
//             Trusted by Businesses Across <GradText>North America &amp; the UK</GradText>
...
//               <LogoItem key={i} logo={logo} isMobile={isMobile}/>
//             ))}
//           </div>
//         </div>
...
//               <div>
//                 <p style={{color:"rgba(255,255,255,0.7)",fontSize:isMobile?14:15,lineHeight:1.7,marginBottom:20}}>
//                   Backed by <strong style={{color:T}}>Nakshatra Namaha Creations Pvt. Ltd.</strong> — 8+ years of experience, 565+ projects delivered. Dedicated client teams in Canada, USA, and UK. ERP integration specialists.
//                 </p>
//                 <div style={{display:"flex",flexDirection:"column",gap:8,marginBottom:20}}>
...
//                     <span style={{color:T,fontSize:isMobile?18:20}}>{faq===i?"−":"+"}</span>
//                   </button>
//                   {faq===i&&(<div style={{padding:isMobile?"0 16px 16px":"0 20px 20px"}}><p style={{color:"rgba(255,255,255,0.6)",fontSize:isMobile?12:13,lineHeight:1.6,margin:0}}>{item.a}</p></div>)}
//                 </div>
//               ))}
//             </div>
//           </div>
...
// ─── Marquee Row ──────────────────────────────────────────────────────────────
// We render 4 copies so the strip is always wider than the viewport.
// Animation moves -50% → seamless loop regardless of screen width.
function MarqueeRow({logos, className, isMobile}:{logos:string[]; className:string; isMobile:boolean}) {
  // 4 copies guarantees coverage even on very wide screens
...
export default function ManufacturingIndustryPage() {
  ...
  /* ── MARQUEE KEYFRAMES ─────────────────────────────────────────────────────
     All three rows animate to -50% of their own total width.
     Because we render 4 copies, exactly half = 2 copies, so the loop
     is perfectly seamless at any viewport width.
  ── */
  @keyframes marquee        { from { transform: translateX(0); }    to { transform: translateX(-50%); } }
  @keyframes marqueeReverse { from { transform: translateX(-50%); } to { transform: translateX(0); }    }
  @keyframes marqueeSlow    { from { transform: translateX(0); }    to { transform: translateX(-50%); } }

  /* Tracks: width:max-content lets them grow as wide as all children need */
  .cl-track      { animation: marquee        25s linear infinite; }
  .cl-track-rev  { animation: marqueeReverse 30s linear infinite; }
  .cl-track-slow { animation: marqueeSlow    38s linear infinite; }

  .cl-track:hover,
  .cl-track-rev:hover,
  .cl-track-slow:hover { animation-play-state: paused !important; }
...
`}</style>
      ...
      {/* ══ MODULE 2 — LOGOS ══════════════════════════════════════════════════
          Each row uses 4× duplicated logos → always wider than viewport.
          -50% translation = exactly 2 copies = perfect seamless loop.
      ══ */}
      <section style={{padding:isMobile?"40px 0":"50px 0",background:N0,overflow:"hidden",borderTop:"1px solid rgba(0,201,167,.1)",borderBottom:"1px solid rgba(0,201,167,.1)"}}>
        <div style={{textAlign:"center",marginBottom:isMobile?30:40,padding:"0 24px"}}>
          <p style={{fontWeight:600,fontSize:isMobile?10:11.5,color:"rgba(255,255,255,.28)",letterSpacing:"0.14em",textTransform:"uppercase",marginBottom:12}}>Our Happy Clients</p>
        ...
        <div style={{marginBottom:isMobile?16:20}}>
          <MarqueeRow logos={LOGOS.slice(0,6)}  className="cl-track"      isMobile={isMobile}/>
        </div>

        {/* Row 2 — right → left (reverse) */}
        <div style={{marginBottom:isMobile?16:20}}>
          <MarqueeRow logos={LOGOS.slice(6,12)} className="cl-track-rev"  isMobile={isMobile}/>
        </div>

        {/* Row 3 — left → right (slow) */}
        <MarqueeRow logos={LOGOS.slice(12,18)} className="cl-track-slow" isMobile={isMobile}/>
      </section>
