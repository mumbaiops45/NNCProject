...
// //         minHeight: isMobile ? "auto" : isTablet ? "50vh" : "60vh",
// //         display: "flex",
// //         alignItems: "center"
// //       }}>
...
// //                     target.style.boxShadow = `0 20px 40px ${model.color}20`;
...
// //                     borderRadius: "20px",
// //                     background: `linear-gradient(135deg, ${model.color}30, transparent)`,
...
// //                         <span style={{ color: T, fontSize: isMobile ? "14px" : "16px" }}>✓</span>
// //                         <span style={{ 
...
// //             borderRadius: "24px",
// //             overflow: "hidden",
// //             overflowX: isMobile && !activeCurrency ? "auto" as const : "hidden"
// //           }}>
// //             {isMobile ? (
// //               // Mobile card view
...
// //       {/* MODULE 5 — WHY CHOOSE US + CTA FORM */}
// //       <section style={{
// //         padding: getSectionPadding(),
...
// //                     <span style={{ color: T, fontSize: isMobile ? "16px" : "18px" }}>{item.split(' ')[0]}</span>
// //                     <span style={{ 
// //                       color: "rgba(255,255,255,0.7)", 
// //                       fontSize: isMobile ? "13px" : "15px" 
// //                     }}>
...
// //                   <div style={{ color: "rgba(255,255,255,0.5)", fontSize: isMobile ? "11px" : "13px" }}>{stat.label}</div>
// //                 </div>
// //               ))}
// //             </div>
// //           </div>
...
// //                 <textarea
// //                   style={{ ...iS, minHeight: isMobile ? "80px" : "100px", resize: "vertical" as const }}
...
//   // Responsive input styles - optimized height
//   const baseInputStyle: CSSProperties = {
//     width: "100%",
//     padding: isMobile ? "12px 14px" : "14px 16px",
//     borderRadius: "12px",
...
//       {/* MODULE 1 — HERO */}
//       <section style={{
//         padding: isMobile ? "40px 16px 50px" : isTablet ? "70px 32px 60px" : "40px 48px 70px",
//         background: `linear-gradient(135deg, ${N0} 0%, #041628 50%, ${N0} 100%)`,
//         position: "relative",
//         overflow: "hidden",
//         textAlign: "center" as const,
...
//                         <span style={{ color: T, fontSize: isMobile ? "13px" : "14px" }}>✓</span>
//                         <span style={{ 
//                           color: "rgba(255,255,255,0.8)", 
//                           fontSize: isMobile ? "11px" : "12px" 
//                         }}>
...
//                   marginBottom: "6px"
//                 }}>
//                   <span style={{ fontSize: isMobile ? "22px" : "24px" }}>{factor.icon}</span>
//                   <h3 style={{
//                     fontSize: isMobile ? "13px" : "14px",
//                     fontWeight: 700,
//                     color: T,
...
//                     textAlign: "center"
//                   }}>
//                     <div style={{ color: T, fontSize: isMobile ? "15px" : "17px", fontWeight: 800 }}>{stat.value}</div>
//                     <div style={{ color: "rgba(255,255,255,0.5)", fontSize: isMobile ? "9px" : "10px" }}>{stat.label}</div>
//                   </div>
//                 ))}
//               </div>
//             </div>
...
//                 </div>
//               ) : (
//                 <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: isMobile ? "8px" : "10px" }}>
//                   <input
//                     required
//                     style={iS}
//                     placeholder="Full Name *"
...
//                     overflow: "hidden",
//                     transition: "all 0.3s ease",
//                     padding: openFAQ === index ? (isMobile ? "0 14px 12px 14px" : "0 18px 14px 18px") : "0 18px",
//                     color: "rgba(255,255,255,0.6)",
//                     fontSize: isMobile ? "12px" : "13px",
//                     lineHeight: 1.6
//                   }}>
