...
// //   return (
// //     <section style={{
// //       padding: "clamp(34px,8vw,88px) clamp(16px,5vw,48px)",
...
// //         /* Metrics grid: 3 cols on ≥480px, 1 col on very small screens */
// //         .ss-metrics-grid {
// //           display: grid;
...
// //         /* Challenge/Solution grid: 2 cols on ≥600px, 1 col below */
// //         .ss-cs-grid {
// //           display: grid;
...
// //             borderRadius: 100, padding: "6px 18px", marginBottom: 14,
// //           }}>
...
// //           </div>
// //           <h2 style={{
// //             fontSize: "clamp(24px,4vw,42px)", fontWeight: 900, color: "#fff",
...
// //             </span>
// //           </h2>
// //           <p style={{ color: "rgba(255,255,255,0.45)", fontSize: "clamp(14px,2vw,16px)", lineHeight: 1.7, maxWidth: 480, margin: "0 auto" }}>
...
// //             {/* Title */}
// //             <h3 style={{
// //               color: "#fff", fontSize: "clamp(16px,2.5vw,22px)", fontWeight: 800,
...
// //                     {col.icon} {col.label}
// //                   </p>
// //                   <p style={{ color: "rgba(255,255,255,0.6)", fontSize: "clamp(13px,1.5vw,14px)", lineHeight: 1.7, margin: 0 }}>
// //                     {col.text}
// //                   </p>
// //                 </div>
// //               ))}
...
// //                   <div style={{
// //                     fontSize: "clamp(22px,3vw,30px)", fontWeight: 900, marginBottom: 4,
// //                     background: `linear-gradient(135deg,#fff 30%,${TEAL})`,
// //                     WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent",
// //                   }}>
// //                     {m.val}
// //                   </div>
// //                   <div style={{ color: "rgba(255,255,255,0.45)", fontSize: "clamp(11px,1.2vw,12px)", fontWeight: 500 }}>
// //                     {m.label}
// //                   </div>
// //                 </div>
// //               ))}
...
//   return (
//     <section style={{
//       padding: "clamp(24px,6vw,60px) clamp(16px,5vw,48px)", // 👈 REDUCED TOP PADDING from 88px to 60px max
//       background: "linear-gradient(180deg,#061425 0%,#030B18 100%)",
//       position: "relative", overflow: "hidden",
//       fontFamily: "'Poppins',sans-serif",
//     }}>
...
//           justify-content: center;
//           flex-wrap: wrap;
//           margin-bottom: 32px; // 👈 REDUCED from 36px to 32px
//         }
//         @media (max-width: 480px) {
//           .ss-tabs {
//             justify-content: flex-start;
...
//         {/* Heading */}
//         <div style={{ textAlign: "center", marginBottom: 36 }}> {/* 👈 REDUCED from 40px to 36px */}
//           <div style={{
//             display: "inline-flex", alignItems: "center", gap: 8,
//             background: "rgba(0,201,167,0.08)", border: "1px solid rgba(0,201,167,0.22)",
//             borderRadius: 100, padding: "6px 18px", marginBottom: 12, // 👈 REDUCED from 14px to 12px
//           }}>
//             <span style={{ width: 6, height: 6, borderRadius: "50%", background: TEAL, display: "block", boxShadow: `0 0 8px ${TEAL}` }} />
//             <span style={{ color: TEAL, fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase" }}>
//               Proven Results
...
//           <h2 style={{
//             fontSize: "clamp(24px,4vw,42px)", fontWeight: 900, color: "#fff",
//             letterSpacing: "-0.02em", lineHeight: 1.15, marginBottom: 12, // 👈 REDUCED from 14px to 12px
//           }}>
//             Success{" "}
//             <span style={{ background: `linear-gradient(135deg,${TEAL},#1fd1b5)`, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
//               Stories
...
//             {/* Tag + icon row */}
//             <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}> {/* 👈 REDUCED from 18px to 16px */}
//               <div style={{
//                 width: 46, height: 46, borderRadius: 12, fontSize: 22, flexShrink: 0,
//                 display: "flex", alignItems: "center", justifyContent: "center",
//                 background: CASES[active].tagColor, border: `1px solid ${CASES[active].tagBorder}`,
...
//             <h3 style={{
//               color: "#fff", fontSize: "clamp(16px,2.5vw,22px)", fontWeight: 800,
//               marginBottom: 20, lineHeight: 1.35, // 👈 REDUCED from 24px to 20px
//             }}>
//               {CASES[active].title}
//             </h3>
...
//         {/* Dot indicators */}
//         <div style={{ display: "flex", justifyContent: "center", gap: 8, marginTop: 20 }}> {/* 👈 REDUCED from 24px to 20px */}
//           {CASES.map((_, i) => (
//             <button key={i} onClick={() => setActive(i)} style={{
//               width: active === i ? 24 : 8,
//               height: 8, borderRadius: 100,
...
export default function SuccessStories() {
  ...
  return (
    <section style={{
      padding: "clamp(16px,4vw,30px) clamp(16px,5vw,48px)", // 👈 REDUCED TOP PADDING from 60px to 30px max
      background: "linear-gradient(180deg,#061425 0%,#030B18 100%)",
      position: "relative", overflow: "hidden",
      fontFamily: "'Poppins',sans-serif",
    }}>
      <style>{`
        ...
        .ss-tabs {
          ...
          justify-content: center;
          flex-wrap: wrap;
          margin-bottom: 28px; // 👈 REDUCED from 32px to 28px
        }
        @media (max-width: 480px) {
          .ss-tabs {
            justify-content: flex-start;
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", position: "relative", zIndex: 2 }}>
        ...
        {/* Heading - REDUCED marginBottom to 16 */}
        <div style={{ textAlign: "center", marginBottom: 16 }}> {/* 👈 REDUCED from 36px to 16px */}
          <div style={{
            display: "inline-flex", alignItems: "center", gap: 8,
            background: "rgba(0,201,167,0.08)", border: "1px solid rgba(0,201,167,0.22)",
            borderRadius: 100, padding: "6px 18px", marginBottom: 8, // 👈 REDUCED from 12px to 8px
          }}>
            <span style={{ width: 6, height: 6, borderRadius: "50%", background: TEAL, display: "block", boxShadow: `0 0 8px ${TEAL}` }} />
            <span style={{ color: TEAL, fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase" }}>
              Proven Results
          ...
          <h2 style={{
            fontSize: "clamp(24px,4vw,42px)", fontWeight: 900, color: "#fff",
            letterSpacing: "-0.02em", lineHeight: 1.15, marginBottom: 8, // 👈 REDUCED from 12px to 8px
          }}>
            Success{" "}
            <span style={{ background: `linear-gradient(135deg,${TEAL},#1fd1b5)`, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
              Stories
        ...
        {/* CTA */}
        <div style={{ textAlign: "center", marginTop: 30 }}> {/* 👈 REDUCED from 36px to 30px */}
          <Link href="/case-studies">
            <button className="ss-cta-btn">
              View All Case Studies →
            </button>
