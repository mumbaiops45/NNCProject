    ...
    <section style={{
      ...
      <div style={{ maxWidth:1280, margin:"0 auto", position:"relative", zIndex:2, width:"100%" }}>
        ...
        <div style={{ textAlign:"center", marginBottom:40 }}>
          ...
          {/* ✅ FIX: margin:"0 auto" centers the constrained h2 */}
          <h2 style={{
            fontSize:"clamp(26px,3vw,42px)", fontWeight:900, color:"#fff",
            letterSpacing:"-0.02em", lineHeight:1.15, marginBottom:14,
            maxWidth:680, margin:"0 auto 14px auto",
          }}>
            Your Best Custom CRM{" "}
            <span style={{ background:`linear-gradient(135deg,${TEAL},#1fd1b5)`, WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent" }}>
              Development Company
          ...
          {/* ✅ FIX: margin:"0 auto" centers the constrained p */}
          <p style={{
            color:"rgba(255,255,255,0.5)", fontSize:16, lineHeight:1.75,
            maxWidth:560, fontWeight:400, margin:"0 auto",
          }}>
            Here&apos;s what we bring to the table in terms of custom CRM development.
          </p>
        </div>
        ...
        <div className="ct-tabs" style={{
          display:"flex", gap:12, marginBottom:32,
          flexWrap:"wrap", justifyContent:"center",   // ✅ FIX
        }}>
          {TABS.map(tab => (
            <button key={tab.id} className="ct-tab" onClick={() => setActive(tab.id)} style={{
              display:"flex", alignItems:"center", gap:9,
