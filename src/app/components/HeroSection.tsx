...
// // // // const FORMSPREE_ENDPOINT = "https://formspree.io/f/mnjgkgny";
...
// // // //   }
// // // //   if (!/^[A-Za-z\s]{2,30}$/.test(name.trim())) {
// // // //     return { isValid: false, message: "Only letters (A-Z, a-z) allowed, minimum 2 characters" };
// // // //   }
...
// // // //   // Define length requirements based on country
...
// // // //   if (cleanPhone.length < rule.min) {
// // // //     return { isValid: false, message: `${rule.message} (got ${cleanPhone.length} digits)` };
// // // //   }
  
// // // //   if (cleanPhone.length > rule.max) {
// // // //     return { isValid: false, message: `${rule.message} (got ${cleanPhone.length} digits)` };
// // // //   }
  
// // // //   // Check if contains only numbers
// // // //   if (!/^\d+$/.test(cleanPhone)) {
// // // //     return { isValid: false, message: "Phone number should only contain numbers" };
// // // //   }
...
// // // //   // Check if message contains only numbers or special characters
// // // //   if (/^[\d\W]+$/.test(message.trim())) {
// // // //     return { isValid: false, message: "Please provide a meaningful message (not just numbers or symbols)" };
// // // //   }
...
// // // //   // Touch state to show errors only after user interaction
...
// // // //     switch (field) {
// // // //       case "fname":
// // // //         const fnameValidation = validateName(value);
// // // //         setErrors(prev => ({ ...prev, fname: fnameValidation.message }));
// // // //         return fnameValidation.isValid;
// // // //       case "lname":
// // // //         if (value) {
// // // //           const lnameValidation = validateName(value);
// // // //           setErrors(prev => ({ ...prev, lname: lnameValidation.message }));
// // // //           return lnameValidation.isValid;
// // // //         }
// // // //         setErrors(prev => ({ ...prev, lname: "" }));
// // // //         return true;
// // // //       case "phone":
// // // //         const phoneValidation = validatePhone(value, form.cc);
...
// // // //       case "service":
// // // //         const serviceValidation = validateService(value);
// // // //         setErrors(prev => ({ ...prev, service: serviceValidation.message }));
...
// // // //         return messageValidation.isValid;
// // // //       default:
// // // //         return true;
// // // //     }
// // // //   };
...
// // // //     // Validate all fields
// // // //     const isFnameValid = validateField("fname", form.fname);
// // // //     const isLnameValid = form.lname ? validateField("lname", form.lname) : true;
// // // //     const isPhoneValid = validateField("phone", form.phone);
// // // //     const isEmailValid = validateField("email", form.email);
// // // //     const isServiceValid = validateField("service", form.service);
// // // //     const isMessageValid = validateField("message", form.message);
    
// // // //     return isFnameValid && isLnameValid && isPhoneValid && isEmailValid && isServiceValid && isMessageValid;
// // // //   };
...
// // // //       formData.append("First Name", form.fname);
// // // //       formData.append("Last Name", form.lname);
// // // //       formData.append("Email", form.email);
// // // //       formData.append("Phone", `${form.cc} ${form.phone}`);
// // // //       formData.append("Service", form.service);
// // // //       formData.append("Message", form.message);
// // // //       formData.append("_subject", `New Consultation Request from ${form.fname} ${form.lname}`);
...
// // // //                       <input
// // // //                         className="h-inp"
// // // //                         style={touched.fname && errors.fname ? errorInputStyle : inp}
...
// // // //                         <p className="error-message" style={errorMessageStyle}>{errors.fname}</p>
// // // //                       )}
// // // //                     </div>
// // // //                     <div>
// // // //                       <input
// // // //                         className="h-inp"
// // // //                         style={touched.lname && errors.lname ? errorInputStyle : inp}
...
// // // //                         <p className="error-message" style={errorMessageStyle}>{errors.lname}</p>
// // // //                       )}
// // // //                     </div>
// // // //                   </div>
...
// // // //                       <input
// // // //                         className="h-inp"
// // // //                         style={touched.phone && errors.phone ? errorInputStyle : inp}
...
// // // //                         <p className="error-message" style={errorMessageStyle}>{errors.phone}</p>
// // // //                       )}
// // // //                     </div>
// // // //                   </div>
...
// // // //                     <input
// // // //                       className="h-inp"
// // // //                       style={touched.email && errors.email ? errorInputStyle : inp}
// // // //                       type="email"
...
// // // //                       <p className="error-message" style={errorMessageStyle}>{errors.email}</p>
// // // //                     )}
// // // //                   </div>
...
// // // //                         ...(touched.service && errors.service ? errorInputStyle : {})
// // // //                       }}
// // // //                       value={form.service}
...
// // // //                       <p className="error-message" style={errorMessageStyle}>{errors.service}</p>
// // // //                     )}
// // // //                   </div>
...
// // // //                         ...(touched.message && errors.message ? errorInputStyle : {})
// // // //                       }}
// // // //                       rows={3}
...
// // // //                       <p className="error-message" style={errorMessageStyle}>{errors.message}</p>
// // // //                     )}
// // // //                   </div>
...
// // //     try {
// // //       // Prepare form data with field names matching the email template
// // //       const formData = new FormData();
// // //       formData.append("first_name", form.fname);
// // //       formData.append("last_name", form.lname);
// // //       formData.append("email", form.email);
// // //       formData.append("phone", `${form.cc} ${form.phone}`);
// // //       formData.append("service", form.service);
// // //       formData.append("message", form.message);
// // //       formData.append("submission_time", new Date().toLocaleString());
// // //       formData.append("_subject", `🚀 New Lead: ${form.fname} ${form.lname} - ${form.service}`);
...
// // const EMAILJS_SERVICE_ID = "service_cegck"; // Your Service ID
// // const EMAILJS_TEMPLATE_ID = "YOUR_TEMPLATE_ID"; // You need to create this in EmailJS
// // const EMAILJS_PUBLIC_KEY = "oY8s46fogw6l5q1b4"; // Your Public Key
// // const YOUR_EMAIL = "mumbaiops45@gmail.com"; // Where to receive emails
...
// const YOUR_EMAIL = "mumbaiops45@gmail.com";
...
//   // EmailJS Submit Handler with all form fields
//   const handleSubmit = async () => {
//     if (!validateForm()) {
//       const firstError = document.querySelector('.error-message');
//       if (firstError) {
...
//       const templateParams = {
//         // Common variable names that EmailJS templates use
...
//       console.log("Sending email with all fields:", templateParams);
...
//         fontFamily: "'Poppins',sans-serif",
//       }}>
//         {/* Keep all your existing background and content - same as before */}
//         {!isAnyMobile && [
//           { left: "2%", top: "5%", size: isLaptop ? 580 : 680, color: "rgba(0,201,167,.07)", dur: 8 },
//           { left: "60%", top: "50%", size: isLaptop ? 380 : 480, color: "rgba(31,209,181,.05)", dur: 10 },
//           { left: "40%", top: "80%", size: isLaptop ? 240 : 290, color: "rgba(0,160,122,.06)", dur: 6 },
...
//             alignItems: "center",
//           }}>
//             {/* LEFT CONTENT - Keep your existing left content */}
//             <div>
//               <div className="hero-fade hero-fade-1" style={{
//                 display: "inline-flex", alignItems: "center",
//                 gap: isMobile ? 5 : 8,
...
export default function HeroSection() {
  ...
  const set = (k: string) => (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>) => {
    let value = e.target.value;
    if (k === "fname" || k === "lname") value = value.replace(/[^A-Za-z\s]/g, '');
    else if (k === "phone") value = value.replace(/[^\d]/g, '');
    setForm(f => ({ ...f, [k]: value }));
