        ...
        <section className="sec sec-hero">
          ...
          <div className="hero-layout">
            ...
            <div className="fade-up">
              <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "rgba(0,201,167,.08)", border: "1px solid rgba(0,201,167,.25)", borderRadius: 100, padding: "7px 18px", marginBottom: 28, animation: "heroGlow 3s ease-in-out infinite,heroFadeUp .7s ease both" }}>
                ...
                <span style={{ color: "var(--teal)", fontSize: 11.5, fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase" }}>CRM Development — Canada, USA &amp; UK</span>
              </div>
              ...
              <div style={{ display: "flex", gap: 20, flexWrap: "wrap" }}>
                {[{ flag: "🇨🇦", label: "CA:", phone: "+1 647-XXX-XXXX" }, { flag: "🇬🇧", label: "UK:", phone: "+44 20-XXXX-XXXX" }].map(p => (
                  <a key={p.phone} href={`tel:${p.phone.replace(/\s|-/g, "")}`} className="h-teal" style={{ display: "flex", alignItems: "center", gap: 7, color: "rgba(255,255,255,.5)", fontSize: 13.5, fontWeight: 600, textDecoration: "none", transition: "color .2s" }}>
            ...
            {/* Right — Form */}
            <div className="hero-form" style={{ animation: "heroFadeUp .7s ease .15s both" }}>
...
══════════════════════════════════════════════════════════════════════════════ */}
        <section className="sec sec-grad-up">
          <div className="bg-grid" style={{ backgroundSize: "56px 56px", backgroundImage: "linear-gradient(rgba(0,201,167,.02) 1px,transparent 1px),linear-gradient(90deg,rgba(0,201,167,.02) 1px,transparent 1px)" }} />
          <div className="sec-content">
            ...
            <div style={{ textAlign: "center", marginTop: 44 }}>
              <button className="btn-teal btn">View All Case Studies →</button>
            </div>
          </div>
        </section>
        ...
        <section className="sec sec-grad-n1n2-n1">
          ...
          <div className="sec-content">
            ...
            <div style={{ textAlign: "center", marginTop: 56 }}>
              <button className="btn-teal btn">View All Services →</button>
            </div>
          </div>
        </section>
        ...
        <section className="sec sec-grad-down">
          ...
          <div className="sec-content">
            ...
            <div style={{ textAlign: "center", marginTop: 52 }}>
              <button className="btn-teal btn">Start Your CRM Journey →</button>
            </div>
          </div>
        </section>
        ...
        <section className="sec sec-grad-n0n1">
          <div className="sec-content">
            ...
            <div className="two-col" style={{ marginBottom: 16 }}>
              ...
              <p className="teal" style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase" }}>By CRM Type</p>
            </div>
            <div className="two-col">
              <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            <div className="btn-row" style={{ marginTop: 48, justifyContent: "center" }}>
              <button className="btn-teal btn">📅 Hire a CRM Developer</button>
        ...
        <section className="sec sec-grad-up">
          <div className="sec-content">
            <div style={{ marginBottom: 52, maxWidth: 620 }}>
              ...
              <p style={{ color: "rgba(255,255,255,.5)", fontSize: 16, lineHeight: 1.8 }}>Our AI-backed CRM solutions aim at simplification and higher efficiency for your workflows.</p>
            </div>
            <div className="two-col-wide">
              <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                ...
                <button className="btn-teal btn" style={{ marginTop: 8, alignSelf: "flex-start" }}>🤖 Explore AI Solutions →</button>
              </div>
              {/* AI Visual Panel */}
        ...
        <section style={{ position: "relative", overflow: "hidden" }}>
          <div style={{ background: "linear-gradient(135deg,#0055b3 0%,#0077cc 35%,#00a07a 65%,#00C9A7 100%)", backgroundSize: "300% 300%", animation: "ctaBgShift 8s ease infinite", padding: "88px 48px", textAlign: "center", position: "relative" }}>
            ...
            <div style={{ position: "relative", zIndex: 2, maxWidth: 760, margin: "0 auto" }}>
              ...
              <p style={{ color: "rgba(255,255,255,.82)", fontSize: 17, lineHeight: 1.75, marginBottom: 40 }}>Connect with NNC Digital today and let&apos;s build something extraordinary together.</p>
          ...
          <div className="sec-content">
            <div className="two-col-wide">
              <div>
                ...
                <p style={{ color: "rgba(255,255,255,.55)", fontSize: 15, lineHeight: 1.8, marginBottom: 16 }}>NNC Digital Solutions is backed by <strong style={{ color: "#fff" }}>Nakshatra Namaha Creations Pvt. Ltd.</strong> — one of Bangalore&apos;s most respected digital studios with <span className="teal" style={{ fontWeight: 600 }}>8+ years of experience</span> and <span className="teal" style={{ fontWeight: 600 }}>565+ projects delivered</span>.</p>
                <p style={{ color: "rgba(255,255,255,.55)", fontSize: 15, lineHeight: 1.8, marginBottom: 32 }}>We launched NNC Digital as our international arm — bringing the same proven technical expertise to the Canadian, US, and UK markets with transparent pricing and long-term partnership.</p>
              ...
              <div>
                ...
                <div className="btn-row" style={{ marginTop: 24 }}>
                  <button className="btn-teal btn" style={{ flex: 1 }}>📅 Book a Free Strategy Call</button>
            ...
            {gTab === "int" && (
              <div>
                <div className="gp-offices" style={{ marginBottom: 24 }}>
                  {INT_OFFICES.map((o, i) => (
                    <div key={i} className="gp-card">
                      ...
                      <a href={`tel:${o.phone.replace(/\s|-/g, "")}`} className="h-teal" style={{ display: "flex", alignItems: "center", gap: 8, color: "rgba(255,255,255,.7)", fontSize: 14, fontWeight: 600, textDecoration: "none", marginBottom: 8, transition: "color .2s" }}>📞 {o.phone}</a>
                      <a href={`mailto:${o.email}`} className="h-teal" style={{ display: "flex", alignItems: "center", gap: 8, color: "rgba(255,255,255,.5)", fontSize: 13, textDecoration: "none", transition: "color .2s" }}>✉️ {o.email}</a>
                    </div>
                  ))}
                </div>
                <div style={{ borderRadius: 14, padding: "20px 28px", background: "rgba(0,201,167,.05)", border: "1px solid rgba(0,201,167,.15)", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 16 }}>
                  ...
                  <a href="mailto:hello@nncdigital.com" className="h-teal teal" style={{ fontSize: 14, fontWeight: 700, textDecoration: "none", transition: "opacity .2s" }}>hello@nncdigital.com →</a>
                </div>
              </div>
            )}
            {gTab === "india" && (
...
══════════════════════════════════════════════════════════════════════════════ */}
    ...
    M15 — CONTACT FORM
══════════════════════════════════════════════════════════════════════════════ */}
        <section className="sec sec-grad-up" style={{ background: "linear-gradient(180deg,var(--n2) 0%,var(--n0) 100%)" }}>
          <div className="sec-content-1180">
              ...
              <div style={{ background: "rgba(255,255,255,.02)", border: "1px solid rgba(255,255,255,.08)", borderRadius: 20, padding: "36px 32px" }}>
                {cSubmitted ? (
                  ...
                  <form onSubmit={handleCSubmit}>
                    ...
                    <div style={{ marginBottom: 24 }}><label className="label-upper-lg">Project Description</label><textarea className="fi fi-lg fi-textarea-lg" placeholder="Briefly describe your project, goals, and timeline..." value={cForm.project} onChange={e => setCF("project", e.target.value)} /></div>
                    <button className="btn-teal btn" type="submit" disabled={cLoading} style={{ width: "100%", padding: 15, opacity: cLoading ? .6 : 1, cursor: cLoading ? "wait" : "pointer" }}>{cLoading ? "Sending..." : "Submit — Get Free Consultation →"}</button>
