...
// //                 <R key={c.industry} d={i*0.1} from="scale">
// //                   <motion.div whileHover={{y:-8,boxShadow:"0 32px 64px rgba(0,0,0,0.45)"}}
// //                     transition={{duration:0.28}}
// //                     style={{background:c.color,borderRadius:22,padding:"42px 36px",position:"relative",overflow:"hidden",cursor:"default"}}>
...
// //                       color:"rgba(255,255,255,0.6)",marginBottom:16}}>{c.industry}</p>
// //                     <p style={{fontFamily:"var(--font-display)",fontWeight:800,fontSize:"3.5rem",
// //                       color:T.white,lineHeight:1,marginBottom:4}}>
// //                       {c.metric}
// //                     </p>
// //                     <p style={{fontSize:14,fontWeight:700,color:"rgba(255,255,255,0.85)",marginBottom:16,textTransform:"uppercase",letterSpacing:"0.06em"}}>
// //                       {c.label}
// //                     </p>
// //                     <p style={{color:"rgba(255,255,255,0.7)",fontSize:14,lineHeight:1.7}}>{c.desc}</p>
// //                     <div style={{marginTop:24,display:"inline-flex",alignItems:"center",gap:6,
// //                       background:"rgba(255,255,255,0.12)",borderRadius:100,padding:"6px 16px",
...
// //               {SERVICES.map((s,i)=>(
// //                 <R key={s.title} d={0.06*i} from="scale">
// //                   <motion.div whileHover={{y:-6,boxShadow:`0 20px 50px rgba(0,0,0,0.1), 0 0 0 1.5px ${T.teal}`}}
// //                     transition={{duration:0.25}}
// //                     style={{background:T.white,border:"1.5px solid rgba(0,201,167,0.18)",borderRadius:18,
// //                       padding:"30px 28px",cursor:"default",display:"grid",gridTemplateColumns:"1fr 1fr",gap:0,
// //                       boxShadow:"0 4px 20px rgba(0,201,167,0.06)"}}>
// //                     <div style={{borderRight:"1px dashed rgba(0,201,167,0.2)",paddingRight:20}}>
// //                       <div style={{fontSize:28,marginBottom:12}}>{s.icon}</div>
// //                       <h3 style={{fontFamily:"var(--font-display)",fontWeight:700,fontSize:15.5,color:T.navy1,marginBottom:8}}>{s.title}</h3>
// //                       <p style={{color:"rgba(1,8,18,0.5)",fontSize:13,lineHeight:1.65}}>{s.sub}</p>
// //                     </div>
// //                     <div style={{paddingLeft:20,display:"flex",flexDirection:"column",justifyContent:"center"}}>
// //                       <p style={{fontSize:11,fontWeight:700,letterSpacing:"0.1em",textTransform:"uppercase",color:"rgba(0,160,122,0.7)",marginBottom:8}}>Also includes</p>
// //                       <p style={{fontFamily:"var(--font-display)",fontWeight:600,fontSize:14,color:T.tealDark,lineHeight:1.5}}>{s.link}</p>
// //                     </div>
// //                   </motion.div>
// //                 </R>
// //               ))}
...
// //                 background:`linear-gradient(180deg,${T.teal},${T.tealDark},transparent)`,
// //                 transform:"translateX(-50%)",opacity:0.3}} className="timeline-line"/>

// //               <div style={{display:"flex",flexDirection:"column",gap:0}}>
// //                 {BENEFITS.map((b,i)=>(
// //                   <R key={b.n} d={i*0.12} from={i%2===0?"left":"right"}>
// //                     <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:0,alignItems:"center",marginBottom:0}} className="benefit-row">
// //                       {i%2===0 ? (
// //                         <>
// //                           <div style={{padding:"32px 60px 32px 0",textAlign:"right"}}>
// //                             <motion.div whileHover={{x:-4}} transition={{duration:0.2}}
// //                               style={{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(0,201,167,0.15)",
// //                                 borderRadius:18,padding:"28px 28px",display:"inline-block",textAlign:"left",maxWidth:380}}>
// //                               <h3 style={{fontFamily:"var(--font-display)",fontWeight:700,fontSize:18,color:T.white,marginBottom:10}}>{b.title}</h3>
// //                               <p style={{color:"rgba(255,255,255,0.55)",fontSize:14.5,lineHeight:1.75}}>{b.desc}</p>
// //                             </motion.div>
// //                           </div>
// //                           <div style={{padding:"32px 0 32px 60px",display:"flex",alignItems:"center",gap:20}}>
...
// //                                 boxShadow:`0 0 0 8px rgba(0,201,167,0.1)`,flexShrink:0}}>
// //                               {b.n}
// //                             </motion.div>
// //                           </div>
// //                         </>
// //                       ) : (
// //                         <>
// //                           <div style={{padding:"32px 60px 32px 0",display:"flex",alignItems:"center",justifyContent:"flex-end",gap:20}}>
// //                             <motion.div whileHover={{scale:1.08}} transition={{duration:0.2}}
// //                               style={{width:64,height:64,borderRadius:"50%",
// //                                 background:`linear-gradient(135deg,${T.teal},${T.tealDark})`,
// //                                 display:"flex",alignItems:"center",justifyContent:"center",
...
// //                             </motion.div>
// //                           </div>
// //                           <div style={{padding:"32px 0 32px 60px"}}>
// //                             <motion.div whileHover={{x:4}} transition={{duration:0.2}}
// //                               style={{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(0,201,167,0.15)",
// //                                 borderRadius:18,padding:"28px 28px",maxWidth:380}}>
// //                               <h3 style={{fontFamily:"var(--font-display)",fontWeight:700,fontSize:18,color:T.white,marginBottom:10}}>{b.title}</h3>
// //                               <p style={{color:"rgba(255,255,255,0.55)",fontSize:14.5,lineHeight:1.75}}>{b.desc}</p>
// //                             </motion.div>
// //                           </div>
...
// //               {PLATFORMS.map((p,i)=>(
// //                 <R key={p.name} d={0.05*i} from="scale">
// //                   <motion.div whileHover={{y:-6,borderColor:T.teal,background:"rgba(0,201,167,0.06)"}}
// //                     transition={{duration:0.25}}
// //                     style={{background:"rgba(6,20,37,0.8)",border:"1px solid rgba(0,201,167,0.14)",
// //                       borderRadius:16,padding:"28px 24px",textAlign:"center",cursor:"default",
// //                       backdropFilter:"blur(12px)"}}>
// //                     <div style={{fontSize:36,marginBottom:14}}>{p.icon}</div>
// //                     <h3 style={{fontFamily:"var(--font-display)",fontWeight:700,fontSize:15,color:T.white,marginBottom:6}}>{p.name}</h3>
// //                     <p style={{color:"rgba(255,255,255,0.42)",fontSize:12.5,lineHeight:1.6}}>{p.desc}</p>
// //                   </motion.div>
// //                 </R>
// //               ))}
// //             </div>
...
// //                 {HIRE_LEFT.map((h,i)=>(
// //                   <R key={h.title} d={i*0.1} from="left">
// //                     <motion.div whileHover={{x:4,borderColor:T.teal}} transition={{duration:0.22}}
// //                       style={{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.07)",
// //                         borderRadius:14,padding:"24px 26px",display:"flex",alignItems:"flex-start",gap:16}}>
// //                       <div style={{width:40,height:40,borderRadius:10,
// //                         background:`linear-gradient(135deg,rgba(0,201,167,0.18),rgba(0,201,167,0.04))`,
// //                         border:`1px solid rgba(0,201,167,0.2)`,
// //                         display:"flex",alignItems:"center",justifyContent:"center",
// //                         fontFamily:"var(--font-display)",fontWeight:800,fontSize:14,color:T.teal,flexShrink:0}}>
// //                         {["E","S","A"][i]}
// //                       </div>
// //                       <div>
// //                         <h3 style={{fontFamily:"var(--font-display)",fontWeight:700,fontSize:16,color:T.white,marginBottom:6}}>{h.title}</h3>
// //                         <p style={{color:"rgba(255,255,255,0.5)",fontSize:13.5,lineHeight:1.68}}>{h.desc}</p>
// //                       </div>
// //                     </motion.div>
// //                   </R>
// //                 ))}
...
// //               <div style={{display:"flex",flexDirection:"column",gap:16}}>
// //                 {HIRE_RIGHT.map((h,i)=>(
// //                   <R key={h.title} d={i*0.1} from="right">
// //                     <motion.div whileHover={{x:-4,borderColor:T.teal}} transition={{duration:0.22}}
// //                       style={{background:`rgba(0,201,167,0.05)`,border:"1px solid rgba(0,201,167,0.15)",
// //                         borderRadius:14,padding:"24px 26px",display:"flex",alignItems:"flex-start",gap:16}}>
// //                       <div style={{width:40,height:40,borderRadius:10,
// //                         background:`linear-gradient(135deg,rgba(0,201,167,0.2),rgba(0,201,167,0.06))`,
...
// //               {AI_FEATURES.map((a,i)=>(
// //                 <R key={a.title} d={0.08*i} from="scale">
// //                   <motion.div whileHover={{y:-8,boxShadow:`0 24px 56px rgba(0,0,0,0.4), 0 0 0 1px ${T.teal}44`}}
// //                     transition={{duration:0.28}}
// //                     style={{background:"rgba(255,255,255,0.97)",borderRadius:18,padding:"32px 28px",cursor:"default",
...
// //                       {a.icon}
// //                     </div>
// //                     <h3 style={{fontFamily:"var(--font-display)",fontWeight:700,fontSize:17,color:T.navy1,marginBottom:10}}>{a.title}</h3>
// //                     <p style={{color:"rgba(1,8,18,0.55)",fontSize:13.5,lineHeight:1.7}}>{a.desc}</p>
// //                   </motion.div>
// //                 </R>
// //               ))}
// //             </div>
...
// //                   style={{position:"absolute",top:20,left:20,opacity:0.7}}/>
// //               </motion.div>
// //             </R>
// //           </div>
// //         </section>
