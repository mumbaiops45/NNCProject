...
//           .two-col-wide { grid-template-columns:1fr!important; gap:32px!important; }
...
//             <div style={{display:"inline-flex",alignItems:"center",gap:8,background:"rgba(0,201,167,0.08)",border:"1px solid rgba(0,201,167,0.25)",borderRadius:100,padding:"7px 18px",marginBottom:28,animation:"heroGlow 3s ease-in-out infinite,heroFadeUp .7s ease both"}}>
//               <span style={{width:7,height:7,borderRadius:"50%",background:T,boxShadow:`0 0 10px ${T}`,animation:"heroBlink 1.4s ease-in-out infinite"}} />
//               <span style={{color:T,fontSize:"clamp(10px,1.2vw,11.5px)",fontWeight:700,letterSpacing:"0.1em",textTransform:"uppercase" as const}}>Digital Transformation — Canada, USA &amp; UK</span>
//             </div>
...
//             <SectionBadge label="Proven Results" />
//             <SectionH2>Digital Transformation <GradText>Success Stories</GradText></SectionH2>
//             <p style={{color:"rgba(255,255,255,0.45)",fontSize:"clamp(14px,1.3vw,16px)",lineHeight:1.7,maxWidth:500,margin:"0 auto"}}>Real transformation results for businesses in Canada, USA &amp; UK.</p>
//           </div>
//           <div style={{display:"flex",gap:10,justifyContent:"center",marginBottom:40,flexWrap:"wrap"}}>
//             {SUCCESS_STORIES.map((c,i)=>(
//               <button key={i} className={`ss-tab${story===i?" act":""}`} onClick={()=>setStory(i)}><span>{c.icon}</span>{c.industry} — {c.result}</button>
...
//           </div>
//           <div style={{textAlign:"center",marginTop:44}}>
//             {/* ✅ Button redirects to /case-studies */}
//             <a href="/case-studies" style={{display:"inline-block",padding:"14px 36px",borderRadius:10,background:`linear-gradient(135deg,${T},${TD})`,color:"#000",fontWeight:700,fontSize:15,fontFamily:"'Poppins',sans-serif",cursor:"pointer",textDecoration:"none",transition:"transform .2s,box-shadow .2s"}}
//               onMouseEnter={e=>{(e.currentTarget as HTMLElement).style.transform="translateY(-3px)";(e.currentTarget as HTMLElement).style.boxShadow="0 12px 32px rgba(0,201,167,.25)";}}
//               onMouseLeave={e=>{(e.currentTarget as HTMLElement).style.transform="";(e.currentTarget as HTMLElement).style.boxShadow="";}}>View All Case Studies →</a>
//           </div>
//         </div>
//       </section>
...
//             <SectionBadge label="What We Deliver" />
//             <SectionH2>Digital Transformation <GradText>Services We Offer</GradText></SectionH2>
//             <p style={{color:"rgba(255,255,255,0.5)",fontSize:"clamp(14px,1.3vw,16px)",lineHeight:1.75,maxWidth:580,margin:"0 auto"}}>End-to-end transformation capabilities for businesses across Canada, USA &amp; UK.</p>
//           </div>
//           <div className="svc-grid" style={{gridTemplateColumns:"repeat(3,1fr)"}}>
//             {SERVICES.map((s,i)=>(
//               <a key={s.title} href={`/services/${s.slug}`} className="svc-card" style={{animationDelay:`${i*.06}s`,textDecoration:"none"}}>
//                 <div style={{display:"flex",alignItems:"flex-start",justifyContent:"space-between",gap:12}}>
//                   <div className="svc-icon" style={{width:52,height:52,borderRadius:14,background:"rgba(0,201,167,0.1)",border:"1px solid rgba(0,201,167,0.2)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:24,flexShrink:0,transition:"background .3s,transform .3s"}}>{s.icon}</div>
//                   <span style={{padding:"3px 10px",borderRadius:100,fontSize:10.5,fontWeight:600,letterSpacing:"0.08em",textTransform:"uppercase" as const,color:T,background:"rgba(0,201,167,0.08)",border:"1px solid rgba(0,201,167,0.18)"}}>{s.tag}</span>
//                 </div>
...
//             <a href="/services" style={{display:"inline-block",padding:"14px 36px",borderRadius:10,background:`linear-gradient(135deg,${T},${TD})`,border:"none",color:"#000",fontWeight:700,fontSize:15,fontFamily:"'Poppins',sans-serif",cursor:"pointer",textDecoration:"none",transition:"transform .2s,box-shadow .2s"}}
//               onMouseEnter={e=>{(e.currentTarget as HTMLElement).style.transform="translateY(-3px)";(e.currentTarget as HTMLElement).style.boxShadow="0 12px 32px rgba(0,201,167,.25)";}}
//               onMouseLeave={e=>{(e.currentTarget as HTMLElement).style.transform="";(e.currentTarget as HTMLElement).style.boxShadow="";}}>View All Services →</a>
//           </div>
//         </div>
//       </section>
...
//             <SectionBadge label="Why Transform" />
//             <SectionH2>Key Benefits of <GradText>Digital Transformation</GradText></SectionH2>
//             <p style={{color:"rgba(255,255,255,0.45)",fontSize:"clamp(14px,1.3vw,16px)",lineHeight:1.75,maxWidth:520,margin:"0 auto"}}>Here&apos;s what you gain when you embark on a structured digital transformation journey with us.</p>
//           </div>
//           <div className="kb-grid" style={{gridTemplateColumns:"repeat(4,1fr)"}}>
//             {BENEFITS.map((b,i)=>(
//               <div key={i} className="kb-card" style={{animationDelay:`${i*.12}s`}}>
...
//           </div>
//           <div style={{textAlign:"center",marginTop:52}}>
//             {/* ✅ Redirects to contact/get-started */}
//             <a href="/contact" style={{display:"inline-block",padding:"14px 36px",borderRadius:10,border:"none",background:`linear-gradient(135deg,${T},${TD})`,color:"#000",fontWeight:700,fontSize:15,fontFamily:"'Poppins',sans-serif",cursor:"pointer",textDecoration:"none",transition:"transform .2s,box-shadow .2s"}}
//               onMouseEnter={e=>{(e.currentTarget as HTMLElement).style.transform="translateY(-3px)";(e.currentTarget as HTMLElement).style.boxShadow="0 12px 32px rgba(0,201,167,.25)";}}
//               onMouseLeave={e=>{(e.currentTarget as HTMLElement).style.transform="";(e.currentTarget as HTMLElement).style.boxShadow="";}}>Start Your Transformation →</a>
//           </div>
//         </div>
//       </section>
...
//             <SectionBadge label="Our Tech Stack" />
//             <SectionH2>Leading Platform Tools <GradText>That We Use</GradText></SectionH2>
//             <p style={{color:"rgba(255,255,255,0.45)",fontSize:"clamp(14px,1.3vw,16px)",lineHeight:1.75,maxWidth:560,margin:"0 auto"}}>We leverage best-in-class tools to build and execute your transformation roadmap.</p>
//           </div>
//           <div className="pt-grid" style={{gridTemplateColumns:"repeat(5,1fr)"}}>
//             {TOOLS.map((tool,i)=>(
//               <div key={i} className="pt-card" style={{background:tool.clr,border:`1px solid ${tool.bd}`}}>
...
//             <SectionBadge label="Tailored Approach" />
//             <SectionH2>Transformation <GradText>Tailored to Your Needs</GradText></SectionH2>
//             <p style={{color:"rgba(255,255,255,0.45)",fontSize:"clamp(14px,1.3vw,16px)",lineHeight:1.75,maxWidth:560,margin:"0 auto"}}>We adapt our transformation framework to your business type and strategic goals.</p>
//           </div>
//           <div className="two-col" style={{marginBottom:16}}>
//             <p style={{color:T,fontSize:11,fontWeight:700,letterSpacing:"0.12em",textTransform:"uppercase" as const}}>By Business Type</p>
//             <p style={{color:T,fontSize:11,fontWeight:700,letterSpacing:"0.12em",textTransform:"uppercase" as const}}>By Transformation Type</p>
...
//           </div>
//           <div style={{display:"flex",gap:16,marginTop:48,justifyContent:"center",flexWrap:"wrap"}}>
//             {/* ✅ Redirects to /hire-crm or /digital-readiness-assessment */}
//             <a href="/digital-readiness-assessment" style={{display:"inline-block",padding:"14px 32px",borderRadius:10,border:"none",background:`linear-gradient(135deg,${T},${TD})`,color:"#000",fontWeight:700,fontSize:15,fontFamily:"'Poppins',sans-serif",cursor:"pointer",textDecoration:"none",transition:"transform .2s,box-shadow .2s"}}
//               onMouseEnter={e=>{(e.currentTarget as HTMLElement).style.transform="translateY(-3px)";(e.currentTarget as HTMLElement).style.boxShadow="0 12px 32px rgba(0,201,167,.25)";}}
//               onMouseLeave={e=>{(e.currentTarget as HTMLElement).style.transform="";(e.currentTarget as HTMLElement).style.boxShadow="";}}>🔍 Get a Readiness Assessment</a>
...
//         <div style={{position:"absolute",top:"0%",left:"50%",transform:"translateX(-50%)",width:700,height:400,borderRadius:"50%",background:"radial-gradient(ellipse,rgba(0,201,167,0.05) 0%,transparent 65%)",pointerEvents:"none",zIndex:0}} />
//         <div style={{maxWidth:1280,margin:"0 auto",position:"relative",zIndex:2}}>
//           <div style={{marginBottom:52,maxWidth:620,marginLeft:"auto",marginRight:"auto",textAlign:"center"}}>
//             <SectionBadge label="AI-Powered" />
//             <SectionH2>Leverage <GradText>AI-Powered Transformation</GradText> Solutions</SectionH2>
//             <p style={{color:"rgba(255,255,255,0.5)",fontSize:"clamp(14px,1.3vw,16px)",lineHeight:1.8}}>We embed AI into your transformation roadmap to deliver predictive insights, intelligent automation, and a true competitive advantage.</p>
//           </div>
//           <div className="ai-feat-grid" style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:20}}>
//             {AI_FEATS.map((f,i)=>(
...
//       ══════════════════════════════════════════════════ */}
//       <section style={{position:"relative",overflow:"hidden"}}>
//         <div style={{background:"linear-gradient(135deg,#0055b3 0%,#0077cc 35%,#00a07a 65%,#00C9A7 100%)",backgroundSize:"300% 300%",animation:"ctaBgShift 8s ease infinite",padding:"clamp(60px,8vw,88px) clamp(20px,5vw,48px)",textAlign:"center",position:"relative"}}>
//           <div style={{position:"absolute",top:"-20%",left:"-5%",width:350,height:350,borderRadius:"50%",background:"radial-gradient(circle,rgba(255,255,255,0.1) 0%,transparent 65%)",pointerEvents:"none"}} />
//           <div style={{position:"absolute",bottom:"-20%",right:"-5%",width:300,height:300,borderRadius:"50%",background:"radial-gradient(circle,rgba(255,255,255,0.08) 0%,transparent 65%)",pointerEvents:"none"}} />
//           <div style={{position:"absolute",inset:0,pointerEvents:"none",backgroundImage:"linear-gradient(rgba(255,255,255,0.04) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,0.04) 1px,transparent 1px)",backgroundSize:"48px 48px"}} />
//           <div style={{position:"relative",zIndex:2,maxWidth:760,margin:"0 auto"}}>
...
//               Want Digital Transformation That Takes Your<br />Business to the <span style={{textDecoration:"underline",textDecorationColor:"rgba(255,255,255,0.4)"}}>Next Level?</span>
//             </h2>
//             <p style={{color:"rgba(255,255,255,0.82)",fontSize:"clamp(14px,1.5vw,17px)",lineHeight:1.75,marginBottom:40}}>Connect with NNC Digital today and let's build your transformation roadmap together.</p>
//             <div style={{display:"flex",gap:16,justifyContent:"center",flexWrap:"wrap"}}>
//               {/* ✅ Redirects to /contact */}
//               <a href="/contact" style={{display:"inline-flex",alignItems:"center",gap:10,padding:"16px 40px",borderRadius:12,background:"#fff",color:"#0055b3",fontWeight:800,fontSize:"clamp(13px,1.3vw,16px)",fontFamily:"'Poppins',sans-serif",border:"none",cursor:"pointer",textDecoration:"none",transition:"transform .2s,box-shadow .2s"}}
//                 onMouseEnter={e=>{(e.currentTarget as HTMLElement).style.transform="translateY(-3px)";(e.currentTarget as HTMLElement).style.boxShadow="0 16px 40px rgba(0,0,0,0.25)";}}
...
//               {/* ✅ Redirects to /book-consultation */}
//               <a href="/book-consultation" style={{display:"inline-flex",alignItems:"center",gap:10,padding:"16px 36px",borderRadius:12,background:"transparent",color:"#fff",fontWeight:700,fontSize:"clamp(13px,1.3vw,16px)",fontFamily:"'Poppins',sans-serif",border:"2px solid rgba(255,255,255,0.5)",cursor:"pointer",textDecoration:"none",transition:"border-color .2s,background .2s"}}
//                 onMouseEnter={e=>{(e.currentTarget as HTMLElement).style.borderColor="#fff";(e.currentTarget as HTMLElement).style.background="rgba(255,255,255,0.1)";}}
...
//           <div style={{display:"flex",gap:16,justifyContent:"center",flexWrap:"wrap"}}>
//             <a href="/book-consultation" style={{display:"inline-block",padding:"14px 32px",borderRadius:10,border:"none",background:`linear-gradient(135deg,${T},${TD})`,color:"#000",fontWeight:700,fontSize:15,fontFamily:"'Poppins',sans-serif",cursor:"pointer",textDecoration:"none",transition:"transform .2s,box-shadow .2s"}}
//               onMouseEnter={e=>{(e.currentTarget as HTMLElement).style.transform="translateY(-3px)";(e.currentTarget as HTMLElement).style.boxShadow="0 12px 32px rgba(0,201,167,.25)";}}
//               onMouseLeave={e=>{(e.currentTarget as HTMLElement).style.transform="";(e.currentTarget as HTMLElement).style.boxShadow="";}}>📅 Book a Strategy Call</a>
...
//             <SectionBadge label="FAQs" />
//             <SectionH2>Frequently Asked <GradText>Questions</GradText></SectionH2>
//             <p style={{color:"rgba(255,255,255,0.45)",fontSize:"clamp(13px,1.2vw,15px)",lineHeight:1.75,maxWidth:520,margin:"0 auto"}}>Everything you need to know about digital transformation for businesses in Canada, USA &amp; UK.</p>
//           </div>
//           <div style={{display:"flex",flexDirection:"column",gap:12}}>
//             {FAQS.map((f,i)=>(
//               <div key={i} className={`faq-item${faq===i?" fopen":""}`} onClick={()=>setFaq(faq===i?null:i)} style={{border:`1px solid ${faq===i?"rgba(0,201,167,0.4)":"rgba(255,255,255,0.08)"}`,borderRadius:16,background:faq===i?"rgba(0,201,167,0.06)":"rgba(255,255,255,0.02)",overflow:"hidden",cursor:"pointer",transition:"all .25s ease"}}>
...
//             <p style={{color:"rgba(255,255,255,0.4)",fontSize:14,marginBottom:20}}>Still have questions? We respond within 24 hours.</p>
//             {/* ✅ Redirects to /contact */}
//             <a href="/contact" style={{display:"inline-block",padding:"13px 32px",borderRadius:10,border:"none",background:`linear-gradient(135deg,${T},${TD})`,color:"#000",fontWeight:700,fontSize:15,fontFamily:"'Poppins',sans-serif",cursor:"pointer",textDecoration:"none",transition:"transform .2s,box-shadow .2s"}}
//               onMouseEnter={e=>{(e.currentTarget as HTMLElement).style.transform="translateY(-3px)";(e.currentTarget as HTMLElement).style.boxShadow="0 12px 32px rgba(0,201,167,.25)";}}
//               onMouseLeave={e=>{(e.currentTarget as HTMLElement).style.transform="";(e.currentTarget as HTMLElement).style.boxShadow="";}}>Ask Us Anything →</a>
//           </div>
//         </div>
//       </section>
...
//             <SectionBadge label="Get In Touch" />
//             <SectionH2>Ready to Build <GradText>Next-Level</GradText> Custom Digital Solutions?</SectionH2>
//             <p style={{color:"rgba(255,255,255,0.45)",fontSize:"clamp(13px,1.3vw,15.5px)",lineHeight:1.75,maxWidth:540,margin:"0 auto"}}>Tell us about your transformation goals. We'll respond within 24 hours with a free consultation.</p>
//           </div>
//           <div className="cf-grid">
//             {/* Left — Form */}
