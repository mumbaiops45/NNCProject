...
//     if (isMobile) return "56px 20px";
//     if (isTablet) return "72px 32px";
//     return "108px 48px";
//   };

//   const getHeroPadding = () => {
//     if (isMobile) return "80px 20px 60px";
//     if (isTablet) return "100px 32px 70px";
...
//           @media (max-width: 960px) {
//             .nnc-story-grid, .nnc-parent-grid, .nnc-why-grid, .nnc-offices-grid { grid-template-columns: 1fr !important; gap: 32px !important; }
//             .nnc-stat-grid { grid-template-columns: repeat(2,1fr) !important; }
//           }
//           @media (max-width: 720px) {
//             .nnc-values-grid { grid-template-columns: 1fr 1fr !important; gap: 14px !important; }
//             .nnc-comp-grid { grid-template-columns: 1fr !important; gap: 8px !important; }
//             .nnc-comp-grid > div { padding: 12px 16px !important; }
//           }
//           @media (max-width: 520px) {
//             .nnc-values-grid { grid-template-columns: 1fr !important; }
//             .nnc-stat-grid { grid-template-columns: 1fr 1fr !important; }
//             .nnc-mini-stats { gap: 8px !important; }
//             .nnc-mini-stats > div { padding: 16px 10px !important; }
//             .nnc-why-item { padding: 8px 10px !important; }
//             .nnc-why-item p { font-size: 13px !important; }
//           }
//         `}</style>
...
//           <div style={{ maxWidth: 1220, margin: "0 auto", position: "relative", zIndex: 3, width: "100%", padding: isMobile ? "0 10px" : "0" }}>
//             <div ref={heroIO.ref} style={{ textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center" }}>
...
//                 background: "rgba(0,201,167,.07)", border: "1px solid rgba(0,201,167,.22)",
//                 borderRadius: 40, padding: isMobile ? "6px 16px" : "8px 20px", marginBottom: isMobile ? 24 : 36,
//                 animation: "glowPulse 3.5s ease-in-out infinite",
//               }}>
//                 <div style={{
...
//               {/* CTAs */}
//               <div className="nnc-hero-btns" style={{ display: "flex", gap: isMobile ? 12 : 14, flexWrap: "wrap", justifyContent: "center" }}>
//                 <MagBtn primary>Book a Free Consultation</MagBtn>
//                 <MagBtn>View Our Work →</MagBtn>
//               </div>
//             </div>
...
//                   {STATS.map((s, i) => (
//                     <div key={i} className="nnc-stat-cell" style={{
//                       padding: isMobile ? "20px 12px" : "32px 24px", textAlign: "center",
//                       background: "rgba(5,16,32,.7)",
...
//                       <p style={{
//                         fontFamily: "'Poppins', sans-serif",
//                         fontSize: isMobile ? "clamp(24px, 6vw, 28px)" : isTablet ? "clamp(28px, 3vw, 36px)" : "clamp(32px, 3.2vw, 48px)",
//                         fontWeight: 700, margin: 0,
//                         ...gradText as object,
//                       }}>
//                         <Counter to={s.value} suffix={s.suffix} active={statsIO.visible} />
//                       </p>
//                       <p style={{
//                         fontSize: isMobile ? 9 : 10, color: "rgba(255,255,255,.38)",
...
//                     fontWeight: 700, lineHeight: 1.2, marginBottom: isMobile ? 20 : 30, marginTop: 0,
//                   }}>
//                     From Bangalore to Canada —{" "}
//                     <span style={gradText as object}>The NNC Digital Story</span>
//                   </h2>
...
//                   ].map((para, i) => (
//                     <p key={i} style={{
//                       color: "rgba(255,255,255,.5)", fontSize: isMobile ? 14 : 15, lineHeight: 1.8,
//                       marginBottom: 16,
//                       animation: `slideIn .6s ease ${.15 + i * .15}s both`,
//                     }}>{para}</p>
//                   ))}
...
//                   {/* Pill */}
//                   <div style={{
//                     marginTop: 26, padding: isMobile ? "14px 18px" : "18px 22px", borderRadius: 14,
//                     background: "rgba(0,201,167,.05)", border: "1px solid rgba(0,201,167,.18)",
//                     display: "flex", alignItems: "center", gap: 16,
//                     transition: "transform .25s, background .25s", cursor: "default",
//                   }}
...
//                     <span style={{ fontSize: 28 }}>🇮🇳</span>
//                     <div>
//                       <p style={{ fontSize: isMobile ? 12.5 : 13.5, fontWeight: 700, color: "#fff", margin: 0 }}>
//                         Bangalore → Toronto · New York · London
//                       </p>
//                       <p style={{ fontSize: isMobile ? 11 : 12, color: "rgba(255,255,255,.38)", margin: "3px 0 0" }}>
//                         One trusted studio. Three international markets.
//                       </p>
//                     </div>
//                   </div>
...
//             <FadeUp style={{ textAlign: "center", marginBottom: isMobile ? 40 : 60 } as React.CSSProperties}>
//               <SectionLabel>Backed By</SectionLabel>
//               <h2 style={{
//                 fontFamily: "'Poppins', sans-serif",
...
//             <FadeUp delay={0.1}>
//               <div style={{
//                 borderRadius: 24, padding: isMobile ? "24px 20px" : "44px 48px", marginBottom: isMobile ? 32 : 50,
//                 background: "rgba(0,201,167,.04)",
//                 border: "1px solid rgba(0,201,167,.18)",
//                 transition: "box-shadow .35s",
//               }}
...
//                 <div className="nnc-parent-grid">
//                   <div>
//                     <p style={{ fontSize: isMobile ? 14 : 15, color: "rgba(255,255,255,.52)", lineHeight: 1.8, margin: "0 0 20px" }}>
//                       Headquartered in <strong style={{ color: "#fff", fontWeight: 700 }}>Bengaluru, Karnataka</strong> — India&apos;s Silicon Valley — with offices in Mysore, Mumbai, and Hyderabad. A full-spectrum digital studio combining creative excellence with engineering rigour.
//                     </p>
//                     <a
//                       href="https://www.nakshatranamahacreations.com"
...
//                         textDecoration: "none",
//                         padding: isMobile ? "8px 14px" : "10px 18px", borderRadius: 10,
//                         background: "rgba(0,201,167,.08)", border: "1px solid rgba(0,201,167,.2)",
//                         transition: "background .2s, gap .2s",
//                       }}
//                       onMouseEnter={e => {
...
//                     ].map((s, i) => (
//                       <div key={i} style={{
//                         textAlign: "center", padding: isMobile ? "16px 8px" : "22px 14px", borderRadius: 16,
//                         background: "rgba(0,201,167,.06)", border: "1px solid rgba(0,201,167,.13)",
//                         transition: "transform .28s, background .28s", cursor: "default",
//                       }}
//                         onMouseEnter={e => {
...
//                         <p style={{
//                           fontFamily: "'Poppins', sans-serif",
//                           fontSize: isMobile ? 24 : 28, fontWeight: 700, color: T.teal, margin: 0,
//                         }}>{s.n}</p>
//                         <p style={{
//                           fontSize: isMobile ? 9 : 10, color: "rgba(255,255,255,.38)",
...
//                 textTransform: "uppercase", color: "rgba(255,255,255,.3)", marginBottom: 14,
//               }}>Parent Company Services That Power NNC Digital</p>
//               <div style={{ overflow: "hidden", maskImage: "linear-gradient(90deg, transparent, black 8%, black 92%, transparent)", marginBottom: isMobile ? 32 : 50 }}>
//                 <div className="nnc-tag-belt">
//                   {[...PARENT_SERVICES, ...PARENT_SERVICES].map((s, i) => (
//                     <span key={i} style={{
...
//                       background: "rgba(255,255,255,.04)",
//                       border: "1px solid rgba(255,255,255,.09)",
//                       padding: isMobile ? "7px 16px" : "9px 20px", borderRadius: 40, whiteSpace: "nowrap",
//                       transition: "background .2s, color .2s, border-color .2s", cursor: "default",
//                     }}
//                       onMouseEnter={e => {
//                         (e.currentTarget as HTMLElement).style.background = "rgba(0,201,167,.1)";
...
//                 {COMPARISON.map((row, i) => (
//                   <div key={i} className="nnc-comp-row nnc-comp-grid" style={{
//                     padding: isMobile ? "12px 16px" : "19px 28px",
//                     background: i % 2 === 0 ? "rgba(255,255,255,.015)" : "transparent",
//                     borderBottom: i < COMPARISON.length - 1 ? "1px solid rgba(255,255,255,.04)" : "none",
//                   }}>
//                     <p style={{ fontSize: isMobile ? 12 : 13, fontWeight: 700, color: "rgba(255,255,255,.55)", margin: 0 }}>{row.metric}</p>
//                     <p style={{ fontSize: isMobile ? 12 : 13, color: "rgba(255,255,255,.82)", margin: isMobile ? "4px 0" : 0 }}>{row.parent}</p>
...
//               <FadeUp delay={0.08}>
//                 <div style={{
//                   borderRadius: 22, padding: isMobile ? "28px 22px" : "42px 38px", height: "100%",
//                   background: "rgba(255,255,255,.025)",
//                   border: "1px solid rgba(255,255,255,.07)",
//                   transition: "border-color .3s, transform .32s",
//                 }}
...
//                   <h3 style={{
//                     fontFamily: "'Poppins', sans-serif",
//                     fontSize: isMobile ? 18 : 20, fontWeight: 700, color: "#fff", marginBottom: 16, marginTop: 0,
//                   }}>The Gap We Saw</h3>
//                   <p style={{ color: "rgba(255,255,255,.48)", fontSize: isMobile ? 14 : 15, lineHeight: 1.8, margin: "0 0 14px" }}>
//                     Businesses in Canada, the USA, and the UK face a common challenge: local agencies charge premium prices for work that can be delivered at a fraction of the cost — without any quality reduction — by the right offshore partner.
//                   </p>
//                   <p style={{ color: "rgba(255,255,255,.48)", fontSize: isMobile ? 14 : 15, lineHeight: 1.8, margin: 0 }}>
//                     Most offshore agencies fail because they don&apos;t understand the regulatory environment, commercial culture, or specific needs of Western businesses.
//                   </p>
//                 </div>
//               </FadeUp>
...
//                   <h3 style={{
//                     fontFamily: "'Poppins', sans-serif",
//                     fontSize: isMobile ? 18 : 20, fontWeight: 700, color: "#fff", marginBottom: 18, marginTop: 0,
//                   }}>The Solution We Built</h3>
...
//                           fontSize: 11, color: "#001a14", fontWeight: 900,
//                         }}>✓</div>
//                         <p style={{ color: "rgba(255,255,255,.7)", fontSize: isMobile ? 13 : 14, lineHeight: 1.6, margin: 0 }}>{item}</p>
//                       </div>
//                     ))}
//                   </div>
//                 </div>
...
//             {/* Values heading */}
//             <FadeUp style={{ textAlign: "center", marginBottom: isMobile ? 40 : 56 } as React.CSSProperties}>
//               <SectionLabel>Our Values</SectionLabel>
//               <h2 style={{
//                 fontFamily: "'Poppins', sans-serif",
//                 fontSize: isMobile ? "clamp(22px, 5vw, 26px)" : isTablet ? "clamp(24px, 3vw, 32px)" : "clamp(28px, 2.9vw, 42px)",
...
//             {/* Values grid */}
//             <div className="nnc-values-grid" style={{ marginBottom: isMobile ? 60 : 96 }}>
//               {VALUES.map((v, i) => (
//                 <FadeUp key={i} delay={0.07 * i}>
//                   <div
//                     className="nnc-val-card"
...
//                     )}
//                     <div style={{
//                       fontSize: isMobile ? 32 : 36, marginBottom: 16, display: "inline-block",
//                       transition: "transform .35s cubic-bezier(.16,1,.3,1)",
//                       transform: hoveredVal === i ? "scale(1.2) rotate(-6deg)" : "scale(1)",
//                     }}>{v.icon}</div>
//                     <p style={{ fontSize: isMobile ? 14 : 15, fontWeight: 700, color: "#fff", marginBottom: 6, marginTop: 0 }}>{v.title}</p>
//                     <p style={{ fontSize: isMobile ? 12 : 13, color: "rgba(255,255,255,.42)", lineHeight: 1.7, margin: 0 }}>{v.desc}</p>
//                   </div>
//                 </FadeUp>
//               ))}
//             </div>
...
//             {/* Offices heading */}
//             <FadeUp style={{ textAlign: "center", marginBottom: 32 } as React.CSSProperties}>
//               <h2 style={{
//                 fontFamily: "'Poppins', sans-serif",
...
//             {/* Offices grid */}
//             <div className="nnc-offices-grid" style={{ marginBottom: isMobile ? 60 : 88 }}>

//               {/* International */}
//               <FadeUp delay={0.08}>
//                 <div style={{
//                   borderRadius: 22, padding: isMobile ? "28px 22px" : "38px 34px",
//                   background: "rgba(0,201,167,.04)", border: "1px solid rgba(0,201,167,.18)",
//                   transition: "transform .3s, box-shadow .3s",
//                 }}
//                   onMouseEnter={e => {
...
//                     textTransform: "uppercase", color: T.teal, marginBottom: 20, marginTop: 0,
//                   }}>International Offices</p>
//                   <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
//                     {INT_OFFICES.map((o, i) => (
//                       <div key={i} className="nnc-office-row" style={{
...
//                   <p style={{
//                     fontSize: isMobile ? 9 : 10, fontWeight: 700, letterSpacing: "0.14em",
//                     textTransform: "uppercase", color: "rgba(255,255,255,.35)", marginBottom: 20, marginTop: 0,
//                   }}>India Offices — Nakshatra Namaha Creations</p>
//                   <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
//                     {INDIA_OFFICES.map((o, i) => (
//                       <div key={i} className="nnc-office-row" style={{
...
//             <FadeUp delay={0.1}>
//               <div style={{
//                 borderRadius: 28, padding: isMobile ? "40px 20px" : isTablet ? "56px 40px" : "72px 60px", textAlign: "center",
//                 background: "linear-gradient(135deg, rgba(0,201,167,.07) 0%, rgba(5,18,34,.9) 50%, rgba(2,12,26,.95) 100%)",
//                 border: "1px solid rgba(0,201,167,.2)",
//                 position: "relative", overflow: "hidden",
//                 transition: "box-shadow .4s",
...
//                   <>
//                     <div style={{
//                       position: "absolute", width: isTablet ? 400 : 550, height: isTablet ? 400 : 550, borderRadius: "50%",
//                       background: `radial-gradient(circle, rgba(0,201,167,.1) 0%, transparent 65%)`,
//                       top: "50%", left: "50%", transform: "translate(-50%,-50%)",
//                       animation: "pulseOrb 6s ease-in-out infinite", pointerEvents: "none",
//                     }} />
//                     <div style={{
//                       position: "absolute", width: isTablet ? 250 : 320, height: isTablet ? 250 : 320, borderRadius: "50%",
//                       border: "1px dashed rgba(0,201,167,.1)",
//                       top: "50%", left: "50%", transform: "translate(-50%,-50%)",
//                       animation: "spinCW 28s linear infinite", pointerEvents: "none",
//                     }} />
...
//                     fontWeight: 600, marginBottom: 16, marginTop: 0,
//                   }}>
//                     Ready to Start a{" "}
//                     <span style={gradText as object}>Conversation?</span>
//                   </h2>
//                   <p style={{
//                     color: "rgba(255,255,255,.48)", fontSize: isMobile ? 14 : 15, lineHeight: 1.7,
//                     maxWidth: isMobile ? "100%" : 560, margin: "0 auto 32px",
//                     padding: isMobile ? "0 10px" : "0",
//                   }}>
//                     Whether you have a fully scoped project or just a problem you&apos;re trying to solve — we&apos;d love to talk. We&apos;ll respond within 24 hours with honest, practical advice.
//                   </p>
...
/* ─── Magnetic Button (FIXED for mobile) ─── */
function MagBtn({ children, primary, style: ext, onClick }: {
  ...
  const getButtonStyles = () => {
    const baseStyles: React.CSSProperties = {
      padding: isMobile ? '14px 24px' : '15px 38px',
...
export default function AboutPage() {
  ...
  // Responsive helpers
  const getSectionPadding = () => {
    if (isMobile) return "56px 16px";
    if (isTablet) return "72px 24px";
    return "108px 48px";
  };
            ...
            <div className="nnc-story-grid">
              ...
              <FadeUp delay={0.18}>
                ...
                >
                  ...
                  >
                    <Image src="/NNCLOGO.jpg" alt="NNC Digital Solutions" fill style={{ objectFit: "contain" , background: "#ffffff",
    padding: "20px" }} />
                    <div style={{
                      position: "absolute", inset: 0,
                      background: "linear-gradient(to top, rgba(2,12,26,.88) 0%, rgba(2,12,26,.2) 55%, transparent 100%)",
        ...
        <section className="nnc-section" style={{
          ...
          <div style={{ maxWidth: 1220, margin: "0 auto" }}>
            ...
            {/* ── FINAL CTA (FIXED for mobile) ── */}
            <FadeUp delay={0.1}>
              <div style={{
                borderRadius: 28, padding: isMobile ? "40px 16px" : isTablet ? "56px 40px" : "72px 60px", textAlign: "center",
                background: "linear-gradient(135deg, rgba(0,201,167,.07) 0%, rgba(5,18,34,.9) 50%, rgba(2,12,26,.95) 100%)",
                border: "1px solid rgba(0,201,167,.2)",
                position: "relative", overflow: "hidden",
                transition: "box-shadow .4s",
