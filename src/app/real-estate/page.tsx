...
//     id: 1,
//     icon: "🏠",
//     title: "45% More Lead Conversions for Toronto Agency",
//     description: "A real estate agency implemented our CRM with automated follow-up and MLS integration, converting 45% more leads.",
//     metrics: [
//       { label: "Conversions", value: "+45%" },
//       { label: "Response", value: "-82%" },
//       { label: "Revenue", value: "+67%" }
//     ],
//     tags: ["Real Estate", "CRM", "Canada"]
//   },
//   {
//     id: 2,
//     icon: "🏢",
//     title: "38% Faster Property Matching for NYC Brokerage",
//     description: "MLS integration and lead scoring helped agents match buyers to properties 38% faster.",
//     metrics: [
//       { label: "Matching", value: "-38%" },
//       { label: "Showings", value: "+52%" },
//       { label: "Satisfaction", value: "4.8★" }
//     ],
//     tags: ["Real Estate", "MLS", "USA"]
//   },
//   {
//     id: 3,
//     icon: "🏘️",
//     title: "2.5× Referrals for London Estate Agent",
//     description: "Referral tracking system and automated nurture campaigns doubled referral business.",
//     metrics: [
//       { label: "Referrals", value: "2.5×" },
//       { label: "ROI", value: "+312%" },
//       { label: "Retention", value: "+43%" }
//     ],
//     tags: ["Real Estate", "Referrals", "UK"]
//   }
// ];

// const SOLUTIONS = [
//   { icon: "👥", title: "Real Estate CRM", desc: "Complete lead management, buyer preferences, and communication history. Purpose-built for Canada, USA & UK real estate." },
//   { icon: "🏢", title: "Property Management Software", desc: "Manage rentals, tenants, maintenance requests, and lease agreements in one unified platform." },
//   { icon: "🔗", title: "MLS / Rightmove / Zoopla Integration", desc: "Auto-sync property listings, real-time lead assignment, and automated property matching." },
//   { icon: "📈", title: "Lead Generation Automation", desc: "Capture leads from portals, automate follow-up sequences, and score prospects by readiness." },
//   { icon: "📱", title: "Real Estate Mobile App", desc: "Native iOS/Android apps for agents and clients with push notifications and offline access." },
//   { icon: "🏠", title: "IDX Website Development", desc: "MLS-powered property search websites with lead capture and agent dashboards." },
//   { icon: "📊", title: "Agent Performance Dashboard", desc: "Real-time metrics on listings, showings, offers, and commissions for each agent." },
//   { icon: "🤝", title: "Referral Tracking System", desc: "Track referral sources, automate commission splits, and measure partner performance." },
//   { icon: "👤", title: "Client Portal", desc: "Self-service portals for buyers, sellers, and tenants with document sharing and status updates." }
// ];
...
//     desc: "Connect CRM to MLS listings for automatic property matching and lead routing. Compatible with major MLS systems across the US."
//   },
//   {
//     region: "Canada",
//     flag: "🇨🇦",
...
//     desc: "Auto-sync UK property listings, handle Rightmove and Zoopla data feeds with real-time lead assignment."
//   }
// ];

// const FAQS = [
//   {
//     q: "How long does a real estate CRM implementation take?",
//     a: "A focused real estate CRM typically takes 6-12 weeks. This includes requirements gathering, MLS integration setup, development, data migration from existing systems, and agent training. For US clients, we handle MLS integration; for UK clients, we connect to Rightmove/Zoopla APIs."
//   },
//   {
//     q: "Can you integrate with MLS, Rightmove, or Zoopla?",
//     a: "Yes. For US/Canadian clients, we integrate with major MLS systems (IDX, RETS, RESO Web API). For UK clients, we connect directly to Rightmove and Zoopla data feeds. All integrations support real-time property updates, automatic lead assignment, and two-way data sync."
//   },
//   {
//     q: "What does a real estate CRM cost in Canada or the UK?",
//     a: "A comprehensive real estate CRM starts from CAD $20,000–$35,000 / £15,000–£25,000. This includes lead management, MLS integration, automated follow-up, and agent dashboards. Enterprise systems with mobile apps and multi-office support are scoped individually. All quotes fixed-price."
//   },
//   {
//     q: "Do you offer mobile apps for agents and clients?",
//     a: "Yes. We build native iOS and Android apps for agents (property search, lead management, push notifications) and clients (saved searches, favorite properties, direct messaging). Apps work offline and sync automatically when connection is restored."
//   }
// ];

// const WCU_POINTS = [
//   { icon: "🏠", text: "8+ years of real estate technology expertise" },
//   { icon: "🌍", text: "Serving Canada, USA & UK markets" },
//   { icon: "⚡", text: "565+ projects delivered globally" },
//   { icon: "🔗", text: "MLS, Rightmove & Zoopla integration experts" },
...
//   { n: 565, s: "+", l: "Projects" },
//   { n: 100, s: "+", l: "Team" },
//   { n: 25, s: "+", l: "Real Estate Clients" }
// ];

// const REAL_ESTATE_STATS = [
//   { value: "45%", label: "Faster Response", icon: "⚡" },
//   { value: "2.8×", label: "More Referrals", icon: "🔄" },
//   { value: "24/7", label: "Lead Capture", icon: "📱" },
...
// const SERVICES_LIST = [
//   "Real Estate CRM", "Property Management", "MLS Integration",
//   "Mobile App", "IDX Website", "Lead Automation", "Other"
// ];
...
//           <span style={{ color: T, fontSize: "clamp(12px, 2vw, 14px)", fontWeight: 700 }}>LEAD PERFORMANCE</span>
//         </div>

//         <div style={{ display: "flex", flexDirection: "column", gap: "clamp(8px, 2vw, 12px)" }}>
//           <div>
//             <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4, flexWrap: "wrap", gap: 4 }}>
//               <span style={{ fontSize: "clamp(11px, 2vw, 12px)", color: "rgba(255,255,255,0.5)" }}>Lead Response Time</span>
//               <span style={{ fontSize: "clamp(11px, 2vw, 12px)", color: T, fontWeight: 600 }}>3.2min</span>
//             </div>
...
//           <div>
//             <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4, flexWrap: "wrap", gap: 4 }}>
//               <span style={{ fontSize: "clamp(11px, 2vw, 12px)", color: "rgba(255,255,255,0.5)" }}>Lead-to-Showings</span>
//               <span style={{ fontSize: "clamp(11px, 2vw, 12px)", color: T, fontWeight: 600 }}>38%</span>
//             </div>
//             <div style={{ height: 6, background: "rgba(255,255,255,0.1)", borderRadius: 3 }}>
//               <div style={{ width: "38%", height: "100%", background: T, borderRadius: 3 }} />
//             </div>
//           </div>

//           <div>
//             <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4, flexWrap: "wrap", gap: 4 }}>
//               <span style={{ fontSize: "clamp(11px, 2vw, 12px)", color: "rgba(255,255,255,0.5)" }}>Referral Conversion</span>
//               <span style={{ fontSize: "clamp(11px, 2vw, 12px)", color: T, fontWeight: 600 }}>72%</span>
//             </div>
//             <div style={{ height: 6, background: "rgba(255,255,255,0.1)", borderRadius: 3 }}>
//               <div style={{ width: "72%", height: "100%", background: T, borderRadius: 3 }} />
//             </div>
//           </div>
//         </div>
//       </div>
...
//         <span style={{ fontSize: "clamp(11px, 2vw, 12px)", color: "rgba(255,255,255,0.5)" }}>MLS connected · Live data</span>
//       </div>
//     </div>
//   );
// }
...
//           {/* Left - Hero Text */}
//           <div>
//             <SectionBadge label="Real Estate Technology" />
//             <h1 style={{
...
//             }}>
//               Custom Digital Systems for <GradText>Real Estate Businesses</GradText> in Canada, USA & UK
//             </h1>
//             <p style={{
...
//                   A real estate specialist will contact you within 24 hours.
//                 </p>
...
//             <SectionH2>Real Estate <GradText>Digital Solutions</GradText> We Build</SectionH2>
//           </div>
...
//               <SectionH2>Your Trusted <GradText>Real Estate Technology</GradText> Partner</SectionH2>
//             </div>
...
//                   Backed by <strong style={{ color: T }}>Nakshatra Namaha Creations Pvt. Ltd.</strong> — 8+ years of experience, 565+ projects delivered. Dedicated client teams in Canada, USA, and UK. MLS, Rightmove, and Zoopla integration experts. Long-term partnership focused on your success.
//                 </p>
...
//             <SectionH2>Ready to Build Your <GradText>Real Estate Solution?</GradText></SectionH2>
//             <p style={{ color: "rgba(255,255,255,0.6)", fontSize: isMobile ? 13 : 14, marginBottom: 20 }}>
...
const SUCCESS_STORIES = [
  {
    ...
    title:"45% More Lead Conversions for Toronto Agency",
    description:"A real estate agency implemented our CRM with automated follow-up and MLS integration, converting 45% more leads.",
    metrics:[{label:"Conversions",value:"+45%"},{label:"Response",value:"-82%"},{label:"Revenue",value:"+67%"}],
    tags:["Real Estate","CRM","Canada"],
  },
  {
    id:2, icon:"🏢",
    title:"38% Faster Property Matching for NYC Brokerage",
    description:"MLS integration and lead scoring helped agents match buyers to properties 38% faster.",
    metrics:[{label:"Matching",value:"-38%"},{label:"Showings",value:"+52%"},{label:"Satisfaction",value:"4.8★"}],
    tags:["Real Estate","MLS","USA"],
  },
  {
    id:3, icon:"🏘️",
    title:"2.5× Referrals for London Estate Agent",
    description:"Referral tracking system and automated nurture campaigns doubled referral business.",
    metrics:[{label:"Referrals",value:"2.5×"},{label:"ROI",value:"+312%"},{label:"Retention",value:"+43%"}],
    tags:["Real Estate","Referrals","UK"],
  },
];
...
const COMPLIANCE = [
  { region:"USA",    flag:"🇺🇸", title:"MLS Integration",          desc:"Connect CRM to MLS listings for automatic property matching and lead routing. Compatible with major MLS systems across the US." },
  { region:"Canada", flag:"🇨🇦", title:"PIPEDA & GDPR Compliance", desc:"All client data handled in accordance with Canadian and UK data protection law. Systems built to work with Canadian MLS® systems and comply with CREA rules for property data display." },
  { region:"UK",     flag:"🇬🇧", title:"Rightmove & Zoopla",       desc:"Auto-sync UK property listings, handle Rightmove and Zoopla data feeds with real-time lead assignment." },
];

const FAQS = [
  { q:"How long does a real estate CRM implementation take?",  a:"A focused real estate CRM typically takes 6-12 weeks. This includes requirements gathering, MLS integration setup, development, data migration from existing systems, and agent training. For US clients, we handle MLS integration; for UK clients, we connect to Rightmove/Zoopla APIs." },
  { q:"Can you integrate with MLS, Rightmove, or Zoopla?",    a:"Yes. For US/Canadian clients, we integrate with major MLS systems (IDX, RETS, RESO Web API). For UK clients, we connect directly to Rightmove and Zoopla data feeds. All integrations support real-time property updates, automatic lead assignment, and two-way data sync." },
  { q:"What does a real estate CRM cost in Canada or the UK?",a:"A comprehensive real estate CRM starts from CAD $20,000–$35,000 / £15,000–£25,000. This includes lead management, MLS integration, automated follow-up, and agent dashboards. Enterprise systems with mobile apps and multi-office support are scoped individually. All quotes fixed-price." },
  { q:"Do you offer mobile apps for agents and clients?",      a:"Yes. We build native iOS and Android apps for agents (property search, lead management, push notifications) and clients (saved searches, favorite properties, direct messaging). Apps work offline and sync automatically when connection is restored." },
];
...
function buildParams(data:{firstName:string;lastName:string;email:string;phone:string;service:string;message:string}) {
  return {
    ...
    title:           `New Real Estate Consultation from ${data.firstName} ${data.lastName}`.trim(),
    reply_to:        data.email,
  };
}
  ...
  return (
    <div style={{background:`linear-gradient(135deg,${N2} 0%,${N1} 100%)`,borderRadius:24,padding:"clamp(20px,4vw,32px)",border:`1px solid ${T}30`,boxShadow:`0 20px 40px rgba(0,0,0,0.4)`,position:"relative",overflow:"hidden"}}>
      ...
      <div style={{background:"rgba(255,255,255,0.02)",border:"1px solid rgba(255,255,255,0.05)",borderRadius:16,padding:"clamp(12px,2.5vw,20px)"}}>
        ...
        <div style={{display:"flex",flexDirection:"column",gap:"clamp(8px,2vw,12px)"}}>
          {[{label:"Lead Response Time",val:"3.2min",pct:"92%"},{label:"Lead-to-Showings",val:"38%",pct:"38%"},{label:"Referral Conversion",val:"72%",pct:"72%"}].map((row,i)=>(
            <div key={i}>
              <div style={{display:"flex",justifyContent:"space-between",marginBottom:4,flexWrap:"wrap",gap:4}}>
...
export default function RealEstateIndustryPage() {
  ...
  const handleCSubmit=async(e:React.FormEvent)=>{
    ...
    try{
      ...
      await emailjs.send(EMAILJS_SERVICE_ID,EMAILJS_TEMPLATE_ID,buildParams({
        ...
        service:"Real Estate Consultation",message:cForm.project,
      }));
      setCSubmitted(true);
  ...
  // ── Responsive helpers ─────────────────────────────────────────────────────
  const getSectionPadding=()=>isMobile?"40px 16px":isTablet?"60px 32px":"60px 48px";
  ...
  return (
    <>
      ...
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700;800;900&display=swap');
        body,button,input,select,textarea,h1,h2,h3,h4,h5,h6,p,span,div{font-family:'Poppins',sans-serif!important;}
        @keyframes pulse{0%,100%{opacity:.4}50%{opacity:.8}}
        @keyframes marquee{0%{transform:translateX(0)}100%{transform:translateX(-50%)}}
        @keyframes marqueeReverse{from{transform:translateX(-50%)}to{transform:translateX(0)}}
        .cl-track{display:flex;width:max-content;animation:marquee 30s linear infinite;}
        .cl-track:hover{animation-play-state:paused;}
        .fi-re:focus{border-color:rgba(0,201,167,0.5)!important;background:rgba(0,201,167,0.06)!important;}
        .fi-re::placeholder{color:rgba(255,255,255,0.28);}
          ...
          <div style={{background:"rgba(8,20,40,0.85)",border:`1px solid ${T}30`,borderRadius:24,padding:isMobile?"20px 16px":isTablet?"24px 20px":"28px 24px",backdropFilter:"blur(16px)",boxShadow:"0 32px 64px rgba(0,0,0,0.5)"}}>
            ...
            {submitted ? (
              <div style={{textAlign:"center",padding:"20px 0"}}>
                <div style={{fontSize:isMobile?40:48,marginBottom:16}}>🏠</div>
                <h4 style={{fontSize:isMobile?16:18,fontWeight:700,marginBottom:8}}>Request Received!</h4>
                <p style={{color:"rgba(255,255,255,0.6)",fontSize:isMobile?13:14,marginBottom:20}}>A real estate specialist will contact you within 24 hours.</p>
              ...
              <form onSubmit={handleSubmit} noValidate style={{display:"flex",flexDirection:"column",gap:isMobile?10:12}}>
                ...
                {/* Name */}
                <div>
                  <input className="fi-re" style={hTouched.name&&hErr.name?iSE:iS} placeholder="Full Name *" value={form.name} onChange={e=>setF("name",e.target.value)} onBlur={hBlur("name")}/>
                ...
                <div>
                  <div style={{display:"flex",gap:8,flexDirection:isMobile?"column":"row"}}>
                    ...
                    <input className="fi-re" style={{...(hTouched.phone&&hErr.phone?iSE:iS),flex:1}} type="tel" placeholder="Phone Number *" value={form.phone} onChange={e=>setF("phone",e.target.value)} onBlur={hBlur("phone")}/>
                  </div>
                ...
                {/* Email */}
                <div>
                  <input className="fi-re" style={hTouched.email&&hErr.email?iSE:iS} type="email" placeholder="Business Email *" value={form.email} onChange={e=>setF("email",e.target.value)} onBlur={hBlur("email")}/>
                ...
                {/* Message */}
                <div>
                  <textarea className="fi-re" style={{...(hTouched.message&&hErr.message?iSE:iS),minHeight:isMobile?60:80,resize:"vertical"}} placeholder="Message *" value={form.message} onChange={e=>setF("message",e.target.value)} onBlur={hBlur("message")}/>
      ...
      <section style={{padding:getSectionPadding(),background:N2}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:getGridColumns(1,2,3),gap:isMobile?16:isTablet?20:34}}>
          {SUCCESS_STORIES.map((s,i)=>(
            <div key={i} onMouseEnter={()=>setHoveredCard(i)} onMouseLeave={()=>setHoveredCard(null)} style={{background:"rgba(255,255,255,0.02)",border:`1px solid ${hoveredCard===i?T:"rgba(255,255,255,0.05)"}`,borderRadius:24,padding:isMobile?16:20,transition:"all 0.3s ease",transform:hoveredCard===i&&!isMobile?"translateY(-4px)":"none"}}>
              ...
              <div style={{display:"flex",gap:4,flexWrap:"wrap"}}>
                {s.tags.map((tag,j)=>(
                  <span key={j} style={{padding:"4px 8px",borderRadius:100,background:"rgba(0,201,167,0.1)",border:`1px solid ${T}30`,color:T,fontSize:isMobile?9:11,fontWeight:600}}>{tag}</span>
                ))}
              </div>
            </div>
          ))}
      ...
      <section style={{padding:getSectionPadding(),background:`linear-gradient(135deg,${N1} 0%,${N0} 100%)`}}>
        <div style={{maxWidth:1000,margin:"0 auto"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:getGridColumns(1,2,3),gap:isMobile?16:isTablet?20:24}}>
            <div style={{background:"rgba(255,255,255,0.02)",border:"1px solid rgba(255,255,255,0.05)",borderRadius:20,padding:isMobile?16:20,textAlign:"center"}}>
              <div style={{fontSize:isMobile?40:48,marginBottom:isMobile?12:16}}>🇺🇸🇨🇦</div>
              <h3 style={{color:T,fontSize:isMobile?18:22,fontWeight:700,marginBottom:8}}>MLS Integration</h3>
              <p style={{color:"rgba(255,255,255,0.6)",fontSize:isMobile?12:13,marginBottom:12}}>Canada / USA</p>
              <p style={{color:"rgba(255,255,255,0.5)",fontSize:isMobile?12:13,lineHeight:1.6}}>Connect CRM to MLS listings for automatic property matching and lead routing.</p>
            </div>
            <div style={{background:"rgba(255,255,255,0.02)",border:"1px solid rgba(255,255,255,0.05)",borderRadius:20,padding:isMobile?16:20,textAlign:"center"}}>
              <div style={{fontSize:isMobile?40:48,marginBottom:isMobile?12:16}}>🇬🇧</div>
              <h3 style={{color:T,fontSize:isMobile?18:22,fontWeight:700,marginBottom:8}}>Rightmove & Zoopla</h3>
              <p style={{color:"rgba(255,255,255,0.6)",fontSize:isMobile?12:13,marginBottom:12}}>UK</p>
              <p style={{color:"rgba(255,255,255,0.5)",fontSize:isMobile?12:13,lineHeight:1.6}}>Auto-sync UK property listings for real-time lead assignment.</p>
            </div>
            <div style={{background:"rgba(255,255,255,0.02)",border:"1px solid rgba(255,255,255,0.05)",borderRadius:20,padding:isMobile?16:20,textAlign:"center"}}>
              <div style={{fontSize:isMobile?40:48,marginBottom:isMobile?12:16}}>🔒</div>
              <h3 style={{color:T,fontSize:isMobile?18:22,fontWeight:700,marginBottom:8}}>PIPEDA & GDPR Compliance</h3>
              <p style={{color:"rgba(255,255,255,0.6)",fontSize:isMobile?12:13,marginBottom:12}}>Canada / UK</p>
              <p style={{color:"rgba(255,255,255,0.5)",fontSize:isMobile?12:13,lineHeight:1.6}}>All client data handled in accordance with Canadian and UK data protection law.</p>
            </div>
          </div>
        </div>
      </section>
            ...
            {cSubmitted ? (
              ...
              <form onSubmit={handleCSubmit} noValidate style={{maxWidth:500,margin:"0 auto"}}>
                <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":"1fr 1fr",gap:12,marginBottom:12}}>
                  <div>
                    <input className="fi-re" style={cTouched.name&&cErr.name?iSLgE:iSLg} placeholder="Full Name *" value={cForm.name} onChange={e=>setCF("name",e.target.value)} onBlur={cBlur("name")}/>
                  ...
                  <div>
                    <div style={{display:"flex",gap:8,flexDirection:isMobile?"column":"row"}}>
                      ...
                      <input className="fi-re" style={{...(cTouched.phone&&cErr.phone?iSLgE:iSLg),flex:1}} type="tel" placeholder="Phone" value={cForm.phone} onChange={e=>setCF("phone",e.target.value)} onBlur={cBlur("phone")}/>
                    </div>
                ...
                <div style={{marginBottom:12}}>
                  <input className="fi-re" style={cTouched.email&&cErr.email?iSLgE:iSLg} type="email" placeholder="Business Email *" value={cForm.email} onChange={e=>setCF("email",e.target.value)} onBlur={cBlur("email")}/>
                  {cTouched.email&&<FieldErr msg={cErr.email}/>}
                </div>

                <div style={{marginBottom:16}}>
                  <textarea className="fi-re" style={{...(cTouched.project&&cErr.project?iSLgE:iSLg),minHeight:isMobile?80:100,resize:"vertical"}} placeholder="Project Description *" value={cForm.project} onChange={e=>setCF("project",e.target.value)} onBlur={cBlur("project")}/>
