...
//             </div>
//             <h2 style={{ fontSize: h2FS(), fontWeight: 900, color: "#fff", marginBottom: 10, letterSpacing: "-0.02em" }}>ERP Development Services <GradText>We Offer</GradText></h2>
...
//             {SERVICES.map((s, i) => (
//               <a key={s.title} className="svc-card" style={{ display: "flex", flexDirection: "column", gap: 12, padding: cardP(), borderRadius: 18, border: "1px solid rgba(255,255,255,0.07)", background: "rgba(255,255,255,0.02)", transition: "transform .3s,border-color .3s,background .3s", textDecoration: "none", cursor: "pointer" }}>
...
//             <h2 style={{
//               fontSize: isMobile ? "clamp(22px, 6vw, 28px)" : isTablet ? "32px" : "clamp(36px, 4vw, 48px)",
//               fontWeight: 800,
//               color: "#fff",
//               lineHeight: 1.2,
...
//             }}>
//               Want <span style={{ textDecoration: "underline", textDecorationColor: "rgba(255,255,255,0.4)" }}>ERP DEVELOPMENT solutions</span> that take your business to the next level?
//             </h2>
...
//       {/* ══ M13 — GLOBAL PRESENCE ═════════════════════════════════════════════════ */}
//       <section style={{ background: `linear-gradient(145deg, ${N0} 0%, #041628 50%, ${N1} 100%)`, position: "relative", overflow: "hidden" }}>
...
//             <div onClick={() => setFaq(faq === 0 ? null : 0)} style={{ border: `1px solid ${faq === 0 ? "rgba(0,201,167,0.4)" : "rgba(255,255,255,0.08)"}`, borderRadius: 16, background: faq === 0 ? "rgba(0,201,167,0.06)" : "rgba(255,255,255,0.02)", overflow: "hidden", cursor: "pointer", transition: "all .25s ease" }}>
//               <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 14, padding: isMobile ? "14px 14px" : "18px 22px" }}>
//                 <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
//                   <span style={{ color: T, fontSize: 12, fontWeight: 800, background: "rgba(0,201,167,0.1)", border: "1px solid rgba(0,201,167,0.2)", borderRadius: 8, padding: "4px 10px", flexShrink: 0 }}>Q1</span>
//                   <span style={{ fontSize: isMobile ? "13px" : "15px", fontWeight: 700, color: faq === 0 ? "#fff" : "rgba(255,255,255,0.78)", lineHeight: 1.4 }}>How long does ERP implementation take?</span>
//                 </div>
//                 <div style={{ width: 26, height: 26, borderRadius: "50%", flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 16, fontWeight: 700, background: faq === 0 ? T : "rgba(255,255,255,0.07)", border: `1px solid ${faq === 0 ? T : "rgba(255,255,255,0.12)"}`, color: faq === 0 ? "#000" : "rgba(255,255,255,0.5)", transform: faq === 0 ? "rotate(45deg)" : "rotate(0deg)", transition: "all .25s ease" }}>+</div>
//               </div>
//               <div style={{ maxHeight: faq === 0 ? 500 : 0, overflow: "hidden", transition: "max-height .38s ease" }}>
//                 <p style={{ padding: isMobile ? "0 14px 16px 46px" : "0 22px 20px 78px", color: "rgba(255,255,255,0.55)", fontSize: isMobile ? "13px" : "14.5px", lineHeight: 1.8, margin: 0 }}>
//                   Detailed answer tailored for businesses in Canada, USA, and UK — covering timeline, cost, compliance, and process.
//                 </p>
//               </div>
//             </div>

//             {/* Q2: Can you integrate with QuickBooks, Xero, or Sage? */}
//             <div onClick={() => setFaq(faq === 1 ? null : 1)} style={{ border: `1px solid ${faq === 1 ? "rgba(0,201,167,0.4)" : "rgba(255,255,255,0.08)"}`, borderRadius: 16, background: faq === 1 ? "rgba(0,201,167,0.06)" : "rgba(255,255,255,0.02)", overflow: "hidden", cursor: "pointer", transition: "all .25s ease" }}>
//               <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 14, padding: isMobile ? "14px 14px" : "18px 22px" }}>
//                 <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
//                   <span style={{ color: T, fontSize: 12, fontWeight: 800, background: "rgba(0,201,167,0.1)", border: "1px solid rgba(0,201,167,0.2)", borderRadius: 8, padding: "4px 10px", flexShrink: 0 }}>Q2</span>
//                   <span style={{ fontSize: isMobile ? "13px" : "15px", fontWeight: 700, color: faq === 1 ? "#fff" : "rgba(255,255,255,0.78)", lineHeight: 1.4 }}>Can you integrate with QuickBooks, Xero, or Sage?</span>
//                 </div>
//                 <div style={{ width: 26, height: 26, borderRadius: "50%", flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 16, fontWeight: 700, background: faq === 1 ? T : "rgba(255,255,255,0.07)", border: `1px solid ${faq === 1 ? T : "rgba(255,255,255,0.12)"}`, color: faq === 1 ? "#000" : "rgba(255,255,255,0.5)", transform: faq === 1 ? "rotate(45deg)" : "rotate(0deg)", transition: "all .25s ease" }}>+</div>
//               </div>
...
//             {/* Q3: Is your ERP compliant with Canadian and UK tax law? */}
//             <div onClick={() => setFaq(faq === 2 ? null : 2)} style={{ border: `1px solid ${faq === 2 ? "rgba(0,201,167,0.4)" : "rgba(255,255,255,0.08)"}`, borderRadius: 16, background: faq === 2 ? "rgba(0,201,167,0.06)" : "rgba(255,255,255,0.02)", overflow: "hidden", cursor: "pointer", transition: "all .25s ease" }}>
//               <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 14, padding: isMobile ? "14px 14px" : "18px 22px" }}>
//                 <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
//                   <span style={{ color: T, fontSize: 12, fontWeight: 800, background: "rgba(0,201,167,0.1)", border: "1px solid rgba(0,201,167,0.2)", borderRadius: 8, padding: "4px 10px", flexShrink: 0 }}>Q3</span>
//                   <span style={{ fontSize: isMobile ? "13px" : "15px", fontWeight: 700, color: faq === 2 ? "#fff" : "rgba(255,255,255,0.78)", lineHeight: 1.4 }}>Is your ERP compliant with Canadian and UK tax law?</span>
//                 </div>
//                 <div style={{ width: 26, height: 26, borderRadius: "50%", flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 16, fontWeight: 700, background: faq === 2 ? T : "rgba(255,255,255,0.07)", border: `1px solid ${faq === 2 ? T : "rgba(255,255,255,0.12)"}`, color: faq === 2 ? "#000" : "rgba(255,255,255,0.5)", transform: faq === 2 ? "rotate(45deg)" : "rotate(0deg)", transition: "all .25s ease" }}>+</div>
//               </div>
...
//             {/* Q4: What does custom ERP development cost? */}
//             <div onClick={() => setFaq(faq === 3 ? null : 3)} style={{ border: `1px solid ${faq === 3 ? "rgba(0,201,167,0.4)" : "rgba(255,255,255,0.08)"}`, borderRadius: 16, background: faq === 3 ? "rgba(0,201,167,0.06)" : "rgba(255,255,255,0.02)", overflow: "hidden", cursor: "pointer", transition: "all .25s ease" }}>
//               <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 14, padding: isMobile ? "14px 14px" : "18px 22px" }}>
//                 <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
//                   <span style={{ color: T, fontSize: 12, fontWeight: 800, background: "rgba(0,201,167,0.1)", border: "1px solid rgba(0,201,167,0.2)", borderRadius: 8, padding: "4px 10px", flexShrink: 0 }}>Q4</span>
//                   <span style={{ fontSize: isMobile ? "13px" : "15px", fontWeight: 700, color: faq === 3 ? "#fff" : "rgba(255,255,255,0.78)", lineHeight: 1.4 }}>What does custom ERP development cost?</span>
//                 </div>
//                 <div style={{ width: 26, height: 26, borderRadius: "50%", flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 16, fontWeight: 700, background: faq === 3 ? T : "rgba(255,255,255,0.07)", border: `1px solid ${faq === 3 ? T : "rgba(255,255,255,0.12)"}`, color: faq === 3 ? "#000" : "rgba(255,255,255,0.5)", transform: faq === 3 ? "rotate(45deg)" : "rotate(0deg)", transition: "all .25s ease" }}>+</div>
//               </div>
...
//             {/* Q5: Can you migrate data from our existing ERP? */}
//             <div onClick={() => setFaq(faq === 4 ? null : 4)} style={{ border: `1px solid ${faq === 4 ? "rgba(0,201,167,0.4)" : "rgba(255,255,255,0.08)"}`, borderRadius: 16, background: faq === 4 ? "rgba(0,201,167,0.06)" : "rgba(255,255,255,0.02)", overflow: "hidden", cursor: "pointer", transition: "all .25s ease" }}>
//               <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 14, padding: isMobile ? "14px 14px" : "18px 22px" }}>
//                 <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
//                   <span style={{ color: T, fontSize: 12, fontWeight: 800, background: "rgba(0,201,167,0.1)", border: "1px solid rgba(0,201,167,0.2)", borderRadius: 8, padding: "4px 10px", flexShrink: 0 }}>Q5</span>
//                   <span style={{ fontSize: isMobile ? "13px" : "15px", fontWeight: 700, color: faq === 4 ? "#fff" : "rgba(255,255,255,0.78)", lineHeight: 1.4 }}>Can you migrate data from our existing ERP?</span>
//                 </div>
//                 <div style={{ width: 26, height: 26, borderRadius: "50%", flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 16, fontWeight: 700, background: faq === 4 ? T : "rgba(255,255,255,0.07)", border: `1px solid ${faq === 4 ? T : "rgba(255,255,255,0.12)"}`, color: faq === 4 ? "#000" : "rgba(255,255,255,0.5)", transform: faq === 4 ? "rotate(45deg)" : "rotate(0deg)", transition: "all .25s ease" }}>+</div>
//               </div>
...
function buildParams(data:{firstName:string;lastName:string;email:string;phone:string;service:string;message:string}) {
  return {
    ...
    title:           `New ERP Consultation from ${data.firstName} ${data.lastName}`.trim(),
    reply_to:        data.email,
  };
}
...
// FAQ item inline (avoids duplicate AccItem usage)
function FaqItem({q,a,qn,open,toggle,isMobile}:{q:string;a:string;qn:string;open:boolean;toggle:()=>void;isMobile:boolean}) {
  return (
    <div onClick={toggle} style={{border:`1px solid ${open?"rgba(0,201,167,0.4)":"rgba(255,255,255,0.08)"}`,borderRadius:16,background:open?"rgba(0,201,167,0.06)":"rgba(255,255,255,0.02)",overflow:"hidden",cursor:"pointer",transition:"all .25s ease"}}>
      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:14,padding:isMobile?"14px 14px":"18px 22px"}}>
        <div style={{display:"flex",alignItems:"center",gap:12}}>
          <span style={{color:T,fontSize:12,fontWeight:800,background:"rgba(0,201,167,0.1)",border:"1px solid rgba(0,201,167,0.2)",borderRadius:8,padding:"4px 10px",flexShrink:0}}>{qn}</span>
          <span style={{fontSize:isMobile?"13px":"15px",fontWeight:700,color:open?"#fff":"rgba(255,255,255,0.78)",lineHeight:1.4}}>{q}</span>
        </div>
        <div style={{width:26,height:26,borderRadius:"50%",flexShrink:0,display:"flex",alignItems:"center",justifyContent:"center",fontSize:16,fontWeight:700,background:open?T:"rgba(255,255,255,0.07)",border:`1px solid ${open?T:"rgba(255,255,255,0.12)"}`,color:open?"#000":"rgba(255,255,255,0.5)",transform:open?"rotate(45deg)":"rotate(0deg)",transition:"all .25s ease"}}>+</div>
      </div>
      <div style={{maxHeight:open?500:0,overflow:"hidden",transition:"max-height .38s ease"}}>
        <p style={{padding:isMobile?"0 14px 16px 46px":"0 22px 20px 78px",color:"rgba(255,255,255,0.55)",fontSize:isMobile?"13px":"14.5px",lineHeight:1.8,margin:0}}>{a}</p>
      </div>
    </div>
  );
}
...
export default function ERPPage() {
  ...
  const setH = (k:string,v:string) => {
    setHForm(f=>({...f,[k]:v}));
    if(hTouched[k as keyof typeof hTouched]) hRunValidate(k,v);
  };
  const hBlur = (k:string) => () => {setHTouched(p=>({...p,[k]:true}));hRunValidate(k,hForm[k as keyof typeof hForm]);};
  ...
  const handleHeroSubmit = async (e:React.FormEvent) => {
    e.preventDefault();
    if(!hValidateAll()){document.querySelector(".h-ferr")?.scrollIntoView({behavior:"smooth",block:"center"});return;}
    setHLoading(true);
    try {
  ...
  const setC = (k:string,v:string) => {
    setCForm(f=>({...f,[k]:v}));
    if(cTouched[k as keyof typeof cTouched]) cRunValidate(k,v);
  };
  ...
  const handleCSubmit = async (e:React.FormEvent) => {
    e.preventDefault();
    if(!cValidateAll()){document.querySelector(".c-ferr")?.scrollIntoView({behavior:"smooth",block:"center"});return;}
    setCLoading(true);
    try {
  ...
  return (
    <>
      ...
      {/* ══ M1 — HERO ══════════════════════════════════════════════════════════ */}
      <section style={{padding:`clamp(20px,5vw,64px) clamp(16px,4vw,${isMobile?"20px":"48px"}) clamp(28px,5vw,56px)`,background:`linear-gradient(135deg,${N0} 0%,#041628 45%,${N0} 100%)`,position:"relative",overflow:"hidden",display:"flex",alignItems:"flex-start"}}>
        <Particles/>
        <div style={{position:"absolute",width:650,height:650,borderRadius:"50%",background:"radial-gradient(circle,rgba(0,201,167,.14) 0%,transparent 65%)",top:"40%",left:"-10%",transform:"translateY(-50%)",animation:"heroPulse 8s ease-in-out infinite",pointerEvents:"none",zIndex:1}}/>
        <div style={{position:"absolute",width:400,height:400,borderRadius:"50%",background:"radial-gradient(circle,rgba(99,102,241,.1) 0%,transparent 65%)",top:"10%",right:"5%",animation:"heroPulse 10s ease-in-out infinite .5s",pointerEvents:"none",zIndex:1}}/>
        <div style={{position:"absolute",width:520,height:520,borderRadius:"50%",border:"1px dashed rgba(0,201,167,.08)",top:"50%",left:"-12%",transform:"translateY(-50%)",animation:"heroSpin 55s linear infinite",pointerEvents:"none",zIndex:1}}/>
        ...
        <div style={{display:"grid",gridTemplateColumns:isMobile||isTablet?"1fr":"1fr 420px",gap:isMobile?"24px":isTablet?"32px":"40px",maxWidth:1280,margin:"0 auto",width:"100%",position:"relative",zIndex:3,alignItems:"center",paddingTop:isMobile?"16px":isTablet?"24px":"32px"}}>
          ...
          <div style={{animation:"heroFadeUp .7s ease both"}}>
            ...
            <p style={{color:"rgba(255,255,255,0.52)",fontSize:bodyFS(),lineHeight:1.85,marginBottom:isMobile?18:28,maxWidth:600}}>
              {isMobile?"Running on spreadsheets? NNC Digital builds custom ERP systems that unify inventory, finance, HR, and operations into one powerful platform.":"Running your business on spreadsheets and disconnected tools is costing you more than you think. NNC Digital builds custom ERP systems that unify inventory, finance, HR, and operations into one powerful platform."}
            </p>
            <div style={{display:"flex",flexWrap:"wrap",gap:isMobile?6:8,marginBottom:isMobile?18:28}}>
              {[{i:"🔵",l:"Google Partner"},{i:"🏆",l:"ISO Certified"},{i:"🔒",l:"GDPR Compliant"},{i:"🍁",l:"PIPEDA Ready"},{i:"⭐",l:"Clutch Top Agency"}].map(b=>(
                <span key={b.l} style={{display:"inline-flex",alignItems:"center",gap:6,padding:isMobile?"5px 10px":"6px 13px",borderRadius:100,border:"1px solid rgba(255,255,255,0.12)",background:"rgba(255,255,255,0.04)",color:"rgba(255,255,255,0.65)",fontSize:isMobile?"10px":"12.5px",fontWeight:600}}>{b.i} {b.l}</span>
          ...
          <div style={{background:"rgba(8,20,40,0.85)",border:"1px solid rgba(0,201,167,0.22)",borderRadius:20,padding:isMobile?"22px 16px":"32px 28px",backdropFilter:"blur(16px)",boxShadow:"0 32px 80px rgba(0,0,0,0.5),0 0 40px rgba(0,201,167,0.06)",position:"relative",overflow:"hidden"}}>
            ...
            {hSubmitted ? (
              <div style={{textAlign:"center",padding:"36px 0"}}>
                ...
                <h3 style={{color:"#fff",fontSize:19,fontWeight:800,marginBottom:10}}>Request Received!</h3>
                <p style={{color:"rgba(255,255,255,0.5)",fontSize:14,lineHeight:1.7,marginBottom:22}}>We&apos;ll contact you within 24 hours with a free consultation.</p>
                <button onClick={()=>setHSubmitted(false)} style={btnT}>Send Another →</button>
              </div>
            ) : (
              <>
                <div style={{marginBottom:18}}>
                ...
                <form onSubmit={handleHeroSubmit} noValidate style={{display:"flex",flexDirection:"column",gap:11}}>
                  ...
                  <div>
                    <label style={{display:"block",fontSize:11,fontWeight:600,color:"rgba(255,255,255,0.45)",marginBottom:5,textTransform:"uppercase" as const,letterSpacing:"0.04em"}}>Phone *</label>
                    <div style={{display:"flex",gap:8}}>
                      <select className="fi" style={{...iS,width:82,flexShrink:0,padding:"10px 6px",cursor:"pointer"}} value={hForm.dialCode} onChange={e=>setH("dialCode",e.target.value)}>
                        {DIAL_CODES.map((d,i)=><option key={i} value={d.code}>{d.flag} {d.code}</option>)}
                      </select>
                  ...
                  <div>
                    ...
                    <textarea className={`fi${hTouched.message&&hErr.message?" fi-err":""}`} style={{...(hTouched.message&&hErr.message?iSE:iS),minHeight:68,resize:"vertical" as const}} placeholder="Tell us about your ERP project..." value={hForm.message} onChange={e=>setH("message",e.target.value)} onBlur={hBlur("message")}/>
                    {hTouched.message&&<FieldErr msg={hErr.message}/>}
                  </div>

                  <button className="btn-t" type="submit" disabled={hLoading} style={{...btnT,width:"100%",marginTop:4,opacity:hLoading?.6:1,cursor:hLoading?"wait":"pointer"}}>
                    {hLoading?"Sending…":"📅 Get Free ERP Consultation →"}
                  </button>
                  <p style={{color:"rgba(255,255,255,0.28)",fontSize:11,textAlign:"center",margin:0}}>🔒 Secure &amp; confidential. No spam, ever.</p>
                </form>
              </>
        ...
        <div style={{maxWidth:1200,margin:"0 auto",position:"relative",zIndex:2}}>
          ...
          <div key={story} style={{background:"rgba(255,255,255,.02)",border:`1px solid ${CASES[story].tagBd}`,borderRadius:24,overflow:"hidden",animation:"sbFadeUp .45s ease both"}}>
            ...
            <div style={{padding:isMobile?"20px 16px":"clamp(20px,3vw,36px)"}}>
              ...
              <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:12}}>
                {CASES[story].metrics.map((m,i)=>(
                  <div key={i} style={{textAlign:"center",padding:isMobile?"12px 8px":"16px 12px",borderRadius:14,border:"1px solid rgba(255,255,255,0.07)",background:"rgba(255,255,255,0.03)",cursor:"default"}}
                    onMouseEnter={e=>{(e.currentTarget as HTMLElement).style.transform="translateY(-4px)";(e.currentTarget as HTMLElement).style.background="rgba(0,201,167,0.06)";}}
                    onMouseLeave={e=>{(e.currentTarget as HTMLElement).style.transform="";(e.currentTarget as HTMLElement).style.background="rgba(255,255,255,0.03)";}}>
                    <div style={{fontSize:isMobile?"16px":"20px",marginBottom:6}}>{m.i}</div>
                    <div style={{fontSize:isMobile?"18px":"26px",fontWeight:900,marginBottom:4,color:CASES[story].tagClr}}>{m.v}</div>
          ...
          <div style={{display:"flex",justifyContent:"center",gap:8,marginTop:22}}>
            {CASES.map((_,i)=><button key={i} onClick={()=>setStory(i)} style={{width:story===i?24:8,height:8,borderRadius:100,background:story===i?T:"rgba(255,255,255,0.2)",border:"none",cursor:"pointer",transition:"all .3s ease"}}/>)}
          </div>
          <div style={{display:"flex",justifyContent:"center",marginTop:isMobile?24:36}}>
            <a href="/case-studies" className="btn-t" style={btnT}>View All Case Studies →</a>
          </div>
      ...
      <section style={{padding:sp(),background:`linear-gradient(180deg,${N2} 0%,${N1} 100%)`,position:"relative",overflow:"hidden"}}>
        ...
        <div style={{maxWidth:1280,margin:"0 auto",position:"relative",zIndex:2}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:g4(),gap:isMobile?14:18}}>
            {BENEFITS.map((b,i)=>(
              <div key={i} className="kb-card" style={{display:"flex",flexDirection:isMobile?"column":"row",gap:isMobile?12:18,padding:cardP(),borderRadius:18,border:"1px solid rgba(255,255,255,0.06)",background:"rgba(255,255,255,0.02)",transition:"transform .3s,border-color .3s"}}>
                <div style={{fontSize:isMobile?"36px":"52px",fontWeight:900,lineHeight:1,color:T,opacity:.3,flexShrink:0,width:isMobile?"auto":"60px",textAlign:"center"}}>{b.num}</div>
                <div style={{flex:1}}>
                  <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:8}}><span style={{fontSize:20}}>{b.icon}</span><h3 style={{color:"#fff",fontSize:isMobile?"16px":"18px",fontWeight:800,margin:0}}>{b.title}</h3></div>
                  <p style={{color:"rgba(255,255,255,.52)",fontSize:isMobile?"13px":"14px",lineHeight:1.75,margin:"0 0 12px"}}>{b.desc}</p>
      ...
      {/* ══ M11 — CTA BANNER ═══════════════════════════════════════════════════ */}
      <section style={{position:"relative",overflow:"hidden"}}>
        <div style={{background:"linear-gradient(135deg,#0055b3 0%,#0077cc 35%,#0055b3 100%)",backgroundSize:"300% 300%",animation:"ctaBgShift 8s ease infinite",padding:isMobile?"60px 20px":"clamp(70px,8vw,100px) 48px",textAlign:"center",position:"relative"}}>
          <div style={{position:"relative",zIndex:2,maxWidth:800,margin:"0 auto"}}>
            <h2 style={{fontSize:isMobile?"clamp(22px,6vw,28px)":isTablet?"32px":"clamp(36px,4vw,48px)",fontWeight:800,color:"#fff",lineHeight:1.2,letterSpacing:"-0.02em",marginBottom:isMobile?16:24}}>
              Want <span style={{textDecoration:"underline",textDecorationColor:"rgba(255,255,255,0.4)"}}>ERP DEVELOPMENT solutions</span> that take your business to the next level?
            </h2>
      ...
      {/* ══ M13 — GLOBAL PRESENCE ══════════════════════════════════════════════ */}
      <section style={{background:`linear-gradient(145deg,${N0} 0%,#041628 50%,${N1} 100%)`,padding:sp(),position:"relative",overflow:"hidden"}}>
          ...
          <div style={{display:"flex",gap:isMobile?8:12,justifyContent:"center",marginBottom:isMobile?30:40,flexWrap:"wrap"}}>
            {[{key:"int",label:"North America & UK",icon:"🌎"},{key:"india",label:"India (HQ)",icon:"🇮🇳"}].map(t=>(
              <button key={t.key} className={`gp-tab${gTab===t.key?" act":""}`} onClick={()=>setGTab(t.key as "int"|"india")}
                style={{padding:isMobile?"12px 24px":"14px 32px",borderRadius:50,border:"none",background:gTab===t.key?`linear-gradient(135deg,${T},${TD})`:"rgba(255,255,255,0.05)",color:gTab===t.key?"#000":"#fff",fontSize:isMobile?14:16,fontWeight:600,cursor:"pointer",transition:"all .3s ease",boxShadow:gTab===t.key?`0 8px 20px ${T}40`:"none",display:"flex",alignItems:"center",gap:8}}
            ...
            <div style={{background:"rgba(255,255,255,0.02)",border:"1px solid rgba(255,255,255,0.08)",borderRadius:20,padding:isMobile?"20px 16px":"clamp(20px,3vw,36px)"}}>
              {cSubmitted ? (
                <div style={{textAlign:"center",padding:"42px 0"}}>
                  ...
                  <h3 style={{color:"#fff",fontSize:21,fontWeight:800,marginBottom:12}}>Message Sent!</h3>
                  <p style={{color:"rgba(255,255,255,0.5)",fontSize:15,lineHeight:1.7,marginBottom:24}}>Thank you — we&apos;ll respond within 24 hours with practical advice.</p>
                  <button onClick={()=>setCSubmitted(false)} style={btnT}>Send Another →</button>
                </div>
              ) : (
                <form onSubmit={handleCSubmit} noValidate>
                  ...
                  <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":"1fr 1fr",gap:isMobile?10:14,marginBottom:14}}>
                    ...
                    <div>
                      <label style={{display:"block",fontSize:12.5,fontWeight:600,color:"rgba(255,255,255,0.5)",marginBottom:7,textTransform:"uppercase" as const,letterSpacing:"0.04em"}}>Phone *</label>
                      <div style={{display:"flex",gap:8}}>
                        <select className="fi" style={{...iSLg,width:88,flexShrink:0,padding:"11px 6px",cursor:"pointer"}} value={cForm.dialCode} onChange={e=>setC("dialCode",e.target.value)}>
                          {DIAL_CODES.map((d,i)=><option key={i} value={d.code}>{d.flag} {d.code}</option>)}
                        </select>
                  ...
                  <div style={{marginBottom:22}}>
                    ...
                    <textarea className={`fi${cTouched.project&&cErr.project?" fi-err":""}`} style={{...(cTouched.project&&cErr.project?iSLgE:iSLg),minHeight:100,resize:"vertical" as const}} placeholder="Briefly describe your ERP project, goals, and timeline..." value={cForm.project} onChange={e=>setC("project",e.target.value)} onBlur={cBlur("project")}/>
                    {cTouched.project&&<FieldErr msg={cErr.project}/>}
                  </div>

                  <button className="btn-t" type="submit" disabled={cLoading} style={{...btnT,width:"100%",padding:"15px",opacity:cLoading?.6:1,cursor:cLoading?"wait":"pointer"}}>
                    {cLoading?"Sending…":"Submit — Get Free ERP Consultation →"}
                  </button>
                  <p style={{color:"rgba(255,255,255,0.3)",fontSize:11.5,textAlign:"center",marginTop:12}}>🔒 Your information is 100% secure and never shared.</p>
                </form>
              )}
