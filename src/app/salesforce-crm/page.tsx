...
//   return <h2 style={{fontSize:"clamp(20px,3vw,40px)",fontWeight:900,color:"#fff",letterSpacing:"-0.02em",lineHeight:1.15,marginBottom:12}}>{children}</h2>;
// }
...
//   const btnSF:React.CSSProperties={display:"inline-block",padding:"13px 28px",borderRadius:10,border:"none",background:`linear-gradient(135deg,${A},${AD})`,color:"#000",fontWeight:700,fontSize:14,fontFamily:"'Poppins',sans-serif",cursor:"pointer",textDecoration:"none",transition:"transform .2s,box-shadow .2s"};
//   const btnOut:React.CSSProperties={display:"inline-block",padding:"13px 28px",borderRadius:10,border:`1.5px solid rgba(0,161,224,0.35)`,background:"transparent",color:A,fontWeight:600,fontSize:14,fontFamily:"'Poppins',sans-serif",cursor:"pointer",textDecoration:"none",transition:"border-color .2s,background .2s"};
...
//         .sec-inner      {max-width:1280px;margin:0 auto;position:relative;z-index:2;}
//         .sec-inner-1180 {max-width:1180px;margin:0 auto;position:relative;z-index:2;}
//         .sec-inner-sm   {max-width:860px; margin:0 auto;position:relative;z-index:2;}
...
//         .svc-card{display:flex;flex-direction:column;gap:14px;padding:24px;border-radius:18px;border:1px solid rgba(255,255,255,0.07);background:rgba(255,255,255,0.02);transition:transform .3s,border-color .3s,background .3s;text-decoration:none;cursor:pointer;}
//         .svc-card:hover{transform:translateY(-6px);border-color:rgba(0,161,224,0.3);background:rgba(0,161,224,0.04);}

//         /* Key benefits */
//         .kb-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:20px;}
//         .kb-card{display:flex;gap:20px;padding:28px 24px;border-radius:18px;border:1px solid rgba(255,255,255,0.06);background:rgba(255,255,255,0.02);transition:transform .3s,border-color .3s;}
//         .kb-card:hover{transform:translateY(-4px);border-color:rgba(0,161,224,0.2);}
...
//         .gp-card{padding:28px 24px;border-radius:18px;background:rgba(0,161,224,0.05);border:1px solid rgba(0,161,224,0.18);transition:transform .25s,box-shadow .25s,border-color .25s;cursor:default;}
//         .gp-card:hover{transform:translateY(-4px);box-shadow:0 16px 40px rgba(0,0,0,0.3);border-color:rgba(0,161,224,0.35);}

//         /* India grid */
//         .gp-ind-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:16px;}
//         .gp-ind{display:flex;align-items:center;gap:14px;padding:16px 18px;border-radius:12px;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.07);transition:background .2s;cursor:default;}
...
//         /* WCU */
//         .wcu-point{display:flex;align-items:center;gap:14px;padding:14px 18px;border-radius:12px;border:1px solid rgba(255,255,255,0.06);background:rgba(255,255,255,0.02);transition:border-color .2s,background .2s,transform .2s;cursor:default;}
...
//         .wcu-stat{text-align:center;padding:20px 14px;border-radius:14px;border:1px solid rgba(0,161,224,0.15);background:rgba(0,161,224,0.05);transition:transform .25s,background .25s;cursor:default;}
//         .wcu-stat:hover{transform:translateY(-4px)!important;background:rgba(0,161,224,0.1)!important;}
//         .wcu-pts{display:grid;grid-template-columns:repeat(2,1fr);gap:12px;}

//         /* FAQ */
//         .faq-item{border-radius:16px;background:rgba(255,255,255,0.02);overflow:hidden;cursor:pointer;transition:all .25s ease;}
...
//         .gp-tab{padding:11px 24px;border-radius:10px;border:1px solid rgba(255,255,255,0.1);background:rgba(255,255,255,0.03);color:rgba(255,255,255,0.55);font-size:14px;font-weight:700;font-family:'Poppins',sans-serif;cursor:pointer;transition:all .22s;}
...
//           .hero-layout   {grid-template-columns:1fr;gap:32px;padding-top:24px;}
...
//           .two-col-wide  {grid-template-columns:1fr!important;gap:36px!important;}
//         }

//         /* ── Mobile ≤ 768px ── */
//         @media(max-width:768px){
//           section:not(.hero-sf){padding:36px 20px!important;}
//           .hero-layout{padding-top:20px;gap:24px;}
//           /* Hero heading & content breathing room */
//           .hero-layout > div:first-child { margin-top:8px; }
//           .hero-layout h1 { margin-bottom:14px!important; }
//           .hero-layout p  { margin-bottom:20px!important; }
...
//           .sec-head h2  {font-size:clamp(20px,5.5vw,28px)!important;margin-bottom:8px!important;}
//           .sec-head p   {font-size:13px!important;}
//           /* Equal-width stacked buttons */
//           .btn-row{flex-direction:column!important;align-items:stretch!important;gap:10px!important;}
//           .btn-row a,.btn-row button{width:100%!important;text-align:center!important;justify-content:center!important;padding:13px 16px!important;font-size:14px!important;box-sizing:border-box!important;}
//         }

//         /* ── Small mobile ≤ 480px ── */
//         @media(max-width:480px){
//           section:not(.hero-sf){padding:28px 16px!important;}
...
//       {/* ══ M1 — HERO ══════════════════════════════════════════════════════════════ */}
//       <section className="hero-sf" style={{padding:"clamp(5px,5vw,72px) clamp(16px,4vw,48px) clamp(24px,5vw,60px)",background:`linear-gradient(135deg,${N0} 0%,#041628 45%,${N0} 100%)`,position:"relative",overflow:"hidden",display:"flex",alignItems:"flex-start"}}>
//         <Particles/>
...
//             <div style={{display:"inline-flex",alignItems:"center",gap:8,background:"rgba(0,161,224,0.08)",border:"1px solid rgba(0,161,224,0.25)",borderRadius:100,padding:"7px 18px",marginBottom:28,animation:"heroGlow 3s ease-in-out infinite"}}>
...
//               <span style={{color:A,fontSize:"clamp(10px,1.1vw,11.5px)",fontWeight:700,letterSpacing:"0.1em",textTransform:"uppercase" as const}}>Salesforce CRM — Canada, USA &amp; UK</span>
//             </div>
//             <h1 style={{fontSize:"clamp(24px,3.8vw,54px)",fontWeight:900,lineHeight:1.12,marginBottom:22,letterSpacing:"-0.025em",color:"#fff"}}>
//               Salesforce CRM Development, <GradText>Customisation &amp; Implementation</GradText> for Canada, USA &amp; UK
//             </h1>
//             <p style={{color:"rgba(255,255,255,0.52)",fontSize:"clamp(13px,1.3vw,16.5px)",lineHeight:1.85,marginBottom:28,maxWidth:600}}>
//               Salesforce is the world's most powerful CRM — but out of the box, it's designed for everyone, which means it's optimised for no one. Our specialists configure and customise it for you.
//             </p>
//             <div style={{display:"flex",flexWrap:"wrap",gap:8,marginBottom:28}}>
//               {[{i:"🔵",l:"Google Partner"},{i:"🏆",l:"ISO Certified"},{i:"🔒",l:"GDPR Compliant"},{i:"🍁",l:"PIPEDA Ready"},{i:"⭐",l:"Clutch Top Agency"}].map(b=>(
//                 <span key={b.l} style={{display:"inline-flex",alignItems:"center",gap:6,padding:"6px 13px",borderRadius:100,border:"1px solid rgba(255,255,255,0.12)",background:"rgba(255,255,255,0.04)",color:"rgba(255,255,255,0.65)",fontSize:"clamp(10px,1vw,12.5px)",fontWeight:600}}>{b.i} {b.l}</span>
//               ))}
//             </div>
//             <div style={{display:"flex",gap:20,flexWrap:"wrap"}}>
//               {[{flag:"🇨🇦",label:"CA:",phone:"+1 647-XXX-XXXX"},{flag:"🇬🇧",label:"UK:",phone:"+44 20-XXXX-XXXX"}].map(p=>(
//                 <a key={p.phone} href={`tel:${p.phone.replace(/\s|-/g,"")}`} className="h-blue" style={{display:"flex",alignItems:"center",gap:7,color:"rgba(255,255,255,0.5)",fontSize:"clamp(11px,1.1vw,13.5px)",fontWeight:600,textDecoration:"none",transition:"color .2s"}}>
...
//           {/* Hero Form */}
//           <div style={{background:"rgba(8,20,40,0.85)",border:"1px solid rgba(0,161,224,0.22)",borderRadius:20,padding:"32px 28px",backdropFilter:"blur(16px)",boxShadow:"0 32px 80px rgba(0,0,0,0.5),0 0 40px rgba(0,161,224,0.06)",position:"relative",overflow:"hidden"}}>
...
//       {/* ══ M2 — CLIENT LOGOS ══════════════════════════════════════════════════════ */}
//       <section style={{padding:"40px 0",background:N0,overflow:"hidden",borderTop:"1px solid rgba(0,161,224,.1)",borderBottom:"1px solid rgba(0,161,224,.1)"}}>
//         <div className="sec-head" style={{padding:"0 24px",marginBottom:28}}>
...
//             <SectionH2>Salesforce <GradText>Success Stories</GradText></SectionH2>
...
//               </div>
//               <h3 style={{color:"#fff",fontSize:"clamp(16px,2vw,24px)",fontWeight:800,marginBottom:14,lineHeight:1.3}}>{SUCCESS_STORIES[story].title}</h3>
//               <p style={{color:"rgba(255,255,255,0.6)",fontSize:"clamp(13px,1.2vw,15px)",lineHeight:1.7,marginBottom:24}}>{SUCCESS_STORIES[story].description}</p>
...
//                     <div style={{fontSize:"clamp(20px,2.5vw,30px)",fontWeight:900,marginBottom:4,color:A}}>{m.v}</div>
...
//       {/* ══ M4 — SERVICES ══════════════════════════════════════════════════════════ */}
//       <section style={{padding:"52px 48px",background:`linear-gradient(180deg,${N1} 0%,${N2} 60%,${N1} 100%)`,position:"relative",overflow:"hidden"}}>
//         <div style={{position:"absolute",inset:0,pointerEvents:"none",zIndex:0,backgroundImage:"linear-gradient(rgba(0,161,224,.02) 1px,transparent 1px),linear-gradient(90deg,rgba(0,161,224,.02) 1px,transparent 1px)",backgroundSize:"56px 56px"}}/>
//         <div className="sec-inner">
//           <div className="sec-head">
//             <SectionBadge label="What We Build"/>
//             <SectionH2>Salesforce CRM Services <GradText>We Offer</GradText></SectionH2>
//             <p style={{color:"rgba(255,255,255,0.5)",fontSize:"clamp(13px,1.3vw,16px)",lineHeight:1.75,maxWidth:580,margin:"0 auto"}}>A comprehensive lineup of Salesforce solutions for clients across Canada, USA &amp; UK.</p>
//           </div>
//           <div className="svc-grid">
//             {SERVICES.map((s,i)=>(
//               <a key={s.title} href={`/services/salesforce/${s.slug}`} className="svc-card">
//                 <div style={{display:"flex",alignItems:"flex-start",justifyContent:"space-between",gap:12}}>
...
//             <SectionH2>Key Benefits of <GradText>Salesforce CRM</GradText></SectionH2>
//             <p style={{color:"rgba(255,255,255,0.45)",fontSize:"clamp(13px,1.3vw,16px)",lineHeight:1.75,maxWidth:520,margin:"0 auto"}}>Here's what you gain when your sales processes run on a properly configured Salesforce.</p>
//           </div>
//           <div className="kb-grid">
//             {BENEFITS.map((b,i)=>(
//               <div key={i} className="kb-card" style={{animationDelay:`${i*.12}s`}}>
//                 <div style={{fontSize:"clamp(36px,5vw,60px)",fontWeight:900,lineHeight:1,color:A,opacity:.25,flexShrink:0,width:64,textAlign:"center"}}>{b.num}</div>
//                 <div style={{flex:1}}>
//                   <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:10}}><span style={{fontSize:22}}>{b.icon}</span><h3 style={{color:"#fff",fontSize:"clamp(15px,1.4vw,18px)",fontWeight:800,margin:0}}>{b.title}</h3></div>
//                   <p style={{color:"rgba(255,255,255,0.52)",fontSize:"clamp(13px,1vw,14.5px)",lineHeight:1.75,margin:"0 0 12px"}}>{b.desc}</p>
...
//       {/* ══ M6 — PLATFORM TOOLS ════════════════════════════════════════════════════ */}
//       <section style={{padding:"52px 48px",background:N1,position:"relative",overflow:"hidden"}}>
...
//             <p style={{color:"rgba(255,255,255,0.45)",fontSize:"clamp(13px,1.3vw,16px)",lineHeight:1.75,maxWidth:560,margin:"0 auto"}}>A closer look at the Salesforce tools we leverage for the best possible business outcomes.</p>
//           </div>
...
//                 <h3 style={{color:"#fff",fontSize:"clamp(12px,1.2vw,15px)",fontWeight:700,marginBottom:6,lineHeight:1.3}}>{tool.name}</h3>
...
//             <SectionH2>Hire Salesforce Developers <GradText>Tailored to Your Needs</GradText></SectionH2>
//             <p style={{color:"rgba(255,255,255,0.45)",fontSize:"clamp(13px,1.3vw,16px)",lineHeight:1.75,maxWidth:560,margin:"0 auto"}}>Whether you're an enterprise, start-up, or agency — we have the right Salesforce expert for your challenge.</p>
//           </div>
...
//         <div className="sec-inner">
//           <div className="sec-head" style={{maxWidth:620,marginLeft:"auto",marginRight:"auto"}}>
//             <SectionBadge label="AI-Powered"/>
//             <SectionH2>Leverage <GradText>AI-Powered Salesforce</GradText> Solutions</SectionH2>
//             <p style={{color:"rgba(255,255,255,0.5)",fontSize:"clamp(13px,1.3vw,16px)",lineHeight:1.8}}>Einstein AI and machine learning capabilities built into your Salesforce implementation.</p>
//           </div>
//           <div className="ai-feat-grid">
//             {AI_FEATS.map((f,i)=>(
//               <div key={i} style={{background:"rgba(0,161,224,0.05)",border:"1px solid rgba(0,161,224,0.15)",borderRadius:16,padding:"clamp(18px,2.5vw,28px) 20px",textAlign:"center"}}>
...
//         <div className="sec-inner" style={{maxWidth:1100}}>
//           <div className="sec-head">
//             <SectionBadge label="Our Story"/>
//             <SectionH2>Why Choose Us as Your <GradText>Salesforce Partner</GradText>?</SectionH2>
...
//             <p style={{color:"rgba(255,255,255,0.55)",fontSize:"clamp(13px,1.2vw,15px)",lineHeight:1.8,maxWidth:700,margin:"0 auto"}}>We launched NNC Digital as our international arm — bringing proven technical expertise to Canadian, US, and UK markets with dedicated client-facing teams, transparent pricing, and long-term partnership.</p>
//           </div>
//           <div className="wcu-pts" style={{marginBottom:32}}>
//             {WCU_POINTS.map((p,i)=>(
//               <div key={i} className="wcu-point">
//                 <span style={{fontSize:18,flexShrink:0}}>{p.icon}</span>
...
//             ))}
//           </div>
//           <div className="wcu-stats" style={{marginBottom:36}}>
//             {WCU_STATS.map(st=>(
//               <div key={st.l} className="wcu-stat">
...
//       {/* ══ M11 — GLOBAL PRESENCE ══════════════════════════════════════════════════ */}
//       <section style={{padding:"52px 48px",background:`linear-gradient(180deg,${N0} 0%,${N1} 100%)`,position:"relative",overflow:"hidden"}}>
...
//           {gTab==="int"&&(
//             <div>
//               <div className="gp-offices" style={{marginBottom:20}}>
//                 {INT_OFFICES.map((o,i)=>(
//                   <div key={i} className="gp-card">
...
//           {gTab==="india"&&(
//             <div>
//               <div style={{borderRadius:20,padding:"clamp(20px,3vw,36px)",background:"rgba(255,255,255,0.02)",border:"1px solid rgba(255,255,255,0.08)",marginBottom:20}}>
...
//                     <p style={{fontSize:"clamp(20px,2.2vw,26px)",fontWeight:900,color:A,margin:0}}>{s.n}</p>
...
//             <p style={{color:"rgba(255,255,255,0.45)",fontSize:"clamp(13px,1.2vw,15px)",lineHeight:1.75,maxWidth:520,margin:"0 auto"}}>Everything you need to know about Salesforce implementation for businesses in Canada, USA &amp; UK.</p>
//           </div>
//           <div style={{display:"flex",flexDirection:"column",gap:12}}>
//             {FAQS.map((f,i)=>(
...
//                   <p style={{padding:"0 clamp(14px,2vw,22px) 20px clamp(50px,6vw,80px)",color:"rgba(255,255,255,0.55)",fontSize:"clamp(13px,1.1vw,14.5px)",lineHeight:1.8,margin:0}}>{f.a}</p>
//                 </div>
//               </div>
//             ))}
//           </div>
...
//       {/* ══ M13 — CONTACT FORM ═════════════════════════════════════════════════════ */}
//       <section style={{padding:"52px 48px",background:`linear-gradient(180deg,${N2} 0%,${N0} 100%)`,position:"relative",overflow:"hidden"}}>
...
//             <SectionH2>Ready to Build <GradText>Next-Level</GradText> Custom Salesforce Solutions?</SectionH2>
