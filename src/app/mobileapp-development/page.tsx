...
const SERVICES = [
  {icon:"🍎",title:"iOS App Development",            desc:"Native Swift/SwiftUI apps built for iPhone and iPad — performance-optimised and App Store ready.",            tag:"iOS"},
  {icon:"🤖",title:"Android App Development",         desc:"Native Kotlin apps built for Android phones, tablets, and enterprise devices across all screen sizes.",       tag:"Android"},
  {icon:"⚡",title:"Cross-Platform (React Native)",   desc:"One codebase, two platforms. Full-featured iOS & Android apps at lower cost and faster delivery time.",        tag:"React Native"},
  {icon:"🦋",title:"Flutter App Development",         desc:"Google's Flutter framework for beautiful, high-performance cross-platform apps with native feel.",             tag:"Flutter"},
  {icon:"🔗",title:"CRM-Integrated Mobile Apps",      desc:"Mobile apps that sync live with Salesforce, HubSpot, or your custom CRM — keeping field teams connected.",    tag:"CRM"},
  {icon:"🎨",title:"Mobile UI/UX Design",             desc:"User research, wireframes, prototypes, and polished UI — all before a line of code is written.",              tag:"Design"},
  {icon:"🛒",title:"E-Commerce Mobile Apps",          desc:"Shopify-integrated or custom mobile storefronts with one-tap checkout, push campaigns, and loyalty features.", tag:"E-Commerce"},
  {icon:"🏥",title:"Healthcare Mobile Apps",          desc:"GDPR-compliant patient apps with secure messaging, online booking, and EHR integrations.",                    tag:"Healthcare"},
  {icon:"📦",title:"Field Service Apps",              desc:"Mobile apps for field teams — job scheduling, digital forms, GPS tracking, and offline-first capabilities.",   tag:"Field"},
  {icon:"🔔",title:"Push Notification Systems",       desc:"Targeted push campaigns, in-app messaging, and automated lifecycle notifications to re-engage users.",         tag:"Engagement"},
  {icon:"🔧",title:"App Maintenance & Support",       desc:"Post-launch monitoring, OS update compatibility, crash fixing, and performance optimisation.",                 tag:"Support"},
  {icon:"📊",title:"App Analytics & Optimisation",    desc:"Firebase analytics, A/B testing, funnel tracking, and ASO to continuously improve app performance.",          tag:"Analytics"},
];
  ...
  <div className="hero-layout">
    ...
    <div style={{animation:"heroFadeUp .7s ease both"}}>
      <div style={{display:"inline-flex",alignItems:"center",gap:8,background:"rgba(0,201,167,0.08)",border:"1px solid rgba(0,201,167,0.25)",borderRadius:100,padding:"7px 18px",marginBottom:28,animation:"heroGlow 3s ease-in-out infinite,heroFadeUp .7s ease both"}}>
        ...
        <span style={{color:T,fontSize:11.5,fontWeight:700,letterSpacing:"0.1em",textTransform:"uppercase" as const}}>Mobile App Development — Canada, USA &amp; UK</span>
      </div>
      ...
      <div style={{display:"flex",flexWrap:"wrap",gap:8,marginBottom:28,animation:"heroFadeUp .7s ease .27s both"}}>
        {[{i:"🍎",l:"iOS (Swift)"},{i:"🤖",l:"Android (Kotlin)"},{i:"⚡",l:"React Native"},{i:"🦋",l:"Flutter"},{i:"📦",l:"Offline-First"}].map(b=>(
          <span key={b.l} className="platform-pill">{b.i} {b.l}</span>
        ))}
      </div>
      ...
      {submitted?(
        ...
        <>
          <div style={{marginBottom:22}}>
            ...
            <h2 style={{color:"#fff",fontSize:18,fontWeight:800,margin:0,lineHeight:1.3}}>Get a Free Mobile App Strategy Call</h2>
          </div>
          <form onSubmit={handleSubmit} style={{display:"flex",flexDirection:"column",gap:12}}>
            ...
            <div><label style={{display:"block",fontSize:11,fontWeight:600,color:"rgba(255,255,255,0.45)",marginBottom:5,textTransform:"uppercase" as const,letterSpacing:"0.04em"}}>Message</label><textarea className="fi" style={{...iS,minHeight:76,resize:"vertical" as const}} placeholder="Tell us about your app idea..." value={form.message} onChange={e=>setF("message",e.target.value)}/></div>
  ...
  <div className="stats-row">
    {STATS_TOP.map((s,i)=>(
      <div key={i} className="card-hover" style={{position:"relative",textAlign:"center",padding:"44px 28px",borderRadius:20,background:"rgba(0,201,167,0.08)",border:"1px solid rgba(0,201,167,0.2)",transition:"transform .3s,box-shadow .3s",cursor:"default",animation:`sbFadeUp .7s ease ${i*.12}s both`}}>
        ...
        <div style={{fontSize:"clamp(40px,4.5vw,56px)",fontWeight:900,lineHeight:1,marginBottom:10,background:"linear-gradient(135deg,#fff 30%,#00C9A7 100%)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}}>
...
<section style={{padding:"88px 48px",background:`linear-gradient(180deg,${N2} 0%,${N1} 100%)`,position:"relative",overflow:"hidden"}}>
  ...
  <div style={{maxWidth:1200,margin:"0 auto",position:"relative",zIndex:2}}>
    <div style={{textAlign:"center",marginBottom:48}}>
      ...
      <p style={{color:"rgba(255,255,255,0.45)",fontSize:16,lineHeight:1.7,maxWidth:500,margin:"0 auto"}}>Real results from real mobile apps built for businesses in Canada, USA &amp; UK.</p>
    </div>
...
<section style={{padding:"80px 48px 48px",background:`linear-gradient(180deg,${N1} 0%,${N2} 60%,${N1} 100%)`,position:"relative",overflow:"hidden"}}>
  ...
  <div style={{maxWidth:1280,margin:"0 auto",position:"relative",zIndex:2}}>
    <div style={{textAlign:"center",marginBottom:60}}>
      ...
      <p style={{color:"rgba(255,255,255,0.5)",fontSize:16,lineHeight:1.75,maxWidth:580,margin:"0 auto"}}>iOS, Android, and cross-platform app development for businesses across Canada, USA &amp; UK.</p>
    </div>
...
<section style={{padding:"88px 48px",background:`linear-gradient(180deg,${N1} 0%,${N2} 100%)`,position:"relative",overflow:"hidden"}}>
  ...
  <div style={{maxWidth:1280,margin:"0 auto",position:"relative",zIndex:2}}>
    <div style={{textAlign:"center",marginBottom:60}}>
      ...
      <p style={{color:"rgba(255,255,255,0.45)",fontSize:16,lineHeight:1.75,maxWidth:520,margin:"0 auto"}}>Here&apos;s what you gain when your mobile app is built by a team that prioritises performance, integration, and long-term success.</p>
    </div>
    ...
    <div style={{textAlign:"center",marginTop:52}}>
      <button className="btn-teal" style={{padding:"14px 36px",borderRadius:10,border:"none",background:`linear-gradient(135deg,${T},${TD})`,color:"#000",fontWeight:700,fontSize:15,fontFamily:"'Poppins',sans-serif",cursor:"pointer",transition:"transform .2s,box-shadow .2s"}}>Start Your App Project →</button>
    </div>
  </div>
</section>
...
<section style={{padding:"80px 48px",background:N1,position:"relative",overflow:"hidden"}}>
  ...
  <div style={{maxWidth:1280,margin:"0 auto",position:"relative",zIndex:2}}>
    <div style={{textAlign:"center",marginBottom:56}}>
      ...
      <p style={{color:"rgba(255,255,255,0.45)",fontSize:16,lineHeight:1.75,maxWidth:560,margin:"0 auto"}}>A production-proven mobile stack — chosen for performance, reliability, and long-term maintainability.</p>
    </div>
...
<section style={{padding:"96px 48px",background:N0,position:"relative",overflow:"hidden"}}>
  ...
  <div style={{maxWidth:1280,margin:"0 auto",position:"relative",zIndex:2}}>
    <div style={{textAlign:"center",marginBottom:60}}>
      ...
      <p style={{color:"rgba(255,255,255,0.45)",fontSize:16,lineHeight:1.7,maxWidth:520,margin:"0 auto"}}>Explore the full capability set we bring to every mobile app project.</p>
    </div>
...
<section style={{padding:"80px 48px",background:`linear-gradient(180deg,${N1} 0%,${N2} 100%)`,position:"relative",overflow:"hidden"}}>
  ...
  <div style={{maxWidth:1280,margin:"0 auto",position:"relative",zIndex:2}}>
    <div style={{textAlign:"center",marginBottom:56}}>
      ...
      <p style={{color:"rgba(255,255,255,0.45)",fontSize:16,lineHeight:1.75,maxWidth:560,margin:"0 auto"}}>Whether you&apos;re launching an MVP, scaling an enterprise app, or extending your agency team — we have the right developer for your project.</p>
    </div>
    <div className="two-col" style={{marginBottom:16}}>
      ...
      <p style={{color:T,fontSize:11,fontWeight:700,letterSpacing:"0.12em",textTransform:"uppercase" as const}}>By App Type</p>
    </div>
    <div className="two-col">
      <div style={{display:"flex",flexDirection:"column",gap:12}}>
    ...
    <div style={{display:"flex",gap:16,marginTop:48,justifyContent:"center",flexWrap:"wrap"}}>
      <button className="btn-teal" style={{padding:"14px 32px",borderRadius:10,border:"none",background:`linear-gradient(135deg,${T},${TD})`,color:"#000",fontWeight:700,fontSize:15,fontFamily:"'Poppins',sans-serif",cursor:"pointer",transition:"transform .2s,box-shadow .2s"}}>📱 Hire a Mobile Developer</button>
...
<section style={{padding:"80px 48px",background:`linear-gradient(180deg,${N2} 0%,${N1} 100%)`,position:"relative",overflow:"hidden"}}>
  ...
  <div style={{maxWidth:1280,margin:"0 auto",position:"relative",zIndex:2}}>
    <div style={{marginBottom:52,maxWidth:620}}>
      ...
      <p style={{color:"rgba(255,255,255,0.5)",fontSize:16,lineHeight:1.8}}>We build AI directly into your mobile app — personalisation, predictive retention, and intelligent automation from day one.</p>
    </div>
    <div className="two-col-wide">
      <div style={{display:"flex",flexDirection:"column",gap:16}}>
        ...
        <button className="btn-teal" style={{marginTop:8,alignSelf:"flex-start",display:"inline-flex",alignItems:"center",gap:10,padding:"13px 28px",borderRadius:10,border:"none",background:`linear-gradient(135deg,${T},${TD})`,color:"#000",fontWeight:700,fontSize:14,fontFamily:"'Poppins',sans-serif",cursor:"pointer",transition:"transform .2s,box-shadow .2s"}}>🤖 Explore AI Mobile Solutions →</button>
      </div>
...
<section style={{position:"relative",overflow:"hidden"}}>
  <div style={{background:"linear-gradient(135deg,#0055b3 0%,#0077cc 35%,#00a07a 65%,#00C9A7 100%)",backgroundSize:"300% 300%",animation:"ctaBgShift 8s ease infinite",padding:"88px 48px",textAlign:"center",position:"relative"}}>
    ...
    <div style={{position:"relative",zIndex:2,maxWidth:760,margin:"0 auto"}}>
      ...
      <p style={{color:"rgba(255,255,255,0.82)",fontSize:17,lineHeight:1.75,marginBottom:40}}>Connect with NNC Digital today — iOS, Android, or cross-platform. Let&apos;s build your app together.</p>
  ...
  <div style={{maxWidth:1280,margin:"0 auto",position:"relative",zIndex:2}}>
    <div className="two-col-wide">
      <div>
        ...
        <p style={{color:"rgba(255,255,255,0.55)",fontSize:15,lineHeight:1.8,marginBottom:32}}>We launched NNC Digital as our international arm — bringing the same proven mobile expertise to Canadian, US, and UK markets with transparent pricing, dedicated client-facing teams, and long-term partnership.</p>
      ...
      <div>
        ...
        <div style={{display:"flex",gap:12,marginTop:24}}>
          <button className="btn-teal" style={{flex:1,padding:"13px 20px",borderRadius:10,border:"none",background:`linear-gradient(135deg,${T},${TD})`,color:"#000",fontWeight:700,fontSize:14,fontFamily:"'Poppins',sans-serif",cursor:"pointer",transition:"transform .2s,box-shadow .2s"}}>📅 Book a Free App Strategy Call</button>
...
<section style={{padding:"80px 48px",background:`linear-gradient(180deg,${N1} 0%,${N2} 100%)`,position:"relative",overflow:"hidden"}}>
  ...
  <div style={{maxWidth:860,margin:"0 auto",position:"relative",zIndex:2}}>
    <div style={{textAlign:"center",marginBottom:52}}>
      ...
      <p style={{color:"rgba(255,255,255,0.45)",fontSize:15,lineHeight:1.75,maxWidth:520,margin:"0 auto"}}>Everything you need to know about mobile app development for businesses in Canada, USA &amp; UK.</p>
    </div>
    <div style={{display:"flex",flexDirection:"column",gap:12}}>
      {FAQS.map((f,i)=>(
...
<section style={{padding:"80px 48px",background:`linear-gradient(180deg,${N2} 0%,${N0} 100%)`,position:"relative",overflow:"hidden"}}>
  ...
  <div style={{maxWidth:1180,margin:"0 auto",position:"relative",zIndex:2}}>
    <div style={{textAlign:"center",marginBottom:56}}>
      ...
      <p style={{color:"rgba(255,255,255,0.45)",fontSize:15.5,lineHeight:1.75,maxWidth:540,margin:"0 auto"}}>Tell us about your app idea. We respond within 24 hours with a free consultation and honest advice.</p>
    </div>
